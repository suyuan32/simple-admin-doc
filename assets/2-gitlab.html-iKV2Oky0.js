import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as s,e as n}from"./app-IU8gEcM_.js";const i={},l=n(`<h2 id="gitlab-ci-文件生成" tabindex="-1"><a class="header-anchor" href="#gitlab-ci-文件生成" aria-hidden="true">#</a> Gitlab CI 文件生成</h2><blockquote><p>goctls &gt;= 1.6.6</p></blockquote><h2 id="创建-gitlab-ci-文件" tabindex="-1"><a class="header-anchor" href="#创建-gitlab-ci-文件" aria-hidden="true">#</a> 创建 Gitlab CI 文件</h2><blockquote><p>创建 .gitlab-ci.yaml</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls cicd gitlab
