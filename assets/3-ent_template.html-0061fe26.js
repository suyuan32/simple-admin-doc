import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as s,e as n}from"./app-58a58450.js";const t={},i=n(`<h2 id="ent-文件生成" tabindex="-1"><a class="header-anchor" href="#ent-文件生成" aria-hidden="true">#</a> Ent 文件生成</h2><h3 id="extra-ent-template-模板生成" tabindex="-1"><a class="header-anchor" href="#extra-ent-template-模板生成" aria-hidden="true">#</a> <code>extra ent template</code> 模板生成</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls extra ent template <span class="token parameter variable">-u</span>
...
Flags:
  ...
  -l, <span class="token parameter variable">--list</span>         列出所有支持的模板
  -u, <span class="token parameter variable">--update</span>       更新所有模板
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>目前已支持软删除模板</p><h3 id="extra-ent-import-数据库结构导出到-schema" tabindex="-1"><a class="header-anchor" href="#extra-ent-import-数据库结构导出到-schema" aria-hidden="true">#</a> <code>extra ent import</code> 数据库结构导出到 schema</h3><blockquote><p>goctls &gt;= 1.5.18</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls extra ent <span class="token function">import</span> <span class="token parameter variable">-h</span>
从数据库生成 Ent Schema
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>goctls 支持生成 index 索引，但是索引的名称的后缀必须为字段名称，且只支持生成单索引，不支持复合索引</p></div>`,14),l=[i];function d(r,c){return e(),s("div",null,l)}const v=a(t,[["render",d],["__file","3-ent_template.html.vue"]]);export{v as default};
