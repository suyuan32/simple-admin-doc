import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as s,e as n}from"./app-e741f0b8.js";const t={},i=n(`<h2 id="ent-文件生成" tabindex="-1"><a class="header-anchor" href="#ent-文件生成" aria-hidden="true">#</a> Ent 文件生成</h2><h3 id="extra-ent-template-模板生成" tabindex="-1"><a class="header-anchor" href="#extra-ent-template-模板生成" aria-hidden="true">#</a> <code>extra ent template</code> 模板生成</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls extra ent template <span class="token parameter variable">-u</span>
...
Flags:
  ...
  -l, <span class="token parameter variable">--list</span>         列出所有支持的模板
  -u, <span class="token parameter variable">--update</span>       更新所有模板
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>目前已支持软删除模板</p><h3 id="extra-ent-import-数据库结构导出到-schema" tabindex="-1"><a class="header-anchor" href="#extra-ent-import-数据库结构导出到-schema" aria-hidden="true">#</a> <code>extra ent import</code> 数据库结构导出到 schema</h3><blockquote><p>goctls &gt;= 1.6.12</p></blockquote><div class="hint-container warning"><p class="hint-container-title">注意</p><p>建议直接在项目<strong>根目录</strong>执行命令，可以不用配置 <code>-o</code> 参数, 例如</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls extra ent <span class="token function">import</span> <span class="token parameter variable">-d</span> <span class="token string">&quot;mysql://root:simple-admin.@tcp(localhost:3306)/simple_admin?charset=utf8mb4&amp;parseTime=True&amp;loc=Local&quot;</span> <span class="token parameter variable">-t</span> <span class="token string">&quot;sys_tokens&quot;</span>
