import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as s,e as n}from"./app-7u129erx.js";const i={},t=n(`<h2 id="gitea-文件生成" tabindex="-1"><a class="header-anchor" href="#gitea-文件生成" aria-hidden="true">#</a> Gitea 文件生成</h2><blockquote><p>goctls &gt;= 1.6.7</p></blockquote><h2 id="创建-gitea-workflow-文件" tabindex="-1"><a class="header-anchor" href="#创建-gitea-workflow-文件" aria-hidden="true">#</a> 创建 Gitea Workflow 文件</h2><blockquote><p>创建 .gitea/workflow/docker.yaml</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls cicd gitea <span class="token parameter variable">-r</span> https://github.com/suyuan32/simple-admin-job.git <span class="token parameter variable">-c</span>
