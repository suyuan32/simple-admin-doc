import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,b as i}from"./app-CW05xIpp.js";const p={},l=i(`<p>该命令用于通过 proto 生成 api 中的字段内容, 主要用于生成除了 CRUD 代码生成之外的结构体，即将 rpc 中额外的 message 转换为 api 的 type，使得 proto 接入 api 更便捷.</p><div class="language-shell line-numbers-mode" data-highlighter="shiki" data-ext="shell" data-title="shell" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#61AFEF;">$</span><span style="--shiki-light:#032F62;--shiki-dark:#98C379;"> goctls</span><span style="--shiki-light:#032F62;--shiki-dark:#98C379;"> extra</span><span style="--shiki-light:#032F62;--shiki-dark:#98C379;"> proto2api</span><span style="--shiki-light:#005CC5;--shiki-dark:#D19A66;"> -h</span></span>
