import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as e,e as s}from"./app-DqXjkZhl.js";const a={},t=s(`<blockquote><p>goctls &gt;= 1.5.14</p></blockquote><p>该命令用于通过 proto 生成 api 中的字段内容, 主要用于生成除了 CRUD 代码生成之外的结构体，即将 rpc 中额外的 message 转换为 api 的 type，使得 proto 接入 api 更便捷.</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ goctls extra proto2api <span class="token parameter variable">-h</span>
