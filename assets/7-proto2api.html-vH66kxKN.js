import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,b as i}from"./app-iJ54aJvk.js";const p={},l=i(`<p>该命令用于通过 proto 生成 api 中的字段内容, 主要用于生成除了 CRUD 代码生成之外的结构体，即将 rpc 中额外的 message 转换为 api 的 type，使得 proto 接入 api 更便捷.</p><div class="language-shell line-numbers-mode" data-ext="shell" data-title="shell"><pre class="shiki shiki-themes github-light one-dark-pro vp-code" style="background-color:#fff;--shiki-dark-bg:#282c34;color:#24292e;--shiki-dark:#abb2bf;" tabindex="0"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">$</span><span style="color:#032F62;--shiki-dark:#98C379;"> goctls</span><span style="color:#032F62;--shiki-dark:#98C379;"> extra</span><span style="color:#032F62;--shiki-dark:#98C379;"> proto2api</span><span style="color:#005CC5;--shiki-dark:#D19A66;"> -h</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">通过</span><span style="color:#032F62;--shiki-dark:#98C379;"> proto</span><span style="color:#032F62;--shiki-dark:#98C379;"> 生成</span><span style="color:#032F62;--shiki-dark:#98C379;"> api</span><span style="color:#032F62;--shiki-dark:#98C379;"> 额外数据，如</span><span style="color:#032F62;--shiki-dark:#98C379;"> type</span><span style="color:#032F62;--shiki-dark:#98C379;"> 和</span><span style="color:#032F62;--shiki-dark:#98C379;"> service</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">Usage:</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">  goctls</span><span style="color:#032F62;--shiki-dark:#98C379;"> extra</span><span style="color:#032F62;--shiki-dark:#98C379;"> proto2api</span><span style="color:#24292E;--shiki-dark:#ABB2BF;"> [flags]</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">Flags:</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">  -a,</span><span style="color:#005CC5;--shiki-dark:#D19A66;"> --api_path</span><span style="color:#032F62;--shiki-dark:#98C379;"> string</span><span style="color:#032F62;--shiki-dark:#98C379;">     api</span><span style="color:#032F62;--shiki-dark:#98C379;"> 文件路径，若为空则会输出到控制台</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">  -g,</span><span style="color:#005CC5;--shiki-dark:#D19A66;"> --group_name</span><span style="color:#032F62;--shiki-dark:#98C379;"> string</span><span style="color:#032F62;--shiki-dark:#98C379;">   分组名称，若为空则为模型名称的小写</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">  -h,</span><span style="color:#005CC5;--shiki-dark:#D19A66;"> --help</span><span style="color:#032F62;--shiki-dark:#98C379;">                help</span><span style="color:#032F62;--shiki-dark:#98C379;"> for</span><span style="color:#032F62;--shiki-dark:#98C379;"> proto2api</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">  -j,</span><span style="color:#005CC5;--shiki-dark:#D19A66;"> --json_style</span><span style="color:#032F62;--shiki-dark:#98C379;"> string</span><span style="color:#032F62;--shiki-dark:#98C379;">   JSON</span><span style="color:#032F62;--shiki-dark:#98C379;"> 字段的格式，默认为</span><span style="color:#032F62;--shiki-dark:#98C379;"> goZero</span><span style="color:#24292E;--shiki-dark:#ABB2BF;"> (default </span><span style="color:#032F62;--shiki-dark:#98C379;">&quot;goZero&quot;</span><span style="color:#24292E;--shiki-dark:#ABB2BF;">)</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">  -m,</span><span style="color:#005CC5;--shiki-dark:#D19A66;"> --model_name</span><span style="color:#032F62;--shiki-dark:#98C379;"> string</span><span style="color:#032F62;--shiki-dark:#98C379;">   模型名称，用于过滤</span><span style="color:#032F62;--shiki-dark:#98C379;"> rpc</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">      --multiple</span><span style="color:#032F62;--shiki-dark:#98C379;">            是否为多</span><span style="color:#032F62;--shiki-dark:#98C379;"> service</span><span style="color:#032F62;--shiki-dark:#98C379;"> 的</span><span style="color:#032F62;--shiki-dark:#98C379;"> proto</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">  -p,</span><span style="color:#005CC5;--shiki-dark:#D19A66;"> --proto_path</span><span style="color:#032F62;--shiki-dark:#98C379;"> string</span><span style="color:#032F62;--shiki-dark:#98C379;">   proto</span><span style="color:#032F62;--shiki-dark:#98C379;"> 文件路径，注意为根目录下的</span><span style="color:#032F62;--shiki-dark:#98C379;"> proto</span><span style="color:#032F62;--shiki-dark:#98C379;"> 不是</span><span style="color:#032F62;--shiki-dark:#98C379;"> desc</span><span style="color:#032F62;--shiki-dark:#98C379;"> 文件夹中的</span><span style="color:#032F62;--shiki-dark:#98C379;"> proto</span><span style="color:#032F62;--shiki-dark:#98C379;"> 文件</span></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p>proto 文件中必须含有对应的 group 注释 api 文件中必须已有 type 和 service, 否则建议从控制台复制</p></div><h2 id="例子" tabindex="-1"><a class="header-anchor" href="#例子"><span>例子</span></a></h2><div class="language-shell line-numbers-mode" data-ext="shell" data-title="shell"><pre class="shiki shiki-themes github-light one-dark-pro vp-code" style="background-color:#fff;--shiki-dark-bg:#282c34;color:#24292e;--shiki-dark:#abb2bf;" tabindex="0"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">goctls</span><span style="color:#032F62;--shiki-dark:#98C379;"> extra</span><span style="color:#032F62;--shiki-dark:#98C379;"> proto2api</span><span style="color:#005CC5;--shiki-dark:#D19A66;"> -m</span><span style="color:#032F62;--shiki-dark:#98C379;"> OauthProvider</span><span style="color:#005CC5;--shiki-dark:#D19A66;"> -p</span><span style="color:#032F62;--shiki-dark:#98C379;"> D:/projects/simpleadmin/feature-workspace/simple-admin-core/rpc/core.proto</span></span>
<span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF;">-a</span><span style="color:#032F62;--shiki-dark:#98C379;"> D:/projects/simpleadmin/feature-workspace/simple-admin-core/api/desc/core/api.api</span></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="shiki shiki-themes github-light one-dark-pro vp-code" style="background-color:#fff;--shiki-dark-bg:#282c34;color:#24292e;--shiki-dark:#abb2bf;" tabindex="0"><code><span class="line"><span>syntax = &quot;v1&quot;</span></span>
