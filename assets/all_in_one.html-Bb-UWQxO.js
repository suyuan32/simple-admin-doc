import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as e,c as t,d as n,e as p,b as l,o as i}from"./app-SeIJRtVB.js";const c={},o={class:"hint-container info"},u=n("p",{class:"hint-container-title"},"视频教程",-1),r=l(`<p>在 deploy/docker-compose/all_in_one 文件夹下, <a href="https://github.com/suyuan32/simple-admin-core/tree/master/deploy/docker-compose/all_in_one" target="_blank" rel="noopener noreferrer">Github</a></p><p>有 mysql 和 postgres 文件夹，根据需求选择一个文件夹打开。</p><h2 id="只需两步" tabindex="-1"><a class="header-anchor" href="#只需两步"><span>只需两步</span></a></h2><h3 id="_1-启动-docker-compose" tabindex="-1"><a class="header-anchor" href="#_1-启动-docker-compose"><span>1. 启动 docker-compose</span></a></h3><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>由于国内获取镜像较慢，现已提供阿里云镜像服务，需要手动获取镜像</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull registry.cn-hangzhou.aliyuncs.com/simple_admin/core-api-docker:<span class="token punctuation">[</span>镜像版本号<span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-初始化数据库" tabindex="-1"><a class="header-anchor" href="#_2-初始化数据库"><span>2. 初始化数据库</span></a></h3><div class="hint-container warning"><p class="hint-container-title">注意</p><p>如果出现 503 错误，请单独重启 backend ui 容器</p></div><p><a href="http://localhost/init" target="_blank" rel="noopener noreferrer">http://localhost/init</a></p><div class="hint-container warning"><p class="hint-container-title">注意</p><p>部署自己的服务到 docker 只需修改为自己的镜像即可</p></div><h2 id="国内-docker-compose-例子" tabindex="-1"><a class="header-anchor" href="#国内-docker-compose-例子"><span>国内 docker-compose 例子</span></a></h2><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>只需把 ryanpower 替换为阿里云镜像地址即可</p></div><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&quot;3&quot;</span>
