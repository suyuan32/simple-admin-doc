import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o as i,c,a as n,f as s,b as e,e as t}from"./app-CH4yOpAS.js";const o={},u={href:"https://github.com/suyuan32/simple-admin-core/tree/master/deploy/docker-compose/all_in_one",target:"_blank",rel:"noopener noreferrer"},r=t(`<p>有 mysql 和 postgres 文件夹，根据需求选择一个文件夹打开。</p><h2 id="只需三步" tabindex="-1"><a class="header-anchor" href="#只需三步" aria-hidden="true">#</a> 只需三步</h2><h3 id="_1-启动-docker-compose" tabindex="-1"><a class="header-anchor" href="#_1-启动-docker-compose" aria-hidden="true">#</a> 1. 启动 docker-compose</h3><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>由于国内获取镜像较慢，现已提供阿里云镜像服务，需要手动获取镜像</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull registry.cn-hangzhou.aliyuncs.com/simple_admin/core-api-docker:<span class="token punctuation">[</span>镜像版本号<span class="token punctuation">]</span>
