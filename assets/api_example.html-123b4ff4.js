import{_ as i,a as r}from"./api_gen_struct-3403667f.js";import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as d,c as p,a as e,b as a,d as s,e as t}from"./app-950724a6.js";const c={},u=e("h1",{id:"_3-minutes-developing-api-service",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_3-minutes-developing-api-service","aria-hidden":"true"},"#"),a(" 3 minutes developing API service")],-1),m={class:"hint-container warning"},v=e("p",{class:"hint-container-title"},"Note",-1),b=e("p",null,"Make sure that you have been installed follow software:",-1),h=e("ul",null,[e("li",null,"simple-admin-tool (goctls) v1.5.5 +")],-1),k=e("br",null,null,-1),g={href:"https://go-zero.dev/docs/goctl/api",target:"_blank",rel:"noopener noreferrer"},f={href:"https://go-zero.dev/docs/advance/api-coding",target:"_blank",rel:"noopener noreferrer"},_=e("br",null,null,-1),y=e("br",null,null,-1),x={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"},w=e("h2",{id:"responsibilities-of-the-api-service",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#responsibilities-of-the-api-service","aria-hidden":"true"},"#"),a(" Responsibilities of the API service")],-1),T=e("p",null,"In simple admin, the API service acts as a gateway, mainly providing the following functions:",-1),I=e("ul",null,[e("li",null,"User authentication, such as JWT"),e("li",null,"Data processing, such as data filtering, international translation"),e("li",null,"Current limiting and fusing")],-1),N=e("p",null,"An API can access multiple RPCs, providing a unified request entry。",-1),P={class:"hint-container info"},q=e("p",{class:"hint-container-title"},"Info",-1),j={href:"https://youtu.be/duSIv0qcCV8",target:"_blank",rel:"noopener noreferrer"},C=t(`<h2 id="create-api-project" tabindex="-1"><a class="header-anchor" href="#create-api-project" aria-hidden="true">#</a> Create API project</h2><blockquote><p>Create example project</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api new example <span class="token parameter variable">--i18n</span><span class="token operator">=</span>true <span class="token parameter variable">--casbin</span><span class="token operator">=</span>true <span class="token parameter variable">--trans_err</span><span class="token operator">=</span>true <span class="token parameter variable">--module_name</span><span class="token operator">=</span>github.com/suyuan32/simple-admin-example-api <span class="token parameter variable">--port</span><span class="token operator">=</span><span class="token number">8081</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see the project structure:</p></blockquote><figure><img src="`+r+`" alt="Example" tabindex="0" loading="lazy"><figcaption>Example</figcaption></figure><h3 id="file-structure" tabindex="-1"><a class="header-anchor" href="#file-structure" aria-hidden="true">#</a> File structure</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── desc                             api declaration file storage directory
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="api-proto-parameters" tabindex="-1"><a class="header-anchor" href="#api-proto-parameters" aria-hidden="true">#</a> <code>api proto</code> parameters</h3><table><thead><tr><th>Parameters</th><th>Must</th><th>Default</th><th>Introduction</th><th>Usage</th></tr></thead><tbody><tr><td>proto</td><td>Yes</td><td></td><td>Proto file path</td><td>Input the absolute path of proto file. <strong>It should be the proto in <code>root</code> directory, not in desc. Because it needs package data and <code>Base</code> data.</strong></td></tr><tr><td>style</td><td>No</td><td>go_zero</td><td>File name format</td><td>The go_zero means snack format</td></tr><tr><td>i18n</td><td>No</td><td>false</td><td>Whether to use i18n</td><td>true means use</td></tr><tr><td>api_service_name</td><td>Yes</td><td></td><td>API Service name</td><td>The API service name set in <code>.api</code> file</td></tr><tr><td>rpc_service_name</td><td>Yes</td><td></td><td>RPC Service name</td><td>The RPC service name set in <code>.proto</code> file</td></tr><tr><td>output</td><td>Yes</td><td></td><td>Output path</td><td>The output path，it can be relative path. It should target to the root path of project.</td></tr><tr><td>model</td><td>Yes</td><td></td><td>Model name</td><td>The structure name in schema，e.g. the Student in example project</td></tr><tr><td>rpc_name</td><td>Yes</td><td></td><td>RPC name</td><td>Input Example will generate l.svcCtx.ExampleRpc</td></tr><tr><td>grpc_package</td><td>Yes</td><td></td><td>RPC *_grpc.go package path</td><td>In example project is github.com/suyuan32/simple-admin-example-rpc/example</td></tr><tr><td>multiple</td><td>No</td><td>false</td><td>Multiple Service</td><td>If your proto file contains multiple service, you should set true</td></tr><tr><td>json_style</td><td>No</td><td>goZero</td><td>JSON tag format, the default is small camelCase</td><td>go_zero is underscore, GoZero is large camelCase</td></tr><tr><td>import_prefix</td><td>No</td><td></td><td>The path prefix of import</td><td>Import paths&#39; prefix is only used when the service in sub folder, such as core service&#39;s api and rpc</td></tr><tr><td>overwrite</td><td>No</td><td>false</td><td>Whether it covers the generated file</td><td><code>true</code> will cover all generated files</td></tr><tr><td>optional_service</td><td>No</td><td>false</td><td>Whether the service is optional</td><td><code>true</code> will generate logic code to judge the service status</td></tr></tbody></table><p>** Run <code>goctls api proto --help</code> see more details. **</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls api proto <span class="token parameter variable">-h</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,30),E={class:"hint-container info"},z=t(`<p class="hint-container-title">Info</p><p>Multiple Service Example, multiple is used to generate separate RPC client when there are several RPC service in one proto file.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api proto <span class="token parameter variable">--proto</span><span class="token operator">=</span>/home/ryan/GolandProjects/simple-admin-example-rpc/example.proto <span class="token parameter variable">--style</span><span class="token operator">=</span>go_zero <span class="token parameter variable">--api_service_name</span><span class="token operator">=</span>example <span class="token parameter variable">--rpc_service_name</span><span class="token operator">=</span>school <span class="token parameter variable">--o</span><span class="token operator">=</span>./ <span class="token parameter variable">--model</span><span class="token operator">=</span>Teacher <span class="token parameter variable">--rpc_name</span><span class="token operator">=</span>School <span class="token parameter variable">--grpc_package</span><span class="token operator">=</span>github.com/suyuan32/simple-admin-example-rpc/example <span class="token parameter variable">--multiple</span><span class="token operator">=</span>true
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,3),S={href:"https://github.com/suyuan32/simple-admin-example-api/tree/multiple",target:"_blank",rel:"noopener noreferrer"},A=e("p",null,"The codes generated is like below:",-1),R=e("figure",null,[e("img",{src:i,alt:"pic",tabindex:"0",loading:"lazy"}),e("figcaption",null,"pic")],-1),W={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"},M=t('<div class="hint-container warning"><p class="hint-container-title">Note</p><p>You need to add <code>ExampleRpc</code> manually into <code>service_context</code>, <code>config</code>, <code>etc</code>.</p></div><h2 id="code-generation-ent-based-single-service" tabindex="-1"><a class="header-anchor" href="#code-generation-ent-based-single-service" aria-hidden="true">#</a> Code generation (Ent-based single service)</h2>',2),Y={class:"hint-container info"},D=e("p",{class:"hint-container-title"},"Info",-1),U={href:"https://youtu.be/h3wybuEdg4s",target:"_blank",rel:"noopener noreferrer"},L=e("div",{class:"hint-container info"},[e("p",{class:"hint-container-title"},"Info"),e("p",null,"If your project is small, single API service is a good choise. It doesn't need RPC services.")],-1),O={class:"hint-container warning"},B=e("p",{class:"hint-container-title"},"Note",-1),G=e("code",null,"--ent=true",-1),F=e("code",null,"api new",-1),V=e("br",null,null,-1),Z={href:"https://github.com/suyuan32/simple-admin-example-api-single",target:"_blank",rel:"noopener noreferrer"},J=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api ent <span class="token parameter variable">--schema</span><span class="token operator">=</span>./ent/schema <span class="token parameter variable">--api_service_name</span><span class="token operator">=</span>example <span class="token parameter variable">--output</span><span class="token operator">=</span>./ <span class="token parameter variable">--model</span><span class="token operator">=</span><span class="token punctuation">{</span>modelName<span class="token punctuation">}</span> <span class="token parameter variable">--group</span><span class="token operator">=</span><span class="token punctuation">{</span>groupName<span class="token punctuation">}</span> <span class="token parameter variable">--search_key_num</span><span class="token operator">=</span><span class="token number">3</span> <span class="token parameter variable">--overwrite</span><span class="token operator">=</span>true
...
└── internal
     ...
     └── utils                                # tools directory
         ...
         └── entx                             # Ent transaction support function
             └── ent_tx.go
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7);function H($,K){const n=o("ExternalLinkIcon");return d(),p("div",null,[u,e("div",m,[v,b,h,e("p",null,[k,a(" Must know go-zero's API command. "),e("a",g,[a("API Command"),s(n)]),a(),e("a",f,[a("Api Service"),s(n)]),a(),_,y,a(" Refer to the "),e("a",x,[a("Example"),s(n)]),a(" project to generate it again, confirm that the generated file is consistent with the Example project, and the Example project has complete commands.")])]),w,T,I,N,e("div",P,[q,e("p",null,[e("a",j,[a("Tutorial"),s(n)])])]),C,e("div",E,[z,e("p",null,[e("a",S,[a("Example Code"),s(n)])])]),A,R,e("blockquote",null,[e("p",null,[a("See more detail in simple admin example api URL "),e("a",W,[a("https://github.com/suyuan32/simple-admin-example-api"),s(n)])])]),M,e("div",Y,[D,e("p",null,[e("a",U,[a("Tutorial Video"),s(n)])])]),L,e("div",O,[B,e("p",null,[a("Single services need to set "),G,a(" when using the "),F,a(" command. "),V,a(" Learn from "),e("a",Z,[a("Single Example"),s(n)])])]),J])}const ae=l(c,[["render",H],["__file","api_example.html.vue"]]);export{ae as default};
