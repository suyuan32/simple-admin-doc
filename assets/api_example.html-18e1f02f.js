...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p>创建项目名称仅支持小写和驼峰命名</p></div><h3 id="api-new-参数介绍" tabindex="-1"><a class="header-anchor" href="#api-new-参数介绍" aria-hidden="true">#</a> <code>api new</code> 参数介绍</h3>`,11),P=n("thead",null,[n("tr",null,[n("th",null,"参数"),n("th",null,"必须"),n("th",null,"默认值"),n("th",null,"介绍"),n("th",null,"使用方法")])],-1),E=n("tr",null,[n("td",null,"i18n"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否启用 i18n"),n("td",null,"true 为启用")],-1),C=n("tr",null,[n("td",null,"casbin"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否启用 casbin 进行鉴权并自动添加中间件"),n("td",null,"true 为启用")],-1),A=n("tr",null,[n("td",null,"module_name"),n("td",null,"否"),n("td"),n("td",null,"go.mod 中的 module 名称"),n("td",null,"如果项目需要被在外部 import，需要像上面例子设置为 github 或者其他地方的仓库网址， 为空则 module 为项目名称")],-1),N=n("td",null,"go_zero_version",-1),I=n("td",null,"否",-1),j=n("td",null,"v1.5.2",-1),S=n("td",null,"go zero 版本",-1),R={href:"https://github.com/zeromicro/go-zero/releases",target:"_blank",rel:"noopener noreferrer"},D=n("td",null,"tool_version",-1),T=n("td",null,"否",-1),L=n("td",null,"v1.5.5",-1),B=n("td",null,"simple admin tools 版本号",-1),M={href:"https://github.com/suyuan32/simple-admin-tools/releases",target:"_blank",rel:"noopener noreferrer"},Z=n("tr",null,[n("td",null,"trans_err"),n("td",null,"否"),n("td",null,"false"),n("td",null,"国际化翻译错误信息"),n("td",null,"true 为启用")],-1),V=n("tr",null,[n("td",null,"gitlab"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否生成 gitlab-ci.yml"),n("td",null,"true 为生成")],-1),G=n("tr",null,[n("td",null,"port"),n("td",null,"否"),n("td",null,"9100"),n("td",null,"端口号"),n("td",null,"服务暴露的端口号")],-1),J=n("tr",null,[n("td",null,"ent"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否启用 Ent"),n("td",null,"true 为启用，启用 Ent 可用于单体 API 服务")],-1),O=l(`<p><strong>详细参数请在命令行查看 <code>goctls api new --help</code></strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls api new <span class="token parameter variable">--help</span>
快速创建 API 服务
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="api-proto-参数介绍" tabindex="-1"><a class="header-anchor" href="#api-proto-参数介绍" aria-hidden="true">#</a> <code>api proto</code> 参数介绍</h3>`,17),H=n("thead",null,[n("tr",null,[n("th",null,"参数"),n("th",null,"必须"),n("th",null,"默认值"),n("th",null,"介绍"),n("th",null,"使用方法")])],-1),$=n("tr",null,[n("td",null,"proto"),n("td",null,"是"),n("td"),n("td",null,"proto 文件地址"),n("td",null,[a("输入 proto 文件的绝对路径。 "),n("strong",null,"注意要为合并后的 proto 即根目录下的 proto ，不是 desc 文件夹中的，因为要获取 package 和 Base 结构")])],-1),U=n("tr",null,[n("td",null,"style"),n("td",null,"否"),n("td",null,"go_zero"),n("td",null,"文件名格式"),n("td",null,"go_zero 为蛇形格式")],-1),W=n("tr",null,[n("td",null,"api_service_name"),n("td",null,"是"),n("td"),n("td",null,"服务名称"),n("td",null,"api 服务的 service 名称, 在 api 声明文件中")],-1),X=n("tr",null,[n("td",null,"rpc_service_name"),n("td",null,"是"),n("td"),n("td",null,"服务名称"),n("td",null,"rpc 服务的名称, 与 proto 文件中的 service 名称一致")],-1),K=n("tr",null,[n("td",null,"output"),n("td",null,"是"),n("td"),n("td",null,"输出位置"),n("td",null,"文件输出位置，可以为相对路径，指向 main 文件目录")],-1),Y=n("tr",null,[n("td",null,"model"),n("td",null,"是"),n("td"),n("td",null,"模型名称"),n("td",null,"schema 中内部 struct 名称，如 example 中的 Student")],-1),F=n("tr",null,[n("td",null,"rpc_name"),n("td",null,"是"),n("td"),n("td",null,"RPC 名称"),n("td",null,"输入 Example 则生成文件会生成 l.svcCtx.ExampleRpc")],-1),Q=n("td",null,"grpc_package",-1),nn=n("td",null,"是",-1),an=n("td",null,null,-1),en=n("td",null,"RPC *_grpc.go 包路径",-1),sn={href:"http://github.com/suyuan32/simple-admin-example-rpc/example",target:"_blank",rel:"noopener noreferrer"},ln=n("tr",null,[n("td",null,"multiple"),n("td",null,"否"),n("td",null,"false"),n("td",null,"多服务"),n("td",null,"若 proto 文件中有多个 service, 需要设置为 true")],-1),tn=n("tr",null,[n("td",null,"json_style"),n("td",null,"否"),n("td",null,"goZero"),n("td",null,"JSON tag 的格式，默认为小驼峰"),n("td",null,"go_zero 为下划线， GoZero 为大驼峰")],-1),rn=n("tr",null,[n("td",null,"overwrite"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否覆盖生成文件"),n("td",null,"true 则会覆盖所有生成的文件")],-1),on=l(`<p><strong>详细参数请在命令行查看 <code>goctls api proto --help</code></strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls api proto <span class="token parameter variable">--help</span>
从 proto 文件生成 CRUD 模板

用法：
  goctl api proto <span class="token punctuation">[</span>选项<span class="token punctuation">]</span>
...
选项：
  ...
  -h, <span class="token parameter variable">--help</span>                      显示帮助信息
  -j, <span class="token parameter variable">--json_style</span> string         JSON 标签格式，默认为驼峰式 <span class="token punctuation">(</span>默认为 <span class="token string">&quot;goZero&quot;</span><span class="token punctuation">)</span>
  -m, <span class="token parameter variable">--model</span> string              要生成的模型名称，例如 user，如果为空，则为 schema 目录中的所有模型生成代码
      <span class="token parameter variable">--multiple</span>                  proto 文件是否包含多个服务
  -o, <span class="token parameter variable">--output</span> string             输出路径
  -w, <span class="token parameter variable">--overwrite</span>                 是否覆盖已生成的文件，它将覆盖所有已生成的文件
  -p, <span class="token parameter variable">--proto</span> string              proto 文件路径
  -n, <span class="token parameter variable">--rpc_name</span> string           服务上下文中的 RPC 名称。例如 CoreRpc
  -r, <span class="token parameter variable">--rpc_service_name</span> string   RPC 服务名称
  -k, <span class="token parameter variable">--search_key_num</span> int        搜索键的最大数量 <span class="token punctuation">(</span>默认为 <span class="token number">3</span><span class="token punctuation">)</span>
  -s, <span class="token parameter variable">--style</span> string              文件名格式样式 <span class="token punctuation">(</span>默认为 <span class="token string">&quot;go_zero&quot;</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),pn={class:"hint-container info"},dn=l(`<p class="hint-container-title">相关信息</p><p>multiple 例子, multiple 用于根据不同服务生成多个 rpcclient</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api proto <span class="token parameter variable">--proto</span><span class="token operator">=</span>/home/ryan/GolandProjects/simple-admin-example-rpc/example.proto <span class="token parameter variable">--style</span><span class="token operator">=</span>go_zero <span class="token parameter variable">--api_service_name</span><span class="token operator">=</span>example <span class="token parameter variable">--rpc_service_name</span><span class="token operator">=</span>school <span class="token parameter variable">--o</span><span class="token operator">=</span>./ <span class="token parameter variable">--model</span><span class="token operator">=</span>Teacher <span class="token parameter variable">--rpc_name</span><span class="token operator">=</span>School <span class="token parameter variable">--grpc_package</span><span class="token operator">=</span>github.com/suyuan32/simple-admin-example-rpc/example <span class="token parameter variable">--multiple</span><span class="token operator">=</span>true
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,3),cn={href:"https://github.com/suyuan32/simple-admin-example-api/tree/multiple",target:"_blank",rel:"noopener noreferrer"},un=n("blockquote",null,[n("p",null,"生成效果")],-1),mn=n("figure",null,[n("img",{src:t,alt:"pic",tabindex:"0",loading:"lazy"}),n("figcaption",null,"pic")],-1),vn={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"},bn=l('<div class="hint-container warning"><p class="hint-container-title">注意</p><p>还需要手动添加<code>ExampleRpc</code>到<code>service_context</code>, <code>config</code>, <code>etc</code></p></div><h2 id="代码生成-基于-ent-的单体服务" tabindex="-1"><a class="header-anchor" href="#代码生成-基于-ent-的单体服务" aria-hidden="true">#</a> 代码生成 (基于 Ent 的单体服务)</h2>',2),kn={class:"hint-container info"},hn=n("p",{class:"hint-container-title"},"相关信息",-1),gn={href:"https://www.bilibili.com/video/BV1oa4y1A7rT/",target:"_blank",rel:"noopener noreferrer"},_n=n("div",{class:"hint-container info"},[n("p",{class:"hint-container-title"},"相关信息"),n("p",null,"如果你的项目较小， 单体 API 服务比较适合你。直接在 API 层操作数据库，无需连接 RPC。")],-1),xn={class:"hint-container warning"},yn=n("p",{class:"hint-container-title"},"注意",-1),fn=n("code",null,"api new",-1),wn=n("code",null,"--ent=true",-1),zn=n("br",null,null,-1),qn={href:"https://github.com/suyuan32/simple-admin-example-api-single",target:"_blank",rel:"noopener noreferrer"},Pn=l(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api ent <span class="token parameter variable">--schema</span><span class="token operator">=</span>./ent/schema <span class="token parameter variable">--api_service_name</span><span class="token operator">=</span>example <span class="token parameter variable">--output</span><span class="token operator">=</span>./ <span class="token parameter variable">--model</span><span class="token operator">=</span><span class="token punctuation">{</span>modelName<span class="token punctuation">}</span> <span class="token parameter variable">--group</span><span class="token operator">=</span><span class="token punctuation">{</span>groupName<span class="token punctuation">}</span> <span class="token parameter variable">--search_key_num</span><span class="token operator">=</span><span class="token number">3</span> <span class="token parameter variable">--overwrite</span><span class="token operator">=</span>true
...
用法：
  goctl api ent <span class="token punctuation">[</span>选项<span class="token punctuation">]</span>

选项：
  -a, <span class="token parameter variable">--api_service_name</span> string   API 服务名称
  -g, <span class="token parameter variable">--group</span> string              逻辑文件的组名称，例如 user
  -h, <span class="token parameter variable">--help</span>                      显示帮助信息
  -j, <span class="token parameter variable">--json_style</span> string         JSON 标签格式，默认为驼峰格式 <span class="token punctuation">(</span>默认为 <span class="token string">&quot;goZero&quot;</span><span class="token punctuation">)</span>
  -m, <span class="token parameter variable">--model</span> string              要生成的模型名称，例如 user，如果为空，则为 schema 目录中的所有模型生成代码
  -o, <span class="token parameter variable">--output</span> string             输出路径
  -w, <span class="token parameter variable">--overwrite</span>                 是否覆盖已生成的文件，它将覆盖所有已生成的文件
...
└── internal
    ...
    └── utils                                  # 工具目录
        ...
        └── entx                               # Ent事务支持函数
            └── ent_tx.go
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8);function En(Cn,An){const e=d("ExternalLinkIcon");return o(),p("div",null,[u,n("div",m,[v,b,k,n("p",null,[a("必须了解 go zero 的 API 命令 "),n("a",h,[a("API 命令"),s(e)]),a(),n("a",g,[a("api 文件编写"),s(e)]),a(),_,x,a(" 参考 "),n("a",y,[a("Example"),s(e)]),a(" 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令")])]),n("div",f,[w,n("p",null,[n("a",z,[a("视频教程"),s(e)])])]),q,n("table",null,[P,n("tbody",null,[E,C,A,n("tr",null,[N,I,j,S,n("td",null,[a("需要到"),n("a",R,[a("go-zero"),s(e)]),a("查看最新 release")])]),n("tr",null,[D,T,L,B,n("td",null,[a("需要到"),n("a",M,[a("tool"),s(e)]),a("查看 simple admin tools 最新 release")])]),Z,V,G,J])]),O,n("table",null,[H,n("tbody",null,[$,U,W,X,K,Y,F,n("tr",null,[Q,nn,an,en,n("td",null,[a("在 example 中是 "),n("a",sn,[a("github.com/suyuan32/simple-admin-example-rpc/example"),s(e)])])]),ln,tn,rn])]),on,n("div",pn,[dn,n("p",null,[n("a",cn,[a("代码"),s(e)])])]),un,mn,n("blockquote",null,[n("p",null,[a("详情查看 simple admin example api 地址 "),n("a",vn,[a("https://github.com/suyuan32/simple-admin-example-api"),s(e)])])]),bn,n("div",kn,[hn,n("p",null,[n("a",gn,[a("视频教程"),s(e)])])]),_n,n("div",xn,[yn,n("p",null,[a("单体服务需要在 使用 "),fn,a(" 命令时设置 "),wn,a(". "),zn,a(" 示例项目 "),n("a",qn,[a("Single Example"),s(e)])])]),Pn])}const jn=r(c,[["render",En],["__file","api_example.html.vue"]]);export{jn as default};
