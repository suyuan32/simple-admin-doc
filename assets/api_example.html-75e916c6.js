...
└── internal
    ...
    └── utils                                  # 工具目录
        ...
        └── entx                               # Ent事务支持函数
            └── ent_tx.go
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7);function fn(yn,xn){const a=c("ExternalLinkIcon");return o(),p("div",null,[u,n("div",m,[v,b,k,n("p",null,[e("必须了解 go zero 的 API 命令 "),n("a",h,[e("API 命令"),s(a)]),e(),n("a",g,[e("api 文件编写"),s(a)]),e(),_,f,e(" 参考 "),n("a",y,[e("Example"),s(a)]),e(" 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令")])]),x,n("table",null,[w,n("tbody",null,[T,P,z,n("tr",null,[q,E,C,A,n("td",null,[e("需要到"),n("a",N,[e("go-zero"),s(a)]),e("查看最新 release")])]),n("tr",null,[I,j,S,R,n("td",null,[e("需要到"),n("a",W,[e("tool"),s(a)]),e("查看 simple admin tools 最新 release")])]),D,M,Z,G])]),L,n("table",null,[U,n("tbody",null,[B,J,O,F,H,V,$,n("tr",null,[K,X,Y,Q,n("td",null,[e("在 example 中是 "),n("a",nn,[e("github.com/suyuan32/simple-admin-example-rpc/example"),s(a)])])]),en,an,sn])]),tn,n("div",ln,[rn,n("p",null,[n("a",on,[e("代码"),s(a)])])]),pn,cn,n("blockquote",null,[n("p",null,[e("详情查看 simple admin example api 地址 "),n("a",dn,[e("https://github.com/suyuan32/simple-admin-example-api"),s(a)])])]),un,n("div",mn,[vn,n("p",null,[e("单体服务需要在 使用 "),bn,e(" 命令时设置 "),kn,e(". "),hn,e(" 示例项目 "),n("a",gn,[e("Single Example"),s(a)])])]),_n])}const Pn=r(d,[["render",fn],["__file","api_example.html.vue"]]);export{Pn as default};
