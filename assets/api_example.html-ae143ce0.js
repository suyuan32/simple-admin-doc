import{_ as i,a as l}from"./api_gen_struct-3403667f.js";import{_ as r}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as p,c as d,a as e,b as n,d as s,e as t}from"./app-46fafa83.js";const c={},u=e("h1",{id:"_3-minutes-developing-api-service",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_3-minutes-developing-api-service","aria-hidden":"true"},"#"),n(" 3 minutes developing API service")],-1),m={class:"hint-container warning"},v=e("p",{class:"hint-container-title"},"Note",-1),h=e("p",null,"Make sure that you have been installed follow software:",-1),b=e("ul",null,[e("li",null,"simple-admin-tool (goctls) v1.5.5 +")],-1),k=e("br",null,null,-1),g={href:"https://go-zero.dev/docs/goctl/api",target:"_blank",rel:"noopener noreferrer"},f={href:"https://go-zero.dev/docs/advance/api-coding",target:"_blank",rel:"noopener noreferrer"},_=e("br",null,null,-1),y=e("br",null,null,-1),x={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"},w=e("h2",{id:"responsibilities-of-the-api-service",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#responsibilities-of-the-api-service","aria-hidden":"true"},"#"),n(" Responsibilities of the API service")],-1),T=e("p",null,"In simple admin, the API service acts as a gateway, mainly providing the following functions:",-1),I=e("ul",null,[e("li",null,"User authentication, such as JWT"),e("li",null,"Data processing, such as data filtering, international translation"),e("li",null,"Current limiting and fusing")],-1),N=e("p",null,"An API can access multiple RPCs, providing a unified request entry。",-1),P={class:"hint-container info"},j=e("p",{class:"hint-container-title"},"Info",-1),q={href:"https://youtu.be/duSIv0qcCV8",target:"_blank",rel:"noopener noreferrer"},C=t(`<h2 id="create-api-project" tabindex="-1"><a class="header-anchor" href="#create-api-project" aria-hidden="true">#</a> Create API project</h2><blockquote><p>Create example project</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api new example <span class="token parameter variable">--i18n</span><span class="token operator">=</span>true <span class="token parameter variable">--casbin</span><span class="token operator">=</span>true <span class="token parameter variable">--trans_err</span><span class="token operator">=</span>true <span class="token parameter variable">--module_name</span><span class="token operator">=</span>github.com/suyuan32/simple-admin-example-api <span class="token parameter variable">--port</span><span class="token operator">=</span><span class="token number">8081</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>Simpler Command</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api new example <span class="token parameter variable">-i</span> <span class="token parameter variable">-c</span> <span class="token parameter variable">-a</span> <span class="token parameter variable">-m</span> github.com/suyuan32/simple-admin-example-api <span class="token parameter variable">-p</span> <span class="token number">8081</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">Note</p><p>Create a project name that only supports lowercase and camelcase</p></div><h3 id="api-new-parameters" tabindex="-1"><a class="header-anchor" href="#api-new-parameters" aria-hidden="true">#</a> <code>api new</code> parameters</h3><table><thead><tr><th>Parameter</th><th>Must</th><th>Default</th><th>Introduction</th><th>Usage</th></tr></thead><tbody><tr><td>i18n</td><td>No</td><td>false</td><td>Whether to use i18n</td><td>true means use</td></tr><tr><td>casbin</td><td>No</td><td>false</td><td>Whether to enable casbin for authentication and automatically add middleware</td><td>true means use</td></tr><tr><td>module_name</td><td>No</td><td></td><td>Module name in go.mod</td><td>If your project will be used by other project, you should set as above which is a github repository. If it is empty, the module will be the same as project name.</td></tr><tr><td>trans_err</td><td>No</td><td>false</td><td>Whether to use i18n in error</td><td>true means use</td></tr><tr><td>port</td><td>No</td><td>9100</td><td>port number</td><td>The service port</td></tr><tr><td>style</td><td>No</td><td>go_zero</td><td>The format of the file name.</td><td>snake case format is go_zero.</td></tr></tbody></table><p><strong>More parameters please check <code>goctls api new --help</code></strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls api new <span class="token parameter variable">--help</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see the project structure:</p></blockquote><figure><img src="`+l+`" alt="Example" tabindex="0" loading="lazy"><figcaption>Example</figcaption></figure><h3 id="file-structure" tabindex="-1"><a class="header-anchor" href="#file-structure" aria-hidden="true">#</a> File structure</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── desc                             api declaration file storage directory
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>Simpler</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api proto <span class="token parameter variable">-p</span> /home/ryan/GolandProjects/simple-admin-example-rpc/example.proto <span class="token parameter variable">-a</span> example <span class="token parameter variable">-r</span> Example <span class="token parameter variable">--o</span> ./ <span class="token parameter variable">-m</span> Student <span class="token parameter variable">-n</span> Example <span class="token parameter variable">-g</span> github.com/suyuan32/simple-admin-example-rpc/types/example <span class="token parameter variable">-i</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="api-proto-parameters" tabindex="-1"><a class="header-anchor" href="#api-proto-parameters" aria-hidden="true">#</a> <code>api proto</code> parameters</h3>`,27),E=e("thead",null,[e("tr",null,[e("th",null,"Parameters"),e("th",null,"Must"),e("th",null,"Default"),e("th",null,"Introduction"),e("th",null,"Usage")])],-1),S=e("tr",null,[e("td",null,"proto"),e("td",null,"Yes"),e("td"),e("td",null,"Proto file path"),e("td",null,[n("Input the absolute path of proto file. "),e("strong",null,[n("It should be the proto in "),e("code",null,"root"),n(" directory, not in desc. Because it needs package data and "),e("code",null,"Base"),n(" data.")])])],-1),z=e("tr",null,[e("td",null,"style"),e("td",null,"No"),e("td",null,"go_zero"),e("td",null,"File name format"),e("td",null,"The go_zero means snack format")],-1),A=e("tr",null,[e("td",null,"i18n"),e("td",null,"No"),e("td",null,"false"),e("td",null,"Whether to use i18n"),e("td",null,"true means use")],-1),R=e("tr",null,[e("td",null,"api_service_name"),e("td",null,"Yes"),e("td"),e("td",null,"API Service name"),e("td",null,[n("The API service name set in "),e("code",null,".api"),n(" file")])],-1),W=e("tr",null,[e("td",null,"rpc_service_name"),e("td",null,"Yes"),e("td"),e("td",null,"RPC Service name"),e("td",null,[n("The RPC service name set in "),e("code",null,".proto"),n(" file")])],-1),M=e("tr",null,[e("td",null,"output"),e("td",null,"Yes"),e("td"),e("td",null,"Output path"),e("td",null,"The output path，it can be relative path. It should target to the root path of project.")],-1),Y=e("tr",null,[e("td",null,"model"),e("td",null,"Yes"),e("td"),e("td",null,"Model name"),e("td",null,"The structure name in schema，e.g. the Student in example project")],-1),D=e("tr",null,[e("td",null,"rpc_name"),e("td",null,"Yes"),e("td"),e("td",null,"RPC name"),e("td",null,"Input Example will generate l.svcCtx.ExampleRpc")],-1),U=e("td",null,"grpc_package",-1),L=e("td",null,"Yes",-1),O=e("td",null,null,-1),B=e("td",null,"RPC *_grpc.go package path",-1),G={href:"http://github.com/suyuan32/simple-admin-example-rpc/example",target:"_blank",rel:"noopener noreferrer"},F=e("tr",null,[e("td",null,"multiple"),e("td",null,"No"),e("td",null,"false"),e("td",null,"Multiple Service"),e("td",null,"If your proto file contains multiple service, you should set true")],-1),V=e("tr",null,[e("td",null,"json_style"),e("td",null,"No"),e("td",null,"goZero"),e("td",null,"JSON tag format, the default is small camelCase"),e("td",null,"go_zero is underscore, GoZero is large camelCase")],-1),Z=e("tr",null,[e("td",null,"import_prefix"),e("td",null,"No"),e("td"),e("td",null,"The path prefix of import"),e("td",null,"Import paths' prefix is only used when the service in sub folder, such as core service's api and rpc")],-1),J=e("tr",null,[e("td",null,"overwrite"),e("td",null,"No"),e("td",null,"false"),e("td",null,"Whether it covers the generated file"),e("td",null,[e("code",null,"true"),n(" will cover all generated files")])],-1),H=e("tr",null,[e("td",null,"optional_service"),e("td",null,"No"),e("td",null,"false"),e("td",null,"Whether the service is optional"),e("td",null,[e("code",null,"true"),n(" will generate logic code to judge the service status")])],-1),$=t(`<p>** Run <code>goctls api proto --help</code> see more details. **</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls api proto <span class="token parameter variable">-h</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),K={class:"hint-container info"},Q=t(`<p class="hint-container-title">Info</p><p>Multiple Service Example, multiple is used to generate separate RPC client when there are several RPC service in one proto file.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api proto <span class="token parameter variable">--proto</span><span class="token operator">=</span>/home/ryan/GolandProjects/simple-admin-example-rpc/example.proto <span class="token parameter variable">--style</span><span class="token operator">=</span>go_zero <span class="token parameter variable">--api_service_name</span><span class="token operator">=</span>example <span class="token parameter variable">--rpc_service_name</span><span class="token operator">=</span>school <span class="token parameter variable">--o</span><span class="token operator">=</span>./ <span class="token parameter variable">--model</span><span class="token operator">=</span>Teacher <span class="token parameter variable">--rpc_name</span><span class="token operator">=</span>School <span class="token parameter variable">--grpc_package</span><span class="token operator">=</span>github.com/suyuan32/simple-admin-example-rpc/example <span class="token parameter variable">--multiple</span><span class="token operator">=</span>true
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,3),X={href:"https://github.com/suyuan32/simple-admin-example-api/tree/multiple",target:"_blank",rel:"noopener noreferrer"},ee=e("p",null,"The codes generated is like below:",-1),ne=e("figure",null,[e("img",{src:i,alt:"pic",tabindex:"0",loading:"lazy"}),e("figcaption",null,"pic")],-1),ae={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"},se=t('<div class="hint-container warning"><p class="hint-container-title">Note</p><p>You need to add <code>ExampleRpc</code> manually into <code>service_context</code>, <code>config</code>, <code>etc</code>.</p></div><h2 id="code-generation-ent-based-single-service" tabindex="-1"><a class="header-anchor" href="#code-generation-ent-based-single-service" aria-hidden="true">#</a> Code generation (Ent-based single service)</h2>',2),te={class:"hint-container info"},ie=e("p",{class:"hint-container-title"},"Info",-1),le={href:"https://youtu.be/h3wybuEdg4s",target:"_blank",rel:"noopener noreferrer"},re=e("div",{class:"hint-container info"},[e("p",{class:"hint-container-title"},"Info"),e("p",null,"If your project is small, single API service is a good choise. It doesn't need RPC services.")],-1),oe={class:"hint-container warning"},pe=e("p",{class:"hint-container-title"},"Note",-1),de=e("code",null,"--ent=true",-1),ce=e("code",null,"api new",-1),ue=e("br",null,null,-1),me={href:"https://github.com/suyuan32/simple-admin-example-api-single",target:"_blank",rel:"noopener noreferrer"},ve=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls api ent <span class="token parameter variable">--schema</span><span class="token operator">=</span>./ent/schema <span class="token parameter variable">--api_service_name</span><span class="token operator">=</span>example <span class="token parameter variable">--output</span><span class="token operator">=</span>./ <span class="token parameter variable">--model</span><span class="token operator">=</span><span class="token punctuation">{</span>modelName<span class="token punctuation">}</span> <span class="token parameter variable">--group</span><span class="token operator">=</span><span class="token punctuation">{</span>groupName<span class="token punctuation">}</span> <span class="token parameter variable">--search_key_num</span><span class="token operator">=</span><span class="token number">3</span> <span class="token parameter variable">--overwrite</span><span class="token operator">=</span>true
...
└── internal
     ...
     └── utils                                # tools directory
         ...
         └── entx                             # Ent transaction support function
             └── ent_tx.go
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7);function he(be,ke){const a=o("ExternalLinkIcon");return p(),d("div",null,[u,e("div",m,[v,h,b,e("p",null,[k,n(" Must know go-zero's API command. "),e("a",g,[n("API Command"),s(a)]),n(),e("a",f,[n("Api Service"),s(a)]),n(),_,y,n(" Refer to the "),e("a",x,[n("Example"),s(a)]),n(" project to generate it again, confirm that the generated file is consistent with the Example project, and the Example project has complete commands.")])]),w,T,I,N,e("div",P,[j,e("p",null,[e("a",q,[n("Tutorial"),s(a)])])]),C,e("table",null,[E,e("tbody",null,[S,z,A,R,W,M,Y,D,e("tr",null,[U,L,O,B,e("td",null,[n("In example project is "),e("a",G,[n("github.com/suyuan32/simple-admin-example-rpc/example"),s(a)])])]),F,V,Z,J,H])]),$,e("div",K,[Q,e("p",null,[e("a",X,[n("Example Code"),s(a)])])]),ee,ne,e("blockquote",null,[e("p",null,[n("See more detail in simple admin example api URL "),e("a",ae,[n("https://github.com/suyuan32/simple-admin-example-api"),s(a)])])]),se,e("div",te,[ie,e("p",null,[e("a",le,[n("Tutorial Video"),s(a)])])]),re,e("div",oe,[pe,e("p",null,[n("Single services need to set "),de,n(" when using the "),ce,n(" command. "),ue,n(" Learn from "),e("a",me,[n("Single Example"),s(a)])])]),ve])}const ye=r(c,[["render",he],["__file","api_example.html.vue"]]);export{ye as default};
