import{_ as t,X as e,Y as o,Z as n,$ as s,a0 as p,a1 as i,F as c}from"./framework-3afc3da2.js";const u={},l=n("h2",{id:"how-to-use-asynq-as-a-message-queue-in-rpc",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#how-to-use-asynq-as-a-message-queue-in-rpc","aria-hidden":"true"},"#"),s(" How to use Asynq as a message queue in RPC?")],-1),r={class:"hint-container info"},d=n("p",{class:"hint-container-title"},"Official Document",-1),k={href:"https://github.com/hibiken/asynq/wiki",target:"_blank",rel:"noopener noreferrer"},v=i(`<h3 id="add-asynq-configuration-information" tabindex="-1"><a class="header-anchor" href="#add-asynq-configuration-information" aria-hidden="true">#</a> Add Asynq configuration information</h3><p><code>etc</code></p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">AsynqConf</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,11);function m(b,g){const a=c("ExternalLinkIcon");return e(),o("div",null,[l,n("div",r,[d,n("p",null,[n("a",k,[s("Document"),p(a)])])]),v])}const h=t(u,[["render",m],["__file","asynq.html.vue"]]);export{h as default};
