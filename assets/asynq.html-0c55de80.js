import{_ as t,X as e,Y as o,Z as n,$ as s,a0 as p,a1 as c,F as i}from"./framework-3afc3da2.js";const u={},l=n("h2",{id:"如何在-rpc-使用-asynq-作为消息队列",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#如何在-rpc-使用-asynq-作为消息队列","aria-hidden":"true"},"#"),s(" 如何在 RPC 使用 Asynq 作为消息队列？")],-1),r={class:"hint-container info"},d=n("p",{class:"hint-container-title"},"官方文档",-1),k={href:"https://github.com/hibiken/asynq/wiki",target:"_blank",rel:"noopener noreferrer"},v=c(`<h3 id="添加-asynq-配置信息" tabindex="-1"><a class="header-anchor" href="#添加-asynq-配置信息" aria-hidden="true">#</a> 添加 Asynq 配置信息</h3><p><code>etc</code></p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">AsynqConf</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,11);function m(b,g){const a=i("ExternalLinkIcon");return e(),o("div",null,[l,n("div",r,[d,n("p",null,[n("a",k,[s("文档"),p(a)])])]),v])}const f=t(u,[["render",m],["__file","asynq.html.vue"]]);export{f as default};
