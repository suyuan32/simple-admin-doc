import{_ as n,W as s,X as e,a0 as a}from"./framework-2d2f73c4.js";const i={},l=a(`<h2 id="定时任务模块" tabindex="-1"><a class="header-anchor" href="#定时任务模块" aria-hidden="true">#</a> 定时任务模块</h2><h3 id="下载代码" tabindex="-1"><a class="header-anchor" href="#下载代码" aria-hidden="true">#</a> 下载代码</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-job.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div>`,13),d=[l];function t(c,o){return s(),e("div",null,d)}const u=n(i,[["render",t],["__file","cron.html.vue"]]);export{u as default};
