import{_ as e}from"./cron_console-Dc6T7VfF.js";import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,c as l,d as n,e as t,b as c,o}from"./app-SeIJRtVB.js";const d="/assets/cron_zh.png",p={},r=n("h3",{id:"介绍",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#介绍"},[n("span",null,"介绍")])],-1),u={class:"hint-container info"},v=n("p",{class:"hint-container-title"},"相关信息",-1),m=n("p",null,[n("a",{href:"https://www.bilibili.com/video/BV1Ac411F7yx/",target:"_blank",rel:"noopener noreferrer"},"官方教程")],-1),b=c(`<p>Simple Admin Job 是 Simple Admin 的定时任务模块，目前已提供了基于 asynq 的动态定时任务及静态定时任务，基于 redis 实现，未来会接入 RocketMQ 实现额外的定时任务。</p><h3 id="下载代码" tabindex="-1"><a class="header-anchor" href="#下载代码"><span>下载代码</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-job.git
