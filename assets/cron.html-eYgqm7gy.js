import{_ as e}from"./cron_console-Dc6T7VfF.js";import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as t,c as l,a as n,b as o,e as c}from"./app-D1r_dmmg.js";const d="/assets/cron_en.png",p={},r=n("h3",{id:"introduction",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#introduction"},[n("span",null,"Introduction")])],-1),u=n("p",null,"Simple Admin Job is the scheduled task module of Simple Admin. It currently provides dynamic and static scheduled tasks based on asynq and implemented using Redis. In the future, it will integrate with RocketMQ to implement additional scheduled tasks.",-1),m={class:"hint-container info"},v=n("p",{class:"hint-container-title"},"Video tutorial",-1),k=c(`<h3 id="download-code" tabindex="-1"><a class="header-anchor" href="#download-code"><span>Download Code</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-job.git
