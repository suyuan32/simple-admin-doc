...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>If downloading dependencies fails, please upgrade pnpm to the latest version</p></blockquote><h3 id="run-in-development-mode" tabindex="-1"><a class="header-anchor" href="#run-in-development-mode" aria-hidden="true">#</a> Run in development mode</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> serve
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see</p></blockquote><figure><img src="`+o+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure>',45),_=n("h4",{id:"after-initialization-you-should-restart-api-and-rpc-service",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#after-initialization-you-should-restart-api-and-rpc-service","aria-hidden":"true"},"#"),s(),n("strong",null,"After initialization, you should restart api and rpc service.")],-1);function x(q,w){const t=l("ExternalLinkIcon"),a=l("RouterLink");return d(),p("div",null,[m,v,n("ul",null,[b,k,h,g,n("li",null,[n("a",y,[s("go-swagger"),e(t)])]),n("li",null,[e(a,{to:"/guide/basic-config/simple-admin-tools.html"},{default:i(()=>[s("Simple Admin Tool")]),_:1})])]),f,n("blockquote",null,[n("p",null,[s("File manager service is optional "),e(a,{to:"/simple-admin/en/docs/file_manager.html"},{default:i(()=>[s("File Manager")]),_:1})])]),_])}const L=c(u,[["render",x],["__file","env_setting.html.vue"]]);export{L as default};
