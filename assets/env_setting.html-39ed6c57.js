...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>进入界面</p><figure><img src="`+t+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>文件服务初始化是可选的，没有运行文件api可以不初始化</p></blockquote><div class="hint-container warning"><p class="hint-container-title">注意</p><p><strong>初始化完成后需要重启 api 和 rpc。</strong></p></div>',44);function _(x,q){const i=e("ExternalLinkIcon"),l=e("RouterLink");return p(),o("div",null,[m,v,n("ul",null,[k,b,h,g,n("li",null,[n("a",y,[s("go-swagger"),a(i)])]),n("li",null,[a(l,{to:"/zh/guide/basic-config/simple-admin-tools.html"},{default:d(()=>[s("Simple Admin Tool")]),_:1})])]),f])}const C=c(u,[["render",_],["__file","env_setting.html.vue"]]);export{C as default};
