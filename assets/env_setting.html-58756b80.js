...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>进入界面</p><figure><img src="`+c+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>文件服务初始化是可选的，没有运行文件 api 可以不初始化</p></blockquote>',42);function I(T,D){const e=t("ExternalLinkIcon"),i=t("RouterLink");return p(),d("div",null,[m,v,n("ul",null,[k,b,h,g,n("li",null,[n("a",y,[s("go-swagger"),a(e)])]),n("li",null,[a(i,{to:"/zh/guide/basic-config/simple-admin-tools.html"},{default:l(()=>[s("Simple Admin Tool")]),_:1})])]),n("div",_,[f,n("p",null,[s("推荐在 linux 下开发，因为需要用到 make 命令，官方在 "),q,s(" 环境下开发. "),x,n("strong",null,[E,s(" 用户建议在 "),n("a",P,[s("WSL"),a(e)]),s(" 环境下开发, 你也可以自行配置环境， 参考 "),a(i,{to:"/zh/guide/FAQ.html#%E5%A6%82%E4%BD%95%E9%85%8D%E7%BD%AE-windows-%E7%8E%AF%E5%A2%83"},{default:l(()=>[s("Windows")]),_:1})])])]),n("div",C,[S,n("p",null,[n("a",L,[s("视频教程"),a(e)])])]),w])}const R=o(u,[["render",I],["__file","env_setting.html.vue"]]);export{R as default};
