...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see</p></blockquote><figure><img src="`+o+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure>',42),_=n("h2",{id:"after-initialization-you-should-restart-api-and-rpc-service",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#after-initialization-you-should-restart-api-and-rpc-service","aria-hidden":"true"},"#"),s(),n("strong",null,"After initialization, you should restart api and rpc service.")],-1);function q(x,w){const t=l("ExternalLinkIcon"),a=l("RouterLink");return p(),d("div",null,[m,v,n("ul",null,[b,k,h,y,n("li",null,[n("ul",null,[n("li",null,[n("a",g,[s("go-swagger"),e(t)])])])]),n("li",null,[e(a,{to:"/guide/basic-config/simple-admin-tools.html"},{default:i(()=>[s("Simple Admin Tool")]),_:1})])]),f,n("blockquote",null,[n("p",null,[s("File manager service is optional "),e(a,{to:"/simple-admin/en/docs/file_manager.html"},{default:i(()=>[s("File Manager")]),_:1})])]),_])}const L=c(r,[["render",q],["__file","env_setting.html.vue"]]);export{L as default};
