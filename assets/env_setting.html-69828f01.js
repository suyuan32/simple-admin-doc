import{_ as o}from"./init_zh_cn-25f120d7.js";import{_ as c,X as d,Y as p,Z as n,$ as s,a0 as e,a2 as t,a1 as r,F as l}from"./framework-3afc3da2.js";const u={},m=n("h1",{id:"local-development-setting",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#local-development-setting","aria-hidden":"true"},"#"),s(" Local Development Setting")],-1),v=n("blockquote",null,[n("p",null,"Environment Requirement")],-1),b=n("li",null,"golang 1.20 +",-1),k=n("li",null,[n("strong",null,"nodejs 19.8.0 +")],-1),h=n("li",null,[n("strong",null,"mysql 8.0.21 +"),s(" | MariaDB 10.7 + | Postgres 13 + ("),n("strong",null,"Postgres 14 recommended"),s(")")],-1),g=n("li",null,"redis 7.0 +",-1),y={href:"https://goswagger.io/install.html",target:"_blank",rel:"noopener noreferrer"},f={class:"hint-container info"},_=n("p",{class:"hint-container-title"},"Info",-1),q=n("br",null,null,-1),x=n("code",null,"Windows",-1),w={href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},C={class:"hint-container info"},P=n("p",{class:"hint-container-title"},"Info",-1),I={href:"https://vben.ryansu.pro/",target:"_blank",rel:"noopener noreferrer"},S={href:"https://youtu.be/_RDvlaKRRTY",target:"_blank",rel:"noopener noreferrer"},L=r(`<h2 id="backend-setting" tabindex="-1"><a class="header-anchor" href="#backend-setting" aria-hidden="true">#</a> Backend Setting</h2><h3 id="simple-admin-core" tabindex="-1"><a class="header-anchor" href="#simple-admin-core" aria-hidden="true">#</a> simple admin core</h3><p>simple admin core is the core service for simple admin. It offers user management, authorization, menu management and API management and so on. It must be running.</p><div class="hint-container info"><p class="hint-container-title">Default Account</p><p>username: <strong>admin</strong><br> password: <strong>simple-admin</strong></p></div><blockquote><p>Clone the core code</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-core.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see</p></blockquote><figure><img src="`+o+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure>',41);function T(A,R){const a=l("ExternalLinkIcon"),i=l("RouterLink");return d(),p("div",null,[m,v,n("ul",null,[b,k,h,g,n("li",null,[n("a",y,[s("go-swagger"),e(a)])]),n("li",null,[e(i,{to:"/guide/basic-config/simple-admin-tools.html"},{default:t(()=>[s("Simple Admin Tool")]),_:1})])]),n("div",f,[_,n("p",null,[s("It is recommended to develop under linux, because the make command is required. We develop in Ubuntu 22.10. "),q,n("strong",null,[x,s(" users are recommended to develop in the "),n("a",w,[s("WSL"),e(a)]),s(" environment, you can also cofigure the environment via "),e(i,{to:"/guide/FAQ.html#how-to-configure-the-windows-environment"},{default:t(()=>[s("Windows")]),_:1}),s(".")])])]),n("div",C,[P,n("p",null,[n("a",I,[s("Backend UI Doc"),e(a)]),s(),n("a",S,[s("Video Tutorial"),e(a)])])]),L,n("blockquote",null,[n("p",null,[s("File manager service is optional "),e(i,{to:"/simple-admin/en/docs/file_manager.html"},{default:t(()=>[s("File Manager")]),_:1})])])])}const M=c(u,[["render",T],["__file","env_setting.html.vue"]]);export{M as default};
