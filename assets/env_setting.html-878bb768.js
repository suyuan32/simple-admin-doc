...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see</p></blockquote><figure><img src="`+o+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure>',41),P=n("div",{class:"hint-container warning"},[n("p",{class:"hint-container-title"},"Note"),n("p",null,[n("strong",null,"After initialization, you should restart api and rpc service.")])],-1);function L(S,T){const a=l("ExternalLinkIcon"),i=l("RouterLink");return p(),d("div",null,[m,v,n("ul",null,[b,k,h,g,n("li",null,[n("a",y,[s("go-swagger"),e(a)])]),n("li",null,[e(i,{to:"/guide/basic-config/simple-admin-tools.html"},{default:t(()=>[s("Simple Admin Tool")]),_:1})])]),n("div",f,[_,n("p",null,[s("It is recommended to develop under linux, because the make command is required. We develop in Ubuntu 22.10. "),x,n("strong",null,[q,s(" users are recommended to develop in the "),n("a",w,[s("WSL"),e(a)]),s(" environment, the "),C,s(" environment has some bugs.")])])]),I,n("blockquote",null,[n("p",null,[s("File manager service is optional "),e(i,{to:"/simple-admin/en/docs/file_manager.html"},{default:t(()=>[s("File Manager")]),_:1})])]),P])}const D=c(u,[["render",L],["__file","env_setting.html.vue"]]);export{D as default};
