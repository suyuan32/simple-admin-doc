import{_ as t}from"./init_zh_cn-25f120d7.js";import{_ as c,W as p,X as o,Y as n,Z as s,$ as a,a1 as d,a0 as r,H as e}from"./framework-45e551af.js";const u={},m=n("h1",{id:"本地开发环境配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#本地开发环境配置","aria-hidden":"true"},"#"),s(" 本地开发环境配置")],-1),v=n("h2",{id:"环境需求",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#环境需求","aria-hidden":"true"},"#"),s(" 环境需求")],-1),k=n("li",null,"golang 1.19 +",-1),b=n("li",null,"nodejs 18.8.0 +",-1),h=n("li",null,"mysql 8.0 + | MariaDB 10.7 + | Postgres 14 + (Postgres 15 + 推荐)",-1),g=n("li",null,"redis 6.0 +",-1),y={href:"https://goswagger.io/install.html",target:"_blank",rel:"noopener noreferrer"},f=r(`<blockquote><p>推荐在linux下开发，因为需要用到make命令</p></blockquote><h2 id="后端部署" tabindex="-1"><a class="header-anchor" href="#后端部署" aria-hidden="true">#</a> 后端部署</h2><h3 id="simple-admin-core" tabindex="-1"><a class="header-anchor" href="#simple-admin-core" aria-hidden="true">#</a> simple admin core</h3><p>simple admin core 是核心代码，主要负责用户注册鉴权和充当网关的角色以及后台的各类配置。</p><h4 id="默认账号" tabindex="-1"><a class="header-anchor" href="#默认账号" aria-hidden="true">#</a> 默认账号</h4><p>username: admin<br> password: simple-admin</p><h3 id="下载代码" tabindex="-1"><a class="header-anchor" href="#下载代码" aria-hidden="true">#</a> 下载代码</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-core.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="运行" tabindex="-1"><a class="header-anchor" href="#运行" aria-hidden="true">#</a> 运行</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> serve
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>进入界面</p><figure><img src="`+t+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>文件服务初始化是可选的，没有运行文件api可以不初始化</p></blockquote><h4 id="初始化完成后需要重启-api-和-rpc。" tabindex="-1"><a class="header-anchor" href="#初始化完成后需要重启-api-和-rpc。" aria-hidden="true">#</a> <strong>初始化完成后需要重启 api 和 rpc。</strong></h4>',46);function _(x,q){const i=e("ExternalLinkIcon"),l=e("RouterLink");return p(),o("div",null,[m,v,n("ul",null,[k,b,h,g,n("li",null,[n("a",y,[s("go-swagger"),a(i)])]),n("li",null,[a(l,{to:"/zh/guide/basic-config/simple-admin-tools.html"},{default:d(()=>[s("Simple Admin Tool")]),_:1})])]),f])}const C=c(u,[["render",_],["__file","env_setting.html.vue"]]);export{C as default};
