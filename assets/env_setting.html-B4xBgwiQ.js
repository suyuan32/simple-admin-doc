import{_ as o}from"./init_zh_cn-_lrlSFyJ.js";import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as u,c as r,a as n,f as s,b as a,w as p,e as d}from"./app-CK-zxo63.js";const m={},k=n("h2",{id:"环境需求",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#环境需求"},[n("span",null,"环境需求")])],-1),v=n("li",null,"golang 1.20 +",-1),b=n("li",null,[n("strong",null,"nodejs 19.8.0 +")],-1),h=n("li",null,[n("strong",null,"mysql 8.0.30 +"),s(" | MariaDB 10.7 + | Postgres 13 + ("),n("strong",null,"Postgres 14 推荐"),s(")")],-1),g=n("li",null,"redis 7.0 +",-1),y={href:"https://goswagger.io/install.html",target:"_blank",rel:"noopener noreferrer"},f={class:"hint-container info"},_=n("p",{class:"hint-container-title"},"相关信息",-1),q=n("p",null,[n("strong",null,"建议使用 PostgreSQL 数据库")],-1),x=n("br",null,null,-1),w=n("code",null,"Windows",-1),P={href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},S={class:"hint-container info"},C=n("p",{class:"hint-container-title"},"相关信息",-1),E={href:"https://www.bilibili.com/video/BV1Hg4y1M7T5",target:"_blank",rel:"noopener noreferrer"},D={href:"https://vben.ryansu.tech/zh/",target:"_blank",rel:"noopener noreferrer"},I=n("h2",{id:"后端部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#后端部署"},[n("span",null,"后端部署")])],-1),L={class:"hint-container warning"},R=n("p",{class:"hint-container-title"},"注意",-1),A={href:"https://www.bilibili.com/video/BV1do4y1g7VL",target:"_blank",rel:"noopener noreferrer"},B=d(`<h3 id="simple-admin-core" tabindex="-1"><a class="header-anchor" href="#simple-admin-core"><span>simple admin core</span></a></h3><p>simple admin core 是核心代码，主要负责用户注册鉴权和充当网关的角色以及后台的各类配置。</p><div class="hint-container info"><p class="hint-container-title">默认账号</p><p>username: <strong>admin</strong><br> password: <strong>simple-admin</strong></p></div><h3 id="下载代码" tabindex="-1"><a class="header-anchor" href="#下载代码"><span>下载代码</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-core.git
