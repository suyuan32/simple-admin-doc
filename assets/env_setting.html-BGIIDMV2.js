import{_ as p}from"./init_zh_cn-_lrlSFyJ.js";import{_ as o}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,c,d as n,e as a,w as i,f as s,b as u,o as r}from"./app-SeIJRtVB.js";const d={},m=n("h2",{id:"环境需求",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#环境需求"},[n("span",null,"环境需求")])],-1),k=n("li",null,"golang 1.20 +",-1),v=n("li",null,[n("strong",null,"nodejs 19.8.0 +")],-1),b=n("li",null,[n("strong",null,"mysql 8.0.30 +"),s(" | MariaDB 10.7 + | Postgres 13 + ("),n("strong",null,"Postgres 14 推荐"),s(")")],-1),h=n("li",null,"redis 7.0 +",-1),g=n("li",null,[n("a",{href:"https://goswagger.io/install.html",target:"_blank",rel:"noopener noreferrer"},"go-swagger")],-1),y={class:"hint-container info"},f=n("p",{class:"hint-container-title"},"相关信息",-1),_=n("p",null,[n("strong",null,"建议使用 PostgreSQL 数据库")],-1),q=n("br",null,null,-1),x=n("code",null,"Windows",-1),w=n("a",{href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},"WSL",-1),P={class:"hint-container info"},S=n("p",{class:"hint-container-title"},"相关信息",-1),C=n("p",null,[n("a",{href:"https://www.bilibili.com/video/BV1Hg4y1M7T5",target:"_blank",rel:"noopener noreferrer"},"视频教程"),s(),n("a",{href:"https://vben.ryansu.tech/zh/",target:"_blank",rel:"noopener noreferrer"},"Backend UI 文档")],-1),D=n("h2",{id:"后端部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#后端部署"},[n("span",null,"后端部署")])],-1),E={class:"hint-container warning"},I=n("p",{class:"hint-container-title"},"注意",-1),L=n("p",null,[s("除非要二次开发 core 服务， 否则建议直接接入官方镜像， 参考教程 "),n("a",{href:"https://www.bilibili.com/video/BV1do4y1g7VL",target:"_blank",rel:"noopener noreferrer"},"直接接入 Core 服务")],-1),R=u(`<h3 id="simple-admin-core" tabindex="-1"><a class="header-anchor" href="#simple-admin-core"><span>simple admin core</span></a></h3><p>simple admin core 是核心代码，主要负责用户注册鉴权和充当网关的角色以及后台的各类配置。</p><div class="hint-container info"><p class="hint-container-title">默认账号</p><p>username: <strong>admin</strong><br> password: <strong>simple-admin</strong></p></div><h3 id="下载代码" tabindex="-1"><a class="header-anchor" href="#下载代码"><span>下载代码</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-core.git
