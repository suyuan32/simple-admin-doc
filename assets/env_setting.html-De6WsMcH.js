import{_ as p}from"./init_zh_cn-2XH4hFMV.js";import{_ as c}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as u,c as r,a as n,f as s,b as a,w as o,e as l}from"./app-z0TS8spT.js";const d={},m=n("blockquote",null,[n("p",null,"Environment Requirement")],-1),v=n("li",null,"golang 1.20 +",-1),k=n("li",null,[n("strong",null,"nodejs 19.8.0 +")],-1),b=n("li",null,[n("strong",null,"mysql 8.0.30 +"),s(" | MariaDB 10.10 + | Postgres 13 + ("),n("strong",null,"Postgres 14 recommended"),s(")")],-1),h=n("li",null,"redis 7.0 +",-1),g={href:"https://goswagger.io/install.html",target:"_blank",rel:"noopener noreferrer"},y={class:"hint-container info"},f=n("p",{class:"hint-container-title"},"Info",-1),_=n("br",null,null,-1),q=n("code",null,"Windows",-1),x={href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},w={class:"hint-container info"},C=n("p",{class:"hint-container-title"},"Info",-1),S={href:"https://vben.ryansu.tech/",target:"_blank",rel:"noopener noreferrer"},P={href:"https://youtu.be/_RDvlaKRRTY",target:"_blank",rel:"noopener noreferrer"},I=l('<h2 id="backend-setting" tabindex="-1"><a class="header-anchor" href="#backend-setting"><span>Backend Setting</span></a></h2><h3 id="simple-admin-core" tabindex="-1"><a class="header-anchor" href="#simple-admin-core"><span>Simple Admin Core</span></a></h3><p>Simple Admin Core is the core service for Simple Admin. It offers user management, authorization, menu management and API management and so on. It must be running.</p><div class="hint-container info"><p class="hint-container-title">Default Account</p><p>username: <strong>admin</strong><br> password: <strong>simple-admin</strong></p></div>',4),A={class:"hint-container warning"},D=n("p",{class:"hint-container-title"},"Warning",-1),R={href:"https://youtu.be/gpXOoJEeOHg",target:"_blank",rel:"noopener noreferrer"},T=l(`<blockquote><p>Clone the core code</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-core.git
