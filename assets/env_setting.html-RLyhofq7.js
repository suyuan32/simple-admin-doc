import{_ as p}from"./init_zh_cn-_lrlSFyJ.js";import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,c as r,d as n,e as a,w as l,f as s,b as o,o as u}from"./app-SeIJRtVB.js";const d={},m=n("blockquote",null,[n("p",null,"Environment Requirement")],-1),v=n("li",null,"golang 1.20 +",-1),k=n("li",null,[n("strong",null,"nodejs 19.8.0 +")],-1),b=n("li",null,[n("strong",null,"mysql 8.0.30 +"),s(" | MariaDB 10.10 + | Postgres 13 + ("),n("strong",null,"Postgres 14 recommended"),s(")")],-1),h=n("li",null,"redis 7.0 +",-1),g=n("li",null,[n("a",{href:"https://goswagger.io/install.html",target:"_blank",rel:"noopener noreferrer"},"go-swagger")],-1),y={class:"hint-container info"},f=n("p",{class:"hint-container-title"},"Info",-1),_=n("p",null,[n("strong",null,"It is recommended to use PostgreSQL Database.")],-1),q=n("br",null,null,-1),w=n("code",null,"Windows",-1),x=n("a",{href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},"WSL",-1),S={class:"hint-container info"},C=n("p",{class:"hint-container-title"},"Info",-1),P=n("p",null,[n("a",{href:"https://vben.ryansu.tech/",target:"_blank",rel:"noopener noreferrer"},"Backend UI Doc"),s(),n("a",{href:"https://youtu.be/_RDvlaKRRTY",target:"_blank",rel:"noopener noreferrer"},"Video Tutorial")],-1),R=o('<h2 id="backend-setting" tabindex="-1"><a class="header-anchor" href="#backend-setting"><span>Backend Setting</span></a></h2><h3 id="simple-admin-core" tabindex="-1"><a class="header-anchor" href="#simple-admin-core"><span>Simple Admin Core</span></a></h3><p>Simple Admin Core is the core service for Simple Admin. It offers user management, authorization, menu management and API management and so on. It must be running.</p><div class="hint-container info"><p class="hint-container-title">Default Account</p><p>username: <strong>admin</strong><br> password: <strong>simple-admin</strong></p></div>',4),D={class:"hint-container warning"},I=n("p",{class:"hint-container-title"},"Warning",-1),T=n("p",null,[s("Since v1.1.1, we recommend you to use docker to deploy local environment. "),n("a",{href:"https://youtu.be/gpXOoJEeOHg",target:"_blank",rel:"noopener noreferrer"},"Tutorial")],-1),A=o(`<blockquote><p>Clone the core code</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-core.git
