import{_ as l}from"./init_zh_cn-25f120d7.js";import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as c,c as u,a as n,b as s,d as a,w as i,e as r}from"./app-936969af.js";const d={},m=n("h1",{id:"local-development-setting",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#local-development-setting","aria-hidden":"true"},"#"),s(" Local Development Setting")],-1),v=n("blockquote",null,[n("p",null,"Environment Requirement")],-1),k=n("li",null,"golang 1.20 +",-1),b=n("li",null,[n("strong",null,"nodejs 19.8.0 +")],-1),h=n("li",null,[n("strong",null,"mysql 8.0.21 +"),s(" | MariaDB 10.7 + | Postgres 13 + ("),n("strong",null,"Postgres 14 recommended"),s(")")],-1),g=n("li",null,"redis 7.0 +",-1),y={href:"https://goswagger.io/install.html",target:"_blank",rel:"noopener noreferrer"},f={class:"hint-container info"},_=n("p",{class:"hint-container-title"},"Info",-1),q=n("br",null,null,-1),w=n("code",null,"Windows",-1),x={href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},C={class:"hint-container info"},P=n("p",{class:"hint-container-title"},"Info",-1),S={href:"https://vben.ryansu.pro/",target:"_blank",rel:"noopener noreferrer"},I={href:"https://youtu.be/_RDvlaKRRTY",target:"_blank",rel:"noopener noreferrer"},D=r(`<h2 id="backend-setting" tabindex="-1"><a class="header-anchor" href="#backend-setting" aria-hidden="true">#</a> Backend Setting</h2><h3 id="simple-admin-core" tabindex="-1"><a class="header-anchor" href="#simple-admin-core" aria-hidden="true">#</a> simple admin core</h3><p>simple admin core is the core service for simple admin. It offers user management, authorization,<br> menu management and API management and so on. It must be running.</p><div class="hint-container info"><p class="hint-container-title">Default Account</p><p>username: <strong>admin</strong><br> password: <strong>simple-admin</strong></p></div><blockquote><p>Clone the core code</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-core.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see</p></blockquote><figure><img src="`+l+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure>',43);function A(R,L){const e=o("ExternalLinkIcon"),t=o("RouterLink");return c(),u("div",null,[m,v,n("ul",null,[k,b,h,g,n("li",null,[n("a",y,[s("go-swagger"),a(e)])]),n("li",null,[a(t,{to:"/guide/basic-config/simple-admin-tools.html"},{default:i(()=>[s("Simple Admin Tool")]),_:1})])]),n("div",f,[_,n("p",null,[s("It is recommended to develop under linux, because the make command is required. We develop in Ubuntu 22.10. "),q,n("strong",null,[w,s(" users are recommended to cofigure the environment via "),a(t,{to:"/guide/FAQ.html#how-to-configure-the-windows-environment"},{default:i(()=>[s("Windows")]),_:1}),s(", you can also develop in the "),n("a",x,[s("WSL"),a(e)]),s(" environment.")])])]),n("div",C,[P,n("p",null,[n("a",S,[s("Backend UI Doc"),a(e)]),s(),n("a",I,[s("Video Tutorial"),a(e)])])]),D,n("blockquote",null,[n("p",null,[s("File manager service is optional "),a(t,{to:"/simple-admin/en/docs/file_manager.html"},{default:i(()=>[s("File Manager")]),_:1})])])])}const B=p(d,[["render",A],["__file","env_setting.html.vue"]]);export{B as default};
