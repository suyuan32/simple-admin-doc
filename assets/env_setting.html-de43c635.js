...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see</p></blockquote><figure><img src="`+o+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure>',41);function P(S,I){const t=l("ExternalLinkIcon"),a=l("RouterLink");return d(),p("div",null,[m,v,n("ul",null,[b,k,h,g,n("li",null,[n("a",y,[s("go-swagger"),e(t)])]),n("li",null,[e(a,{to:"/guide/basic-config/simple-admin-tools.html"},{default:i(()=>[s("Simple Admin Tool")]),_:1})])]),n("div",f,[_,n("p",null,[s("It is recommended to develop under linux, because the make command is required. We develop in Ubuntu 22.10. "),q,n("strong",null,[x,s(" users are recommended to develop in the "),n("a",w,[s("WSL"),e(t)]),s(" environment, you can also cofigure the environment via "),e(a,{to:"/guide/FAQ.html#how-to-configure-the-windows-environment"},{default:i(()=>[s("Windows")]),_:1}),s(".")])])]),C,n("blockquote",null,[n("p",null,[s("File manager service is optional "),e(a,{to:"/simple-admin/en/docs/file_manager.html"},{default:i(()=>[s("File Manager")]),_:1})])])])}const T=c(u,[["render",P],["__file","env_setting.html.vue"]]);export{T as default};
