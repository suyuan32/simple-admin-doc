import{_ as e}from"./init_zh_cn-25f120d7.js";import{ab as i,F as l,G as t,E as n,R as s,M as o,ad as c,ac as p,U as d}from"./framework-5ae10408.js";const u={},r=p(`<h1 id="local-development-setting" tabindex="-1"><a class="header-anchor" href="#local-development-setting" aria-hidden="true">#</a> Local Development Setting</h1><blockquote><p>Environment Requirement</p></blockquote><ul><li>golang 1.19</li><li>nodejs 18.8.0</li><li>mysql 5.7 +</li><li>redis 6.0 +</li></ul><blockquote><p>Backend Setting</p></blockquote><h2 id="simple-admin-core" tabindex="-1"><a class="header-anchor" href="#simple-admin-core" aria-hidden="true">#</a> simple admin core</h2><p>simple admin core is the core service for simple admin. It offers user management, authorization, menu management and API management and so on. It must be running.</p><blockquote><p>Default Account</p></blockquote><p>username: admin <br> password: simple-admin</p><blockquote><p>Clone the core code</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-core.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see</p></blockquote><figure><img src="`+e+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure>',45),m=n("h2",{id:"after-initialization-you-should-restart-api-and-rpc-service",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#after-initialization-you-should-restart-api-and-rpc-service","aria-hidden":"true"},"#"),s(),n("strong",null,"After initialization, you should restart api and rpc service.")],-1);function v(b,k){const a=d("RouterLink");return l(),t("div",null,[r,n("blockquote",null,[n("p",null,[s("File manager service is optional "),o(a,{to:"/simple-admin/en/docs/file_manager.html"},{default:c(()=>[s("File Manager")]),_:1})])]),m])}const g=i(u,[["render",v],["__file","env_setting.html.vue"]]);export{g as default};
