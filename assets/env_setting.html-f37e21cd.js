...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>进入界面</p><figure><img src="`+n+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>文件服务初始化是可选的，没有运行文件api可以不初始化</p></blockquote><h2 id="初始化完成后需要重启-api-和-rpc。" tabindex="-1"><a class="header-anchor" href="#初始化完成后需要重启-api-和-rpc。" aria-hidden="true">#</a> <strong>初始化完成后需要重启 api 和 rpc。</strong></h2>',48),c=[t];function p(o,d){return a(),e("div",null,c)}const m=s(l,[["render",p],["__file","env_setting.html.vue"]]);export{m as default};
