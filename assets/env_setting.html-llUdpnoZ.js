import{_ as p}from"./init_zh_cn-2XH4hFMV.js";import{_ as c}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o,c as u,a as n,f as s,b as a,w as l,e as r}from"./app-J34oMQ8k.js";const d={},m=n("h2",{id:"环境需求",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#环境需求"},[n("span",null,"环境需求")])],-1),k=n("li",null,"golang 1.20 +",-1),v=n("li",null,[n("strong",null,"nodejs 19.8.0 +")],-1),b=n("li",null,[n("strong",null,"mysql 8.0.30 +"),s(" | MariaDB 10.7 + | Postgres 13 + ("),n("strong",null,"Postgres 14 推荐"),s(")")],-1),h=n("li",null,"redis 7.0 +",-1),g={href:"https://goswagger.io/install.html",target:"_blank",rel:"noopener noreferrer"},y={class:"hint-container info"},f=n("p",{class:"hint-container-title"},"相关信息",-1),_=n("code",null,"Ubuntu 22.10",-1),q=n("br",null,null,-1),x=n("code",null,"Windows",-1),w={href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},C={class:"hint-container info"},E=n("p",{class:"hint-container-title"},"相关信息",-1),P={href:"https://www.bilibili.com/video/BV1Hg4y1M7T5",target:"_blank",rel:"noopener noreferrer"},S={href:"https://vben.ryansu.tech/zh/",target:"_blank",rel:"noopener noreferrer"},I=n("h2",{id:"后端部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#后端部署"},[n("span",null,"后端部署")])],-1),D={class:"hint-container warning"},L=n("p",{class:"hint-container-title"},"注意",-1),A={href:"https://www.bilibili.com/video/BV1do4y1g7VL",target:"_blank",rel:"noopener noreferrer"},R=r(`<h3 id="simple-admin-core" tabindex="-1"><a class="header-anchor" href="#simple-admin-core"><span>simple admin core</span></a></h3><p>simple admin core 是核心代码，主要负责用户注册鉴权和充当网关的角色以及后台的各类配置。</p><div class="hint-container info"><p class="hint-container-title">默认账号</p><p>username: <strong>admin</strong><br> password: <strong>simple-admin</strong></p></div><h3 id="下载代码" tabindex="-1"><a class="header-anchor" href="#下载代码"><span>下载代码</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-core.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>进入界面</p><figure><img src="`+p+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>文件服务初始化是可选的，没有运行文件 api 可以不初始化</p></blockquote>',43);function M(T,B){const e=i("ExternalLinkIcon"),t=i("RouterLink");return o(),u("div",null,[m,n("ul",null,[k,v,b,h,n("li",null,[n("a",g,[s("go-swagger"),a(e)])]),n("li",null,[a(t,{to:"/zh/guide/basic-config/simple-admin-tools.html"},{default:l(()=>[s("Goctls")]),_:1})])]),n("div",y,[f,n("p",null,[s("推荐在 linux 下开发，因为需要用到 make 命令，官方在 "),_,s(" 环境下开发. "),q,n("strong",null,[x,s(" 用户建议自行配置环境， 参考 "),a(t,{to:"/zh/guide/FAQ.html#%E5%A6%82%E4%BD%95%E9%85%8D%E7%BD%AE-windows-%E7%8E%AF%E5%A2%83"},{default:l(()=>[s("Windows")]),_:1}),s("， 或者在 "),n("a",w,[s("WSL"),a(e)]),s(" 环境下开发")])])]),n("div",C,[E,n("p",null,[n("a",P,[s("视频教程"),a(e)]),s(),n("a",S,[s("Backend UI 文档"),a(e)])])]),I,n("div",D,[L,n("p",null,[s("除非要二次开发 core 服务， 否则建议直接接入官方镜像， 参考教程 "),n("a",A,[s("直接接入 Core 服务"),a(e)])])]),R])}const U=c(d,[["render",M],["__file","env_setting.html.vue"]]);export{U as default};
