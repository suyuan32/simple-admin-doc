...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>You can see</p></blockquote><figure><img src="`+p+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>File manager service is optional <a href="/guide/official-comp/file_manager">File Manager</a></p></blockquote>',40);function L(M,O){const e=i("ExternalLinkIcon"),t=i("RouterLink");return u(),r("div",null,[m,v,n("ul",null,[k,b,h,g,n("li",null,[n("a",y,[s("go-swagger"),a(e)])]),n("li",null,[a(t,{to:"/guide/basic-config/simple-admin-tools.html"},{default:o(()=>[s("Goctls")]),_:1})])]),n("div",f,[_,n("p",null,[s("It is recommended to develop under linux, because the make command is required. We develop in Ubuntu 22.10. "),q,n("strong",null,[x,s(" users are recommended to cofigure the environment via "),a(t,{to:"/guide/FAQ.html#how-to-configure-the-windows-environment"},{default:o(()=>[s("Windows")]),_:1}),s(", you can also develop in the "),n("a",w,[s("WSL"),a(e)]),s(" environment.")])])]),n("div",C,[S,n("p",null,[n("a",P,[s("Backend UI Doc"),a(e)]),s(),n("a",I,[s("Video Tutorial"),a(e)])])]),A,n("div",D,[R,n("p",null,[s("Since v1.1.1, we recommend you to use docker to deploy local environment. "),n("a",T,[s("Tutorial"),a(e)])])]),E])}const W=c(d,[["render",L],["__file","env_setting.html.vue"]]);export{W as default};
