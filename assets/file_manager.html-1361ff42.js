import{_ as e,W as t,X as l,Y as n,Z as s,$ as i,a0 as o,F as p}from"./framework-2d290880.js";const c={},u=o(`<h2 id="file-manager-service" tabindex="-1"><a class="header-anchor" href="#file-manager-service" aria-hidden="true">#</a> File manager service</h2><h3 id="get-code" tabindex="-1"><a class="header-anchor" href="#get-code" aria-hidden="true">#</a> Get code</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-file.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),r={href:"http://localhost:3100/init",target:"_blank",rel:"noopener noreferrer"},d=n("h3",{id:"k8s-deployment",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#k8s-deployment","aria-hidden":"true"},"#"),s(" K8s Deployment")],-1),m=n("blockquote",null,[n("p",null,"It is similar with core api.")],-1),k=n("p",null,"You should do these step:",-1),v=n("ul",null,[n("li",null,"deploy the images via fileapi.yaml"),n("li",null,"modify simple-admin-backend-ui/deploy/default.conf, uncomment the file manager rule"),n("li",null,"update ingress configmap"),n("li",null,"update ingress controller")],-1);function b(h,y){const a=p("ExternalLinkIcon");return t(),l("div",null,[u,n("blockquote",null,[n("p",null,[s("You should use nginx to set PublicStorePath as static path for front end. Make sure AccessSecret is the same as simple-admin-core's api set The configuration is similar as core Run code the same as core Init database in "),n("a",r,[s("http://localhost:3100/init"),i(a)]),s(" Add API interface permissions on the role page, then restart the API service of file manager")])]),d,m,k,v])}const g=e(c,[["render",b],["__file","file_manager.html.vue"]]);export{g as default};
