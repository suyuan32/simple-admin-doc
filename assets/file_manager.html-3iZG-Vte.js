import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o as t,c as p,a as n,f as s,b as c,e as i}from"./app-z0TS8spT.js";const o={},u=i(`<h3 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍"><span>介绍</span></a></h3><p>Simple Admin 的文件上传管理服务. 支持本地上传， 支持任意 S3 协议云上传， 包括 阿里云， 腾讯云，七牛云， 天翼云, aws等。</p><h3 id="下载代码" tabindex="-1"><a class="header-anchor" href="#下载代码"><span>下载代码</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-file.git
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="修改配置文件-etc-file-yaml" tabindex="-1"><a class="header-anchor" href="#修改配置文件-etc-file-yaml"><span>修改配置文件 etc/file.yaml</span></a></h3><h4 id="value" tabindex="-1"><a class="header-anchor" href="#value"><span>value</span></a></h4><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token key atrule">Name</span><span class="token punctuation">:</span> file_manager_0
...
<span class="token key atrule">UploadConf</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">ServerURL</span><span class="token punctuation">:</span> <span class="token string">&quot;http://192.168.50.204:81&quot;</span> <span class="token comment"># 本地服务器地址</span>
  <span class="token key atrule">DeleteFileWithCloud</span><span class="token punctuation">:</span> <span class="token boolean important">true</span> <span class="token comment"># 是否当删除本地数据库数据时删除云文件</span>
