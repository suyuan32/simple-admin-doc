...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),r={class:"hint-container info"},d=n("p",{class:"hint-container-title"},"相关信息",-1),k=n("li",null,[n("p",null,"你可以使用nginx 将 PublicStorePath 转发为静态地址方便前端调用")],-1),m=n("li",null,[n("p",null,"确保 AccessSecret 和 simple-admin-core的api配置文件内一致")],-1),v=n("li",null,[n("p",null,"配置方式参考core")],-1),b=n("li",null,[n("p",null,"运行方式同理")],-1),h={href:"http://localhost:3100/init",target:"_blank",rel:"noopener noreferrer"},y=n("li",null,[n("p",null,"在角色页面添加API接口权限，然后重启 file 的 API")],-1),_=n("h3",{id:"k8s-部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#k8s-部署","aria-hidden":"true"},"#"),s(" K8s 部署")],-1),f=n("blockquote",null,[n("p",null,"和 core api 相似")],-1),g=n("p",null,"你应该做如下工作:",-1),x=n("ul",null,[n("li",null,"通过 fileapi.yaml 部署服务"),n("li",null,"修改 simple-admin-backend-ui/deploy/default.conf ，解开 file-manager注释"),n("li",null,"更新 ingress configmap"),n("li",null,"更新 ingress controller")],-1);function S(P,C){const a=c("ExternalLinkIcon");return l(),t("div",null,[u,n("div",r,[d,n("ul",null,[k,m,v,b,n("li",null,[n("p",null,[s("初始化数据库 "),n("a",h,[s("http://localhost:3100/init"),i(a)])])]),y])]),_,f,g,x])}const w=e(o,[["render",S],["__file","file_manager.html.vue"]]);export{w as default};
