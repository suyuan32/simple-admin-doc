...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>你可以使用nginx 将 PublicStorePath 转发为静态地址方便前端调用</p></blockquote>`,7),r={href:"http://localhost:3100/init",target:"_blank",rel:"noopener noreferrer"},d=n("h3",{id:"k8s-部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#k8s-部署","aria-hidden":"true"},"#"),s(" K8s 部署")],-1),k=n("blockquote",null,[n("p",null,"和 core api 相似")],-1),m=n("p",null,"你应该做如下工作:",-1),v=n("ul",null,[n("li",null,"通过 fileapi.yaml 部署服务"),n("li",null,"修改 simple-admin-backend-ui/deploy/default.conf ，解开 file-manager注释"),n("li",null,"更新 ingress configmap"),n("li",null,"更新 ingress controller")],-1);function b(h,y){const a=i("ExternalLinkIcon");return t(),l("div",null,[u,n("blockquote",null,[n("p",null,[s("确保 AccessSecret 和 simple-admin-core的api配置文件内一致 配置方式参考core 运行方式同理 初始化数据库 "),n("a",r,[s("http://localhost:3100/init"),p(a)]),s(" 在角色页面添加API接口权限，然后重启 file 的 API")])]),d,k,m,v])}const g=e(o,[["render",b],["__file","file_manager.html.vue"]]);export{g as default};
