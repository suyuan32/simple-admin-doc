import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,e}from"./app-17fe5eea.js";const o={},p=e(`<h2 id="查看信息命令" tabindex="-1"><a class="header-anchor" href="#查看信息命令" aria-hidden="true">#</a> 查看信息命令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls info <span class="token function">env</span>
...
<span class="token operator">|</span> mcms     <span class="token operator">|</span> 消息中心服务 <span class="token operator">|</span>
+----------+--------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>查看特定服务的环境变量</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls info <span class="token function">env</span> <span class="token parameter variable">-s</span> mcms
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Simple Admin的环境变量
注意： 环境变量的优先级大于配置文件
MCMS
EMAIL
...
<span class="token operator">|</span> 环境变量名称    <span class="token operator">|</span> 环境变量介绍                           <span class="token operator">|</span>
+-----------------+----------------------------------------+
<span class="token operator">|</span> EMAIL_AUTH_TYPE <span class="token operator">|</span> 电子邮箱的认证类型，支持plain和CRAMMD5 <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_ADDR      <span class="token operator">|</span> 电子邮箱地址                           <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_PASSWORD  <span class="token operator">|</span> 电子邮箱密码                           <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_HOST_NAME <span class="token operator">|</span> 电子邮箱的服务器地址                   <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_PORT      <span class="token operator">|</span> 电子邮箱的服务器端口                   <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_IDENTIFY  <span class="token operator">|</span> 电子邮箱的身份信息，用于CRAMMD5        <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_SECRET    <span class="token operator">|</span> 电子邮箱的密钥信息，用于CRAMMD5        <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_TLS       <span class="token operator">|</span> 是否启用TLS                            <span class="token operator">|</span>
+-----------------+----------------------------------------+
SMS
+----------------+------------------+
<span class="token operator">|</span> 环境变量名称   <span class="token operator">|</span> 环境变量介绍     <span class="token operator">|</span>
+----------------+------------------+
<span class="token operator">|</span> SMS_SECRET_ID  <span class="token operator">|</span> 短信服务密钥ID   <span class="token operator">|</span>
<span class="token operator">|</span> SMS_SECRET_KEY <span class="token operator">|</span> 短信服务密钥     <span class="token operator">|</span>
<span class="token operator">|</span> SMS_PROVIDER   <span class="token operator">|</span> 短信服务提供商   <span class="token operator">|</span>
<span class="token operator">|</span> SMS_REGION     <span class="token operator">|</span> 短信服务提供区域 <span class="token operator">|</span>
+----------------+------------------+
