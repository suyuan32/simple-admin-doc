...
+--------------------+------------------------------------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>Show the supported services</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls info <span class="token function">env</span> <span class="token parameter variable">-l</span>
...
<span class="token operator">|</span> mcms         <span class="token operator">|</span> Message Center Service  <span class="token operator">|</span>
+--------------+-------------------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>Show the target service&#39;s environment variables</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls info <span class="token function">env</span> <span class="token parameter variable">-s</span> mcms
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Simple Admin&#39;s environment variables
Notice: Environment variables have priority over configuration files
MCMS
EMAIL
+-----------------+---------------------------------------------------------------+
<span class="token operator">|</span> KEY             <span class="token operator">|</span> INTRODUCTION                                                  <span class="token operator">|</span>
+-----------------+---------------------------------------------------------------+
<span class="token operator">|</span> EMAIL_AUTH_TYPE <span class="token operator">|</span> Authentication <span class="token builtin class-name">type</span> <span class="token keyword">for</span> the email, supports plain and CRAMMD5 <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_ADDR      <span class="token operator">|</span> Email address                                                 <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_PASSWORD  <span class="token operator">|</span> Email password                                                <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_HOST_NAME <span class="token operator">|</span> Server address <span class="token keyword">for</span> the email                                  <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_PORT      <span class="token operator">|</span> Server port <span class="token keyword">for</span> the email                                     <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_IDENTIFY  <span class="token operator">|</span> Identity information <span class="token keyword">for</span> the email, used <span class="token keyword">for</span> CRAMMD5          <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_SECRET    <span class="token operator">|</span> Secret information <span class="token keyword">for</span> the email, used <span class="token keyword">for</span> CRAMMD5            <span class="token operator">|</span>
<span class="token operator">|</span> EMAIL_TLS       <span class="token operator">|</span> Whether to <span class="token builtin class-name">enable</span> TLS                                         <span class="token operator">|</span>
+-----------------+---------------------------------------------------------------+
SMS
+----------------+--------------------------------+
<span class="token operator">|</span> KEY            <span class="token operator">|</span> INTRODUCTION                   <span class="token operator">|</span>
+----------------+--------------------------------+
<span class="token operator">|</span> SMS_SECRET_ID  <span class="token operator">|</span> Secret ID <span class="token keyword">for</span> the SMS <span class="token function">service</span>  <span class="token operator">|</span>
<span class="token operator">|</span> SMS_SECRET_KEY <span class="token operator">|</span> Secret key <span class="token keyword">for</span> the SMS <span class="token function">service</span> <span class="token operator">|</span>
<span class="token operator">|</span> SMS_PROVIDER   <span class="token operator">|</span> Provider <span class="token keyword">for</span> the SMS <span class="token function">service</span>   <span class="token operator">|</span>
<span class="token operator">|</span> SMS_REGION     <span class="token operator">|</span> Region <span class="token keyword">for</span> the SMS <span class="token function">service</span>     <span class="token operator">|</span>
+----------------+--------------------------------+
...
+------+------------+
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,17),i=[r];function p(l,t){return n(),a("div",null,i)}const v=s(o,[["render",p],["__file","info.html.vue"]]);export{v as default};
