...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,21),m={href:"http://%7Bservice-name%7D.%7Bnamespace%7D.svc.cluster.local:%7Bport%7D/",target:"_blank",rel:"noopener noreferrer"},v=n("h4",{id:"quick-deployment",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#quick-deployment","aria-hidden":"true"},"#"),s(" Quick Deployment")],-1),b=n("blockquote",null,[n("p",null,"Run deploy/k8s/setup.sh")],-1);function y(h,g){const l=e("RouterLink"),p=e("ExternalLinkIcon");return c(),o("div",null,[d,n("p",null,[a(l,{to:"/guide/basic-config/k8s/simple-admin/en/docs/minikube.html"},{default:u(()=>[s("Minikube")]),_:1})]),k,n("blockquote",null,[n("p",null,[s("Notice: proxy_pass format: "),n("a",m,[s("http://{service-name}.{namespace}.svc.cluster.local:{port}/"),a(p)])])]),v,b])}const x=i(r,[["render",y],["__file","k8s-deploy.html.vue"]]);export{x as default};
