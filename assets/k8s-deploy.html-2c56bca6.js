...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,21),v={href:"http://%7Bservice-name%7D.%7Bnamespace%7D.svc.cluster.local:%7Bport%7D/",target:"_blank",rel:"noopener noreferrer"},m=n("h4",{id:"快速部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#快速部署","aria-hidden":"true"},"#"),s(" 快速部署")],-1),b=n("blockquote",null,[n("p",null,"执行 deploy/k8s/setup.sh")],-1);function y(h,g){const l=e("RouterLink"),p=e("ExternalLinkIcon");return c(),o("div",null,[k,n("p",null,[a(l,{to:"/zh/guide/basic-config/k8s/simple-admin/zh-cn/docs/minikube.html"},{default:u(()=>[s("Minikube")]),_:1})]),d,n("blockquote",null,[n("p",null,[s("注意 proxy_pass 格式 "),n("a",v,[s("http://{service-name}.{namespace}.svc.cluster.local:{port}/"),a(p)])])]),m,b])}const f=i(r,[["render",y],["__file","k8s-deploy.html.vue"]]);export{f as default};
