...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p>proxy_pass 格式 <a href="http://%7Bservice-name%7D.%7Bnamespace%7D.svc.cluster.local:%7Bport%7D/" target="_blank" rel="noopener noreferrer">http://{service-name}.{namespace}.svc.cluster.local:{port}/</a></p></div><h4 id="快速部署" tabindex="-1"><a class="header-anchor" href="#快速部署"><span>快速部署</span></a></h4><blockquote><p>执行 deploy/k8s/setup.sh</p></blockquote>`,28),p=[l];function i(c,o){return a(),s("div",null,p)}const k=n(t,[["render",i],["__file","k8s-deploy.html.vue"]]),d=JSON.parse('{"path":"/zh/guide/basic-config/k8s/k8s-deploy.html","title":"K8s 部署","lang":"zh-CN","frontmatter":{"order":1,"title":"K8s 部署","head":[["meta",{"name":"keywords","content":"k8s, minikube, docker, deployment, 部署"}],["link",{"rel":"alternate","hreflang":"en-us","href":"https://doc.ryansu.tech/guide/basic-config/k8s/k8s-deploy.html"}],["meta",{"property":"og:url","content":"https://doc.ryansu.tech/zh/guide/basic-config/k8s/k8s-deploy.html"}],["meta",{"property":"og:site_name","content":"Simple Admin"}],["meta",{"property":"og:title","content":"K8s 部署"}],["meta",{"property":"og:description","content":"环境需求 minikube v1.23.0 + mysql 8.0 + | MariaDB 10.7 + | Postgres 14 + (Postgres 15 + 推荐) redis 6.0 + docker Minikube 配置 Minikube K8s配置 API 服务 api/etc/core.yaml rpc/etc/core.yaml ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:locale:alternate","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2024-05-20T10:41:28.000Z"}],["meta",{"property":"article:author","content":"Ryan SU"}],["meta",{"property":"article:modified_time","content":"2024-05-20T10:41:28.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"K8s 部署\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-05-20T10:41:28.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Ryan SU\\",\\"url\\":\\"https://github.com/suyuan32\\"}]}"]],"description":"环境需求 minikube v1.23.0 + mysql 8.0 + | MariaDB 10.7 + | Postgres 14 + (Postgres 15 + 推荐) redis 6.0 + docker Minikube 配置 Minikube K8s配置 API 服务 api/etc/core.yaml rpc/etc/core.yaml ..."},"headers":[{"level":2,"title":"环境需求","slug":"环境需求","link":"#环境需求","children":[]},{"level":2,"title":"Minikube 配置","slug":"minikube-配置","link":"#minikube-配置","children":[{"level":3,"title":"K8s配置","slug":"k8s配置","link":"#k8s配置","children":[]},{"level":3,"title":"Docker镜像编译发布","slug":"docker镜像编译发布","link":"#docker镜像编译发布","children":[]}]},{"level":2,"title":"部署流程","slug":"部署流程","link":"#部署流程","children":[{"level":3,"title":"coreapi 部署文件详解","slug":"coreapi-部署文件详解","link":"#coreapi-部署文件详解","children":[]}]},{"level":2,"title":"前端 nginx 请求设置","slug":"前端-nginx-请求设置","link":"#前端-nginx-请求设置","children":[]}],"git":{"createdTime":1671464359000,"updatedTime":1716201688000,"contributors":[{"name":"Ryan SU","email":"1137661202@qq.com","commits":4},{"name":"Ryan Su","email":"yuansu.china.work@gmail.com","commits":2},{"name":"Ryan SU","email":"yuansu.china.work@gmail.com","commits":1}]},"readingTime":{"minutes":3.9,"words":1171},"filePathRelative":"zh/guide/basic-config/k8s/k8s-deploy.md","localizedDate":"2022年12月19日","autoDesc":true,"excerpt":"<h2>环境需求</h2>\\n<ul>\\n<li>minikube v1.23.0 +</li>\\n<li><strong>mysql 8.0 +</strong> | MariaDB 10.7 + | Postgres 14 + (<strong>Postgres 15 + 推荐</strong>)</li>\\n<li>redis 6.0 +</li>\\n<li>docker</li>\\n</ul>\\n<h2>Minikube 配置</h2>\\n<p><a href=\\"/guide/basic-config/k8s/minikube\\">Minikube</a></p>\\n<h3>K8s配置</h3>\\n<h4>API 服务</h4>"}');export{k as comp,d as data};
