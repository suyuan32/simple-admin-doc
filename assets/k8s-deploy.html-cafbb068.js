import{_ as a,W as e,X as t,Y as l,$ as p,a1 as i,a0 as n,F as c,Z as o}from"./framework-6f82d902.js";const u={},r=n('<h1 id="deploy-service-into-k8s" tabindex="-1"><a class="header-anchor" href="#deploy-service-into-k8s" aria-hidden="true">#</a> Deploy service into K8s</h1><h2 id="environment-requirement" tabindex="-1"><a class="header-anchor" href="#environment-requirement" aria-hidden="true">#</a> Environment Requirement</h2><ul><li>minikube v1.23.0 +</li><li>mysql 8.0 + | MariaDB 10.7 + | Postgres 14 + (Postgres 15 + recommended)</li><li>redis 6.0 +</li><li>docker</li></ul><h2 id="minikube-setting" tabindex="-1"><a class="header-anchor" href="#minikube-setting" aria-hidden="true">#</a> Minikube Setting</h2>',4),d=n(`<h3 id="k8s-setting" tabindex="-1"><a class="header-anchor" href="#k8s-setting" aria-hidden="true">#</a> K8s Setting</h3><h4 id="api-service" tabindex="-1"><a class="header-anchor" href="#api-service" aria-hidden="true">#</a> API service</h4><blockquote><p>api/etc/core.yaml</p></blockquote><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">Name</span><span class="token punctuation">:</span> core.api
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>Recommend to use gitlab-ci. The project had been provided .gitlab-ci.yml， You need set variable ： $DOCKER_USERNAME 和 $DOCKER_PASSWORD in gitlab runner.</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>variables:
  VERSION: 0.0.19
  REPO: docker.io
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="deploy-pipeline" tabindex="-1"><a class="header-anchor" href="#deploy-pipeline" aria-hidden="true">#</a> Deploy pipeline</h2><ul><li>build docker image</li><li>upload to docker repository</li><li>run in k8s -&gt; kubectl apply -f deploy/k8s/coreapi.yaml</li></ul><blockquote><p>You can use gitlab-ci to automatically build and push docker image</p></blockquote><h3 id="coreapi-k8s-deployment-file-tutorial" tabindex="-1"><a class="header-anchor" href="#coreapi-k8s-deployment-file-tutorial" aria-hidden="true">#</a> coreapi k8s deployment file tutorial</h3><blockquote><p>core api the name of service, you can find in label and metadata:name <br> Namespace is default, you can change your own namespace</p></blockquote><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> apps/v1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>Notice: proxy_pass format: http://{service-name}.{namespace}.svc.cluster.local:{port}/</p></blockquote><h4 id="quick-deployment" tabindex="-1"><a class="header-anchor" href="#quick-deployment" aria-hidden="true">#</a> Quick Deployment</h4><blockquote><p>Run deploy/k8s/setup.sh</p></blockquote>`,24);function k(m,v){const s=c("RouterLink");return e(),t("div",null,[r,l("p",null,[p(s,{to:"/guide/basic-config/k8s/simple-admin/en/docs/minikube.html"},{default:i(()=>[o("Minikube")]),_:1})]),d])}const y=a(u,[["render",k],["__file","k8s-deploy.html.vue"]]);export{y as default};
