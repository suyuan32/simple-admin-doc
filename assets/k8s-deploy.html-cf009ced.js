import{_ as a,W as e,X as t,Y as l,$ as p,a1 as i,a0 as n,F as c,Z as o}from"./framework-6f82d902.js";const u={},r=n('<h1 id="部署k8s" tabindex="-1"><a class="header-anchor" href="#部署k8s" aria-hidden="true">#</a> 部署K8s</h1><h2 id="环境需求" tabindex="-1"><a class="header-anchor" href="#环境需求" aria-hidden="true">#</a> 环境需求</h2><ul><li>minikube v1.23.0 +</li><li>mysql 8.0 + | MariaDB 10.7 + | Postgres 14 + (Postgres 15 + 推荐)</li><li>redis 6.0 +</li><li>docker</li></ul><h2 id="minikube-配置" tabindex="-1"><a class="header-anchor" href="#minikube-配置" aria-hidden="true">#</a> Minikube 配置</h2>',4),k=n(`<h3 id="k8s配置" tabindex="-1"><a class="header-anchor" href="#k8s配置" aria-hidden="true">#</a> K8s配置</h3><h4 id="api-服务" tabindex="-1"><a class="header-anchor" href="#api-服务" aria-hidden="true">#</a> API 服务</h4><blockquote><p>api/etc/core.yaml</p></blockquote><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">Name</span><span class="token punctuation">:</span> core.api
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="部署流程" tabindex="-1"><a class="header-anchor" href="#部署流程" aria-hidden="true">#</a> 部署流程</h2><ul><li>生成docker镜像</li><li>上传docker仓库</li><li>在k8s集群使用命令 kubectl apply -f deploy/k8s/coreapi.yaml 等直接部署</li></ul><blockquote><p>生成镜像和上传仓库建议直接使用gitlab-ci自动发布</p></blockquote><h3 id="coreapi-部署文件详解" tabindex="-1"><a class="header-anchor" href="#coreapi-部署文件详解" aria-hidden="true">#</a> coreapi 部署文件详解</h3><blockquote><p>coreapi 是所有服务的label和metadata:name <br> 命名空间默认是 default, 可自行修改</p></blockquote><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> apps/v1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>注意 proxy_pass 格式 http://{service-name}.{namespace}.svc.cluster.local:{port}/</p></blockquote><h4 id="快速部署" tabindex="-1"><a class="header-anchor" href="#快速部署" aria-hidden="true">#</a> 快速部署</h4><blockquote><p>执行 deploy/k8s/setup.sh</p></blockquote>`,24);function d(v,m){const s=c("RouterLink");return e(),t("div",null,[r,l("p",null,[p(s,{to:"/zh/guide/basic-config/k8s/simple-admin/zh-cn/docs/minikube.html"},{default:i(()=>[o("Minikube")]),_:1})]),k])}const y=a(u,[["render",d],["__file","k8s-deploy.html.vue"]]);export{y as default};
