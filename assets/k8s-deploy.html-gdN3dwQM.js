import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as l,c as p,a as n,f as s,b as i,e as c}from"./app-ZIbUVzH_.js";const o={},u=c(`<h1 id="deploy-service-into-k8s" tabindex="-1"><a class="header-anchor" href="#deploy-service-into-k8s" aria-hidden="true">#</a> Deploy service into K8s</h1><h2 id="environment-requirement" tabindex="-1"><a class="header-anchor" href="#environment-requirement" aria-hidden="true">#</a> Environment Requirement</h2><ul><li>minikube v1.23.0 +</li><li><strong>mysql 8.0 +</strong> | MariaDB 10.7 + | Postgres 14 + (<strong>Postgres 15 + recommended</strong>)</li><li>redis 6.0 +</li><li>docker</li></ul><h2 id="minikube-setting" tabindex="-1"><a class="header-anchor" href="#minikube-setting" aria-hidden="true">#</a> Minikube Setting</h2><p><a href="/guide/basic-config/k8s/minikube">Minikube</a></p><h3 id="k8s-setting" tabindex="-1"><a class="header-anchor" href="#k8s-setting" aria-hidden="true">#</a> K8s Setting</h3><h4 id="api-service" tabindex="-1"><a class="header-anchor" href="#api-service" aria-hidden="true">#</a> API service</h4><blockquote><p>api/etc/core.yaml</p></blockquote><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">Name</span><span class="token punctuation">:</span> core.api
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26),r={class:"hint-container warning"},d=n("p",{class:"hint-container-title"},"Warning",-1),k={href:"http://%7Bservice-name%7D.%7Bnamespace%7D.svc.cluster.local:%7Bport%7D/",target:"_blank",rel:"noopener noreferrer"},m=n("h4",{id:"quick-deployment",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#quick-deployment","aria-hidden":"true"},"#"),s(" Quick Deployment")],-1),v=n("blockquote",null,[n("p",null,"Run deploy/k8s/setup.sh")],-1);function b(y,h){const a=t("ExternalLinkIcon");return l(),p("div",null,[u,n("div",r,[d,n("p",null,[s("proxy_pass format: "),n("a",k,[s("http://{service-name}.{namespace}.svc.cluster.local:{port}/"),i(a)])])]),m,v])}const x=e(o,[["render",b],["__file","k8s-deploy.html.vue"]]);export{x as default};
