import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as l,c as p,a as n,f as s,b as i,e as c}from"./app-88j0vs5h.js";const o={},u=c(`<h1 id="部署k8s" tabindex="-1"><a class="header-anchor" href="#部署k8s" aria-hidden="true">#</a> 部署K8s</h1><h2 id="环境需求" tabindex="-1"><a class="header-anchor" href="#环境需求" aria-hidden="true">#</a> 环境需求</h2><ul><li>minikube v1.23.0 +</li><li><strong>mysql 8.0 +</strong> | MariaDB 10.7 + | Postgres 14 + (<strong>Postgres 15 + 推荐</strong>)</li><li>redis 6.0 +</li><li>docker</li></ul><h2 id="minikube-配置" tabindex="-1"><a class="header-anchor" href="#minikube-配置" aria-hidden="true">#</a> Minikube 配置</h2><p><a href="/guide/basic-config/k8s/minikube">Minikube</a></p><h3 id="k8s配置" tabindex="-1"><a class="header-anchor" href="#k8s配置" aria-hidden="true">#</a> K8s配置</h3><h4 id="api-服务" tabindex="-1"><a class="header-anchor" href="#api-服务" aria-hidden="true">#</a> API 服务</h4><blockquote><p>api/etc/core.yaml</p></blockquote><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">Name</span><span class="token punctuation">:</span> core.api
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26),r={class:"hint-container warning"},k=n("p",{class:"hint-container-title"},"注意",-1),d={href:"http://%7Bservice-name%7D.%7Bnamespace%7D.svc.cluster.local:%7Bport%7D/",target:"_blank",rel:"noopener noreferrer"},v=n("h4",{id:"快速部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#快速部署","aria-hidden":"true"},"#"),s(" 快速部署")],-1),m=n("blockquote",null,[n("p",null,"执行 deploy/k8s/setup.sh")],-1);function b(y,h){const a=t("ExternalLinkIcon");return l(),p("div",null,[u,n("div",r,[k,n("p",null,[s("proxy_pass 格式 "),n("a",d,[s("http://{service-name}.{namespace}.svc.cluster.local:{port}/"),i(a)])])]),v,m])}const x=e(o,[["render",b],["__file","k8s-deploy.html.vue"]]);export{x as default};
