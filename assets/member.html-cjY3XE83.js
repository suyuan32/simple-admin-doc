...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="modify-configuration-file" tabindex="-1"><a class="header-anchor" href="#modify-configuration-file"><span>Modify configuration file</span></a></h3><p>The config file is similar with core service&#39;s.</p><div class="hint-container warning"><p class="hint-container-title">Warning</p><p>You should check the CoreRpc config in rpc service and the MmsConf in api service.</p></div>`,7),r={class:"hint-container info"},d=n("p",{class:"hint-container-title"},"Info",-1),m=n("li",null,"Make sure AccessSecret is the same as simple-admin-core's api set",-1),k=n("li",null,"The configuration is similar as core",-1),v=n("li",null,"Run code the same as core",-1),b={href:"http://localhost:3100/init",target:"_blank",rel:"noopener noreferrer"},h=n("li",null,"Add API interface permissions on the role page, then restart the API service of member. You do not need to restart service after v1.0.14.",-1),y=a(`<h3 id="k8s-deployment" tabindex="-1"><a class="header-anchor" href="#k8s-deployment"><span>K8s Deployment</span></a></h3><blockquote><p>It is similar with core api.</p></blockquote><p>You should do these step:</p><ul><li>deploy the images via docker</li><li>modify simple-admin-backend-ui/deploy/default.conf, uncomment the mms-api rule</li><li>update ingress configmap</li><li>update ingress controller</li></ul><h3 id="configuration-file" tabindex="-1"><a class="header-anchor" href="#configuration-file"><span>Configuration file</span></a></h3><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token key atrule">Name</span><span class="token punctuation">:</span> mms.api
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function f(g,_){const e=i("ExternalLinkIcon");return l(),p("div",null,[u,n("div",r,[d,n("ul",null,[m,k,v,n("li",null,[s("Init database in "),n("a",b,[s("http://localhost:3100/init"),c(e)])]),h])]),y])}const T=t(o,[["render",f],["__file","member.html.vue"]]);export{T as default};
