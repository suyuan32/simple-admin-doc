import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-z0TS8spT.js";const t={},l=e(`<h3 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction"><span>Introduction</span></a></h3><p>Simple Admin&#39;s message center module (MCMS) is primarily responsible for email sending, SMS message sending, announcements, and internal instant messaging (IM). It supports any SMTP email service and integrates with Alibaba Cloud, Tencent Cloud, and Heyun for SMS messaging services.</p><h3 id="download-code" tabindex="-1"><a class="header-anchor" href="#download-code"><span>Download Code</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-message-center.git
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="configuration-file" tabindex="-1"><a class="header-anchor" href="#configuration-file"><span>Configuration File</span></a></h3><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token key atrule">Name</span><span class="token punctuation">:</span> mcms.rpc
