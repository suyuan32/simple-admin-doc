import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as e,e as s}from"./app-ec856e6f.js";const a={},l=s(`<h1 id="proto-转-api-命令" tabindex="-1"><a class="header-anchor" href="#proto-转-api-命令" aria-hidden="true">#</a> Proto 转 Api 命令</h1><blockquote><p>goctls &gt;= 1.5.14</p></blockquote><p>该命令用于通过 proto 生成 api 中的字段内容，使得 proto 接入 api 更便捷</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls extra proto2api <span class="token parameter variable">-h</span>
