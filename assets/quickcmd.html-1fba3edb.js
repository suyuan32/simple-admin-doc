import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as l,c,a as n,b as e,d as a,w as r,e as d}from"./app-df8ead8e.js";const u={},m=n("h1",{id:"quick-commands",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#quick-commands","aria-hidden":"true"},"#"),e(" Quick Commands")],-1),p={class:"hint-container warning"},v=n("p",{class:"hint-container-title"},"Note",-1),k=n("code",null,"Windows",-1),b=d(`<p>We offer several commands in makefile ， you can just run in bash:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># build docker image, require environment variables DOCKER_USERNAME</span>
