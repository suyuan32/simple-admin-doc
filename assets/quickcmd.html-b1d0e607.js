import{_ as a,W as i,X as t,Y as n,Z as e,$ as o,a0 as l,F as c}from"./framework-2d290880.js";const r={},d=l(`<h1 id="quick-commands" tabindex="-1"><a class="header-anchor" href="#quick-commands" aria-hidden="true">#</a> Quick Commands</h1><h4 id="note-the-system-needs-to-support-the-make-command-linux-is-recommended" tabindex="-1"><a class="header-anchor" href="#note-the-system-needs-to-support-the-make-command-linux-is-recommended" aria-hidden="true">#</a> <strong>Note: The system needs to support the make command, linux is recommended</strong></h4><p>We offer several commands in makefile ， you can just run in bash:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># build docker image, require environment variables DOCKER_USERNAME VERSION </span>
