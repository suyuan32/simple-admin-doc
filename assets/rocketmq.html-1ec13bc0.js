import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-9625e4e2.js";const t={},o=e(`<h2 id="如何添加-producer-到-rpc-中" tabindex="-1"><a class="header-anchor" href="#如何添加-producer-到-rpc-中" aria-hidden="true">#</a> 如何添加 Producer 到 RPC 中？</h2><h3 id="添加配置信息到-etc" tabindex="-1"><a class="header-anchor" href="#添加配置信息到-etc" aria-hidden="true">#</a> 添加配置信息到 <code>etc</code></h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">ProducerConf</span><span class="token punctuation">:</span>
