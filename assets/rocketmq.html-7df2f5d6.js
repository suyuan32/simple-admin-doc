import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-733fdf0b.js";const t={},o=e(`<h2 id="how-to-add-producer-to-rpc" tabindex="-1"><a class="header-anchor" href="#how-to-add-producer-to-rpc" aria-hidden="true">#</a> How to add Producer to RPC?</h2><h3 id="add-configuration-information-to-etc" tabindex="-1"><a class="header-anchor" href="#add-configuration-information-to-etc" aria-hidden="true">#</a> Add configuration information to <code>etc</code></h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">ProducerConf</span><span class="token punctuation">:</span>
