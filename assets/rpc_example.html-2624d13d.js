...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p>创建项目名称仅支持小写和驼峰命名</p></div><h3 id="rpc-new参数介绍" tabindex="-1"><a class="header-anchor" href="#rpc-new参数介绍" aria-hidden="true">#</a> <code>rpc new</code>参数介绍</h3>`,11),x=n("thead",null,[n("tr",null,[n("th",null,"参数"),n("th",null,"必须"),n("th",null,"默认值"),n("th",null,"介绍"),n("th",null,"使用方法")])],-1),w=n("tr",null,[n("td",null,"ent"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否启用 ent"),n("td",null,"true 为启用")],-1),q=n("tr",null,[n("td",null,"module_name"),n("td",null,"否"),n("td"),n("td",null,"go.mod 中的 module 名称"),n("td",null,"如果项目需要被在外部 import，需要像上面例子设置为 github 或者其他地方的仓库网址， 为空则 module 为项目名称")],-1),C=n("td",null,"go_zero_version",-1),z=n("td",null,"否",-1),S=n("td",null,"v1.5.1",-1),E=n("td",null,"go zero 版本",-1),R={href:"https://github.com/zeromicro/go-zero/releases",target:"_blank",rel:"noopener noreferrer"},T=n("td",null,"tool_version",-1),P=n("td",null,"否",-1),N=n("td",null,"v0.3.2",-1),D=n("td",null,"simple admin tools 版本号",-1),I={href:"https://github.com/suyuan32/simple-admin-tools/releases",target:"_blank",rel:"noopener noreferrer"},A=n("tr",null,[n("td",null,"gitlab"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否生成 gitlab-ci.yml"),n("td",null,"true 为生成")],-1),B=n("tr",null,[n("td",null,"port"),n("td",null,"否"),n("td",null,"9100"),n("td",null,"端口号"),n("td",null,"服务暴露的端口号")],-1),M=n("tr",null,[n("td",null,"desc"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否拆分 proto 文件到 desc 文件夹"),n("td",null,"true 会生成 desc 文件夹")],-1),F=t(`<p>** 详细参数请在命令行查看 <code>goctls rpc new --help</code> **</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls rpc new <span class="token parameter variable">--help</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>说明运行成功.</p>`,15),G={class:"hint-container warning"},H=n("p",{class:"hint-container-title"},"注意",-1),V={href:"https://github.com/suyuan32/simple-admin-member-rpc/blob/main/internal/logic/base/init_database_logic.go",target:"_blank",rel:"noopener noreferrer"},O={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},$=t(`<h2 id="simple-admin-example-api-中如何远程调用该-rpc" tabindex="-1"><a class="header-anchor" href="#simple-admin-example-api-中如何远程调用该-rpc" aria-hidden="true">#</a> simple admin example api 中如何远程调用该 RPC</h2><h3 id="添加-config" tabindex="-1"><a class="header-anchor" href="#添加-config" aria-hidden="true">#</a> 添加 config</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> config
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 logic 直接调用 l.svcCtx.ExampleRpc 即可</p>`,7),K={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function X(Y,Z){const a=r("ExternalLinkIcon");return o(),c("div",null,[d,n("div",m,[v,k,b,n("p",null,[s("必须了解 go zero 的 RPC 命令 "),n("a",h,[s("RPC 命令"),e(a)]),s(),n("a",g,[s("RPC 服务"),e(a)]),f,s(" 参考 "),n("a",y,[s("Example"),e(a)]),s(" 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令")])]),_,n("table",null,[x,n("tbody",null,[w,q,n("tr",null,[C,z,S,E,n("td",null,[s("需要到"),n("a",R,[s("go-zero"),e(a)]),s("查看最新 release")])]),n("tr",null,[T,P,N,D,n("td",null,[s("需要到"),n("a",I,[s("tool"),e(a)]),s("查看 simple admin tools 最新 release")])]),A,B,M])]),F,n("div",L,[U,n("p",null,[n("a",W,[s("示例代码"),e(a)])])]),j,n("div",G,[H,n("p",null,[s("后续还需要修改数据库初始化函数，参考 "),n("a",V,[s("simple admin member"),e(a)])])]),n("blockquote",null,[n("p",null,[s("项目地址 "),n("a",O,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),$,n("blockquote",null,[n("p",null,[s("simple admin example api 地址 "),n("a",K,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const nn=l(u,[["render",X],["__file","rpc_example.html.vue"]]);export{nn as default};
