...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 logic 直接调用 l.svcCtx.ExampleRpc 即可</p>`,8),X={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function Y(Z,$){const a=u("ExternalLinkIcon");return o(),c("div",null,[d,n("div",k,[m,v,b,n("p",null,[s("必须了解 go zero 的 RPC 命令 "),n("a",g,[s("RPC命令"),e(a)]),s(),n("a",h,[s("RPC服务"),e(a)]),_,s(" 参考 "),n("a",f,[s("Example"),e(a)]),s(" 项目生成一遍，确认生成文件与Example项目一致，Example项目有完整的命令")])]),y,n("table",null,[x,n("tbody",null,[q,w,n("tr",null,[C,S,E,R,n("td",null,[s("需要到"),n("a",z,[s("go-zero"),e(a)]),s("查看最新release")])]),n("tr",null,[P,D,N,B,n("td",null,[s("需要到"),n("a",A,[s("tool"),e(a)]),s("查看simple admin tools 最新 release")])]),I,L,M])]),T,n("div",F,[H,n("p",null,[n("a",U,[s("示例代码"),e(a)])])]),V,n("div",j,[O,n("p",null,[s("后续还需要修改数据库初始化函数，参考 "),n("a",G,[s("simple admin member"),e(a)])])]),n("blockquote",null,[n("p",null,[s("项目地址 "),n("a",K,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),W,n("blockquote",null,[n("p",null,[s("simple admin example api 地址 "),n("a",X,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const nn=i(r,[["render",Y],["__file","rpc_example.html.vue"]]);export{nn as default};
