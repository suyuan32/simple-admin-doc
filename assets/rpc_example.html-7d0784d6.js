import{_ as i,a as o}from"./ent_gen_logic-6662d943.js";import{_ as p,W as l,X as c,Y as n,Z as s,$ as e,a0 as t,F as r}from"./framework-2d290880.js";const u={},d=n("h1",{id:"_3-minutes-developing-rpc-service",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_3-minutes-developing-rpc-service","aria-hidden":"true"},"#"),s(" 3 minutes developing RPC service")],-1),m={class:"hint-container warning"},k=n("p",{class:"hint-container-title"},"Note",-1),v=n("p",null,"Make sure that you have been installed follow software:",-1),b=n("ul",null,[n("li",null,"simple-admin-tool (goctls) v0.2.2 +")],-1),h=n("br",null,null,-1),g={href:"https://go-zero.dev/docs/goctl/zrpc/#%E6%96%B9%E5%BC%8F%E4%BA%8C%E9%80%9A%E8%BF%87%E6%8C%87%E5%AE%9Aproto%E7%94%9F%E6%88%90rpc%E6%9C%8D%E5%8A%A1",target:"_blank",rel:"noopener noreferrer"},f={href:"https://go-zero.dev/docs/advance/rpc-call",target:"_blank",rel:"noopener noreferrer"},y=n("br",null,null,-1),_=n("br",null,null,-1),x={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},w=t(`<h2 id="rpc-responsibilities" tabindex="-1"><a class="header-anchor" href="#rpc-responsibilities" aria-hidden="true">#</a> RPC Responsibilities</h2><p>In Simple Admin, RPC is mainly used to obtain data and provide extended functions. It mainly has the following responsibilities:</p><ul><li>Interact with the database to obtain the required data, such as PostgreSql</li><li>Interact with data sources to obtain data, such as ES</li><li>Provide additional functions for API layer calls, such as sending text messages and emails</li></ul><p>Multiple different APIs can access the same RPC to call its functions.</p><h2 id="create-rpc-project" tabindex="-1"><a class="header-anchor" href="#create-rpc-project" aria-hidden="true">#</a> Create RPC project</h2><blockquote><p>Create example project</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls rpc new example <span class="token parameter variable">--ent</span><span class="token operator">=</span>true <span class="token parameter variable">--module_name</span><span class="token operator">=</span>github.com/suyuan32/simple-admin-example-rpc <span class="token parameter variable">--go_zero_version</span><span class="token operator">=</span>v1.4.3 <span class="token parameter variable">--tool_version</span><span class="token operator">=</span>v0.1.8 <span class="token parameter variable">--port</span><span class="token operator">=</span><span class="token number">8080</span>  <span class="token parameter variable">--gitlab</span><span class="token operator">=</span>true <span class="token parameter variable">--desc</span><span class="token operator">=</span>true
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="rpc-new-parameters" tabindex="-1"><a class="header-anchor" href="#rpc-new-parameters" aria-hidden="true">#</a> <code>rpc new</code> parameters</h3>`,8),q=n("thead",null,[n("tr",null,[n("th",null,"Parameter"),n("th",null,"Must"),n("th",null,"Default"),n("th",null,"Introduction"),n("th",null,"Usage")])],-1),C=n("tr",null,[n("td",null,"ent"),n("td",null,"No"),n("td",null,"false"),n("td",null,"Whether to use Ent"),n("td",null,"true means use")],-1),S=n("tr",null,[n("td",null,"module_name"),n("td",null,"Yes"),n("td"),n("td",null,"Module name in go.mod"),n("td",null,"If your project will be used by other project, you should set as above which is a github repository")],-1),E=n("td",null,"go_zero_version",-1),R=n("td",null,"Yes",-1),z=n("td",null,null,-1),P=n("td",null,"Go zero version",-1),I={href:"https://github.com/zeromicro/go-zero/releases",target:"_blank",rel:"noopener noreferrer"},N=n("td",null,"tool_version",-1),M=n("td",null,"Yes",-1),j=n("td",null,null,-1),D=n("td",null,"Simple admin tools version",-1),T={href:"https://github.com/suyuan32/simple-admin-tools/releases",target:"_blank",rel:"noopener noreferrer"},A=n("tr",null,[n("td",null,"gitlab"),n("td",null,"No"),n("td",null,"false"),n("td",null,"Whether to generating gitlab-ci.yml"),n("td",null,"true means generating")],-1),B=n("tr",null,[n("td",null,"port"),n("td",null,"No"),n("td",null,"9100"),n("td",null,"Port number"),n("td",null,"The service port")],-1),F=n("tr",null,[n("td",null,"desc"),n("td",null,"No"),n("td",null,"false"),n("td",null,"Whether to split the proto file into the desc folder"),n("td",null,"true will generate the desc folder")],-1),Y=t('<p>More parameters please check <code>goctls rpc new --help</code></p><blockquote><p>You can see the project structure:</p></blockquote><figure><img src="'+i+`" alt="Example" tabindex="0" loading="lazy"><figcaption>Example</figcaption></figure><h3 id="file-structure" tabindex="-1"><a class="header-anchor" href="#file-structure" aria-hidden="true">#</a> File structure</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── desc                               proto file directory
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,10),W={href:"https://github.com/suyuan32/simple-admin-file/blob/master/api/internal/logic/file/init_database_logic.go",target:"_blank",rel:"noopener noreferrer"},O={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},V=t(`<blockquote><p>How to call the RPC in simple admin example api</p></blockquote><h3 id="add-config" tabindex="-1"><a class="header-anchor" href="#add-config" aria-hidden="true">#</a> Add config</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> config
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container info"><p class="hint-container-title">Info</p><p>Small website use endpoint connect directly \\</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">ExampleRpc</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>It does not need service discovery， there can be several endpoints. \\</p></div><h2 id="add-example-rpc-in-service-context" tabindex="-1"><a class="header-anchor" href="#add-example-rpc-in-service-context" aria-hidden="true">#</a> Add example rpc in service context</h2><h3 id="edit-service-context" tabindex="-1"><a class="header-anchor" href="#edit-service-context" aria-hidden="true">#</a> Edit service context</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> svc
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p><strong>And then you can call in via l.svcCtx.ExampleRpc in logic code.</strong></p></blockquote>`,8),K={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function Q(X,Z){const a=r("ExternalLinkIcon");return l(),c("div",null,[d,n("div",m,[k,v,b,n("p",null,[h,s(" Must know go-zero's RPC command. "),n("a",g,[s("RPC Command"),e(a)]),s(),n("a",f,[s("RPC Service"),e(a)]),s(),y,_,s(" Refer to the "),n("a",x,[s("Example"),e(a)]),s(" project to generate it again, confirm that the generated file is consistent with the Example project, and the Example project has complete commands.")])]),w,n("table",null,[q,n("tbody",null,[C,S,n("tr",null,[E,R,z,P,n("td",null,[s("Go to "),n("a",I,[s("go-zero"),e(a)]),s(" to get the latest release")])]),n("tr",null,[N,M,j,D,n("td",null,[s("Go to "),n("a",T,[s("tool"),e(a)]),s(" to get the latest release")])]),A,B,F])]),Y,n("div",L,[U,n("p",null,[n("a",G,[s("Example Code"),e(a)])])]),H,n("p",null,[s("That means the codes run successfully, you need to finish the database initialization like: "),n("a",W,[s("simple admin file"),e(a)])]),n("blockquote",null,[n("p",null,[s("Project URL "),n("a",O,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),V,n("blockquote",null,[n("p",null,[s("simple admin example api "),n("a",K,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const nn=p(u,[["render",Q],["__file","rpc_example.html.vue"]]);export{nn as default};
