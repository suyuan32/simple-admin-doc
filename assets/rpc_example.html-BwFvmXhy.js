import{_ as l,a as o}from"./ent_gen_logic-DWPOcydN.js";import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as p,o as r,c as d,a as n,f as s,b as a,e as t}from"./app-D1r_dmmg.js";const u={},m={class:"hint-container warning"},v=n("p",{class:"hint-container-title"},"注意",-1),k={href:"https://go-zero.dev/docs/tutorials/cli/rpc",target:"_blank",rel:"noopener noreferrer"},b={href:"https://go-zero.dev/docs/tutorials/grpc/server/configuration",target:"_blank",rel:"noopener noreferrer"},g=n("br",null,null,-1),h={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},f={class:"hint-container info"},y=n("p",{class:"hint-container-title"},"相关信息",-1),x={href:"https://www.bilibili.com/video/BV12s4y1R755",target:"_blank",rel:"noopener noreferrer"},_=t(`<h2 id="rpc-职责" tabindex="-1"><a class="header-anchor" href="#rpc-职责"><span>RPC 职责</span></a></h2><p>在 Simple Admin 中， RPC 主要用于获取数据以及提供扩展功能， 主要有以下职责：</p><ul><li>与数据库交互，获取所需数据， 如 PostgreSql</li><li>与数据源交互获取数据， 如 ES</li><li>提供额外功能供 API 层调用，如发短信，邮件</li></ul><p>多个不同的 API 都可以接入同一个 RPC 调用其功能。</p><h2 id="创建-rpc-基本项目" tabindex="-1"><a class="header-anchor" href="#创建-rpc-基本项目"><span>创建 RPC 基本项目</span></a></h2><blockquote><p>创建 example 服务</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>goctls rpc new example <span class="token parameter variable">--ent</span><span class="token operator">=</span>true <span class="token parameter variable">--module_name</span><span class="token operator">=</span>github.com/suyuan32/simple-admin-example-rpc  <span class="token parameter variable">--port</span><span class="token operator">=</span><span class="token number">8080</span> <span class="token parameter variable">--desc</span><span class="token operator">=</span>true
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>你可以看到如下项目结构</p></blockquote><figure><img src="`+l+`" alt="Example" tabindex="0" loading="lazy"><figcaption>Example</figcaption></figure><h3 id="文件结构" tabindex="-1"><a class="header-anchor" href="#文件结构"><span>文件结构</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>├── desc                                  proto 文件目录
├── ent                                   ent 文件目录
│   ├── enttest
│   ├── hook
│   ├── migrate
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 logic 直接调用 l.svcCtx.ExampleRpc 即可</p>`,7),D={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function I(T,B){const e=p("ExternalLinkIcon"),i=p("BiliBili");return r(),d("div",null,[n("div",m,[v,n("p",null,[s("必须了解 go zero 的 RPC 命令 "),n("a",k,[s("RPC 命令"),a(e)]),s(),n("a",b,[s("RPC 服务"),a(e)]),g,s(" 参考 "),n("a",h,[s("Example"),a(e)]),s(" 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令")])]),n("div",f,[y,n("p",null,[n("a",x,[s("视频教程"),a(e)])]),a(i,{bvid:"BV12s4y1R755"})]),_,n("div",w,[q,n("p",null,[n("a",C,[s("示例代码"),a(e)])])]),R,n("div",S,[z,n("p",null,[s("后续还需要修改数据库初始化函数，参考 "),n("a",P,[s("simple admin member"),a(e)])])]),n("blockquote",null,[n("p",null,[s("项目地址 "),n("a",E,[s("https://github.com/suyuan32/simple-admin-example-rpc"),a(e)])])]),N,n("blockquote",null,[n("p",null,[s("simple admin example api 地址 "),n("a",D,[s("https://github.com/suyuan32/simple-admin-example-api"),a(e)])])])])}const A=c(u,[["render",I],["__file","rpc_example.html.vue"]]),F=JSON.parse('{"path":"/zh/guide/quick-start/codegen/rpc_example.html","title":"RPC 微服务","lang":"zh-CN","frontmatter":{"order":2,"title":"RPC 微服务","description":"注意 必须了解 go zero 的 RPC 命令 RPC 命令 RPC 服务 参考 Example 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令 相关信息 视频教程 RPC 职责 在 Simple Admin 中， RPC 主要用于获取数据以及提供扩展功能， 主要有以下职责： 与数据库交互，获取所需数据， 如...","head":[["link",{"rel":"alternate","hreflang":"en-us","href":"https://doc.ryansu.tech/guide/quick-start/codegen/rpc_example.html"}],["meta",{"property":"og:url","content":"https://doc.ryansu.tech/zh/guide/quick-start/codegen/rpc_example.html"}],["meta",{"property":"og:site_name","content":"Simple Admin"}],["meta",{"property":"og:title","content":"RPC 微服务"}],["meta",{"property":"og:description","content":"注意 必须了解 go zero 的 RPC 命令 RPC 命令 RPC 服务 参考 Example 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令 相关信息 视频教程 RPC 职责 在 Simple Admin 中， RPC 主要用于获取数据以及提供扩展功能， 主要有以下职责： 与数据库交互，获取所需数据， 如..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://doc.ryansu.tech/assets/example_rpc_struct.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:locale:alternate","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2024-05-15T10:08:11.000Z"}],["meta",{"property":"article:author","content":"Ryan SU"}],["meta",{"property":"article:modified_time","content":"2024-05-15T10:08:11.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"RPC 微服务\\",\\"image\\":[\\"https://doc.ryansu.tech/assets/example_rpc_struct.png\\",\\"https://doc.ryansu.tech/assets/ent_gen_logic.png\\"],\\"dateModified\\":\\"2024-05-15T10:08:11.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Ryan SU\\",\\"url\\":\\"https://github.com/suyuan32\\"}]}"]]},"headers":[{"level":2,"title":"RPC 职责","slug":"rpc-职责","link":"#rpc-职责","children":[]},{"level":2,"title":"创建 RPC 基本项目","slug":"创建-rpc-基本项目","link":"#创建-rpc-基本项目","children":[{"level":3,"title":"rpc new参数介绍","slug":"rpc-new参数介绍","link":"#rpc-new参数介绍","children":[]},{"level":3,"title":"文件结构","slug":"文件结构","link":"#文件结构","children":[]},{"level":3,"title":"编辑 schema","slug":"编辑-schema","link":"#编辑-schema","children":[]},{"level":3,"title":"生成 Ent 代码","slug":"生成-ent-代码","link":"#生成-ent-代码","children":[]},{"level":3,"title":"生成 Student 逻辑代码","slug":"生成-student-逻辑代码","link":"#生成-student-逻辑代码","children":[]},{"level":3,"title":"rpc ent参数介绍","slug":"rpc-ent参数介绍","link":"#rpc-ent参数介绍","children":[]}]},{"level":2,"title":"simple admin example api 中如何远程调用该 RPC","slug":"simple-admin-example-api-中如何远程调用该-rpc","link":"#simple-admin-example-api-中如何远程调用该-rpc","children":[{"level":3,"title":"添加 config","slug":"添加-config","link":"#添加-config","children":[]},{"level":3,"title":"添加 example rpc","slug":"添加-example-rpc","link":"#添加-example-rpc","children":[]}]}],"git":{"createdTime":1671464359000,"updatedTime":1715767691000,"contributors":[{"name":"Ryan SU","email":"yuansu.china.work@gmail.com","commits":19},{"name":"Ryan SU","email":"1137661202@qq.com","commits":16},{"name":"Ryan Su","email":"yuansu.china.work@gmail.com","commits":3},{"name":"Larmian","email":"65385917+Larmian@users.noreply.github.com","commits":1}]},"readingTime":{"minutes":7.12,"words":2136},"filePathRelative":"zh/guide/quick-start/codegen/rpc_example.md","localizedDate":"2022年12月19日","autoDesc":true,"excerpt":"<div class=\\"hint-container warning\\">\\n<p class=\\"hint-container-title\\">注意</p>\\n<p>必须了解 go zero 的 RPC 命令 <a href=\\"https://go-zero.dev/docs/tutorials/cli/rpc\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">RPC 命令</a> <a href=\\"https://go-zero.dev/docs/tutorials/grpc/server/configuration\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">RPC 服务</a>\\n<br>\\n参考 <a href=\\"https://github.com/suyuan32/simple-admin-example-rpc\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">Example</a> 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令</p>\\n</div>"}');export{A as comp,F as data};
