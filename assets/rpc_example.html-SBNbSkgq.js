import{_ as p,a as i}from"./ent_gen_logic-QVeuvCRp.js";import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as c,c as r,a as n,f as s,b as e,e as t}from"./app-nfslqie0.js";const d={},u={class:"hint-container warning"},m=n("p",{class:"hint-container-title"},"注意",-1),v=n("p",null,"首先确认你安装了以下软件:",-1),k=n("ul",null,[n("li",null,"simple-admin-tool (goctls) v1.5.5 +")],-1),b={href:"https://go-zero.dev/cn/docs/goctl/zrpc/#%E6%96%B9%E5%BC%8F%E4%BA%8C%E9%80%9A%E8%BF%87%E6%8C%87%E5%AE%9Aproto%E7%94%9F%E6%88%90rpc%E6%9C%8D%E5%8A%A1",target:"_blank",rel:"noopener noreferrer"},g={href:"https://go-zero.dev/cn/docs/advance/rpc-call",target:"_blank",rel:"noopener noreferrer"},h=n("br",null,null,-1),f={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},y={class:"hint-container info"},_=n("p",{class:"hint-container-title"},"相关信息",-1),x={href:"https://www.bilibili.com/video/BV12s4y1R755",target:"_blank",rel:"noopener noreferrer"},w=t(`<h2 id="rpc-职责" tabindex="-1"><a class="header-anchor" href="#rpc-职责" aria-hidden="true">#</a> RPC 职责</h2><p>在 Simple Admin 中， RPC 主要用于获取数据以及提供扩展功能， 主要有以下职责：</p><ul><li>与数据库交互，获取所需数据， 如 PostgreSql</li><li>与数据源交互获取数据， 如 ES</li><li>提供额外功能供 API 层调用，如发短信，邮件</li></ul><p>多个不同的 API 都可以接入同一个 RPC 调用其功能。</p><h2 id="创建-rpc-基本项目" tabindex="-1"><a class="header-anchor" href="#创建-rpc-基本项目" aria-hidden="true">#</a> 创建 RPC 基本项目</h2><blockquote><p>创建 example 服务</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls rpc new example <span class="token parameter variable">--ent</span><span class="token operator">=</span>true <span class="token parameter variable">--module_name</span><span class="token operator">=</span>github.com/suyuan32/simple-admin-example-rpc  <span class="token parameter variable">--port</span><span class="token operator">=</span><span class="token number">8080</span> <span class="token parameter variable">--desc</span><span class="token operator">=</span>true
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 logic 直接调用 l.svcCtx.ExampleRpc 即可</p>`,7),I={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function A(B,M){const a=o("ExternalLinkIcon");return c(),r("div",null,[n("div",u,[m,v,k,n("p",null,[s("必须了解 go zero 的 RPC 命令 "),n("a",b,[s("RPC 命令"),e(a)]),s(),n("a",g,[s("RPC 服务"),e(a)]),h,s(" 参考 "),n("a",f,[s("Example"),e(a)]),s(" 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令")])]),n("div",y,[_,n("p",null,[n("a",x,[s("视频教程"),e(a)])])]),w,n("div",q,[C,n("p",null,[n("a",E,[s("示例代码"),e(a)])])]),S,n("div",R,[z,n("p",null,[s("后续还需要修改数据库初始化函数，参考 "),n("a",P,[s("simple admin member"),e(a)])])]),n("blockquote",null,[n("p",null,[s("项目地址 "),n("a",D,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),N,n("blockquote",null,[n("p",null,[s("simple admin example api 地址 "),n("a",I,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const U=l(d,[["render",A],["__file","rpc_example.html.vue"]]);export{U as default};
