...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,12),R={href:"https://github.com/suyuan32/simple-admin-file/blob/master/api/internal/logic/file/init_database_logic.go",target:"_blank",rel:"noopener noreferrer"},z={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},E=t(`<blockquote><p>simple admin example api 中如何远程调用该 RPC</p></blockquote><h3 id="添加-config" tabindex="-1"><a class="header-anchor" href="#添加-config" aria-hidden="true">#</a> 添加 config</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> config
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>然后在 logic 直接调用 l.svcCtx.ExampleRpc 即可</p></blockquote>`,8),D={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function N(P,I){const a=u("ExternalLinkIcon");return i(),c("div",null,[d,n("table",null,[k,n("tbody",null,[m,v,n("tr",null,[b,g,n("td",null,[s("需要到"),n("a",h,[s("go-zero"),e(a)]),s("查看最新release")])]),n("tr",null,[f,y,n("td",null,[s("需要到"),n("a",x,[s("tool"),e(a)]),s("查看simple admin tools 最新 release")])]),_,q])]),w,n("p",null,[n("a",S,[s("代码"),e(a)])]),C,n("p",null,[s("说明运行成功. 注意后续还需要修改数据库初始化函数，参考 "),n("a",R,[s("simple admin file"),e(a)])]),n("blockquote",null,[n("p",null,[s("项目地址 "),n("a",z,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),E,n("blockquote",null,[n("p",null,[s("simple admin example api 地址 "),n("a",D,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const M=l(r,[["render",N],["__file","rpc_example.html.vue"]]);export{M as default};
