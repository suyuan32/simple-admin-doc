...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>And then you can call in via l.svcCtx.ExampleRpc in logic code</p></blockquote>`,8),I={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function D(P,N){const a=u("ExternalLinkIcon");return l(),c("div",null,[d,n("table",null,[k,n("tbody",null,[m,v,n("tr",null,[b,g,n("td",null,[s("Go to "),n("a",h,[s("go-zero"),e(a)]),s(" to get the latest release")])]),n("tr",null,[f,y,n("td",null,[s("Go to "),n("a",x,[s("tool"),e(a)]),s(" to get the latest release")])]),_,q])]),w,n("p",null,[n("a",C,[s("Code"),e(a)])]),S,n("p",null,[s("That means the codes run successfully, you need to finish the database initialization like: "),n("a",R,[s("simple admin file"),e(a)])]),n("blockquote",null,[n("p",null,[s("Project URL "),n("a",z,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),E,n("blockquote",null,[n("p",null,[s("simple admin example api "),n("a",I,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const j=i(r,[["render",D],["__file","rpc_example.html.vue"]]);export{j as default};
