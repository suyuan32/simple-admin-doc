...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">Note</p><p>The project name only supports lowercase and camelcase and must be not contains <code>rpc</code> words.</p></div><h3 id="rpc-new-parameters" tabindex="-1"><a class="header-anchor" href="#rpc-new-parameters" aria-hidden="true">#</a> <code>rpc new</code> parameters</h3>`,7),N=n("thead",null,[n("tr",null,[n("th",null,"Parameter"),n("th",null,"Must"),n("th",null,"Default"),n("th",null,"Introduction"),n("th",null,"Usage")])],-1),I=n("tr",null,[n("td",null,"ent"),n("td",null,"No"),n("td",null,"false"),n("td",null,"Whether to use Ent"),n("td",null,"true means use")],-1),P=n("tr",null,[n("td",null,"i18n"),n("td",null,"No"),n("td",null,"false"),n("td",null,"Whether to use i18n"),n("td",null,"true means use")],-1),j=n("tr",null,[n("td",null,"module_name"),n("td",null,"No"),n("td"),n("td",null,"Module name in go.mod"),n("td",null,"If your project will be used by other project, you should set as above which is a github repository. If it is empty, the module will be the same as project name.")],-1),M=n("td",null,"go_zero_version",-1),D=n("td",null,"No",-1),A=n("td",null,"v1.5.2",-1),B=n("td",null,"Go zero version",-1),F={href:"https://github.com/zeromicro/go-zero/releases",target:"_blank",rel:"noopener noreferrer"},U=n("td",null,"tool_version",-1),W=n("td",null,"No",-1),G=n("td",null,"v1.5.5",-1),L=n("td",null,"Simple admin tools version",-1),Y={href:"https://github.com/suyuan32/simple-admin-tools/releases",target:"_blank",rel:"noopener noreferrer"},H=n("tr",null,[n("td",null,"gitlab"),n("td",null,"No"),n("td",null,"false"),n("td",null,"Whether to generating gitlab-ci.yml"),n("td",null,"true means generating")],-1),V=n("tr",null,[n("td",null,"port"),n("td",null,"No"),n("td",null,"9100"),n("td",null,"Port number"),n("td",null,"The service port")],-1),O=n("tr",null,[n("td",null,"desc"),n("td",null,"No"),n("td",null,"false"),n("td",null,"Whether to split the proto file into the desc folder"),n("td",null,"true will generate the desc folder")],-1),K=n("tr",null,[n("td",null,"style"),n("td",null,"No"),n("td",null,"go_zero"),n("td",null,"The format of the file name."),n("td",null,"snake case format is go_zero.")],-1),$=t(`<p>** More parameters please check <code>goctls rpc new --help</code> **</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls rpc new <span class="token parameter variable">--help</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,11),nn={href:"https://github.com/suyuan32/simple-admin-file/blob/master/api/internal/logic/file/init_database_logic.go",target:"_blank",rel:"noopener noreferrer"},sn={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},an=t(`<blockquote><p>How to call the RPC in simple admin example api</p></blockquote><h3 id="add-config" tabindex="-1"><a class="header-anchor" href="#add-config" aria-hidden="true">#</a> Add config</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> config
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p><strong>And then you can call in via l.svcCtx.ExampleRpc in logic code.</strong></p></blockquote>`,7),en={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function tn(on,ln){const a=p("ExternalLinkIcon");return c(),r("div",null,[d,n("div",m,[v,k,b,n("p",null,[h,s(" Must know go-zero's RPC command. "),n("a",g,[s("RPC Command"),e(a)]),s(),n("a",f,[s("RPC Service"),e(a)]),s(),y,_,s(" Refer to the "),n("a",x,[s("Example"),e(a)]),s(" project to generate it again, confirm that the generated file is consistent with the Example project, and the Example project has complete commands.")])]),w,q,C,E,n("div",z,[S,n("p",null,[n("a",R,[s("Video Tutorial"),e(a)])])]),T,n("table",null,[N,n("tbody",null,[I,P,j,n("tr",null,[M,D,A,B,n("td",null,[s("Go to "),n("a",F,[s("go-zero"),e(a)]),s(" to get the latest release")])]),n("tr",null,[U,W,G,L,n("td",null,[s("Go to "),n("a",Y,[s("tool"),e(a)]),s(" to get the latest release")])]),H,V,O,K])]),$,n("div",Q,[Z,n("p",null,[n("a",J,[s("Example Code"),e(a)])])]),X,n("p",null,[s("That means the codes run successfully, you need to finish the database initialization like: "),n("a",nn,[s("simple admin file"),e(a)])]),n("blockquote",null,[n("p",null,[s("Project URL "),n("a",sn,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),an,n("blockquote",null,[n("p",null,[s("simple admin example api "),n("a",en,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const un=l(u,[["render",tn],["__file","rpc_example.html.vue"]]);export{un as default};
