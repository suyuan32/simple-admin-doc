...
Flags:
  ...
  -g, <span class="token parameter variable">--gitlab</span>                   Whether to use gitlab-ci
  -z, <span class="token parameter variable">--go_zero_version</span> string   The go zero version used <span class="token keyword">for</span> replacement. e.g. v1.5.2, see <span class="token punctuation">[</span>https://github.com/zeromicro/go-zero/releases<span class="token punctuation">]</span> <span class="token punctuation">(</span>default <span class="token string">&quot;v1.5.2&quot;</span><span class="token punctuation">)</span>
  ...
  -t, <span class="token parameter variable">--tool_version</span> string      The simple admin tool version version used <span class="token keyword">for</span> migration. e.g. v1.5.5, see <span class="token punctuation">[</span>https://github.com/suyuan32/simple-admin-tools/releases<span class="token punctuation">]</span> <span class="token punctuation">(</span>default <span class="token string">&quot;v1.5.6&quot;</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,11),V={href:"https://github.com/suyuan32/simple-admin-file/blob/master/api/internal/logic/file/init_database_logic.go",target:"_blank",rel:"noopener noreferrer"},$={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},K=t(`<blockquote><p>How to call the RPC in simple admin example api</p></blockquote><h3 id="add-config" tabindex="-1"><a class="header-anchor" href="#add-config" aria-hidden="true">#</a> Add config</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> config
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p><strong>And then you can call in via l.svcCtx.ExampleRpc in logic code.</strong></p></blockquote>`,7),Q={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function J(X,Z){const a=p("ExternalLinkIcon");return c(),r("div",null,[d,n("div",m,[v,k,b,n("p",null,[h,s(" Must know go-zero's RPC command. "),n("a",g,[s("RPC Command"),e(a)]),s(),n("a",f,[s("RPC Service"),e(a)]),s(),y,_,s(" Refer to the "),n("a",x,[s("Example"),e(a)]),s(" project to generate it again, confirm that the generated file is consistent with the Example project, and the Example project has complete commands.")])]),w,n("table",null,[q,n("tbody",null,[C,z,E,n("tr",null,[S,R,T,N,n("td",null,[s("Go to "),n("a",I,[s("go-zero"),e(a)]),s(" to get the latest release")])]),n("tr",null,[P,j,M,D,n("td",null,[s("Go to "),n("a",A,[s("tool"),e(a)]),s(" to get the latest release")])]),B,F,U,W])]),G,n("div",L,[Y,n("p",null,[n("a",H,[s("Example Code"),e(a)])])]),O,n("p",null,[s("That means the codes run successfully, you need to finish the database initialization like: "),n("a",V,[s("simple admin file"),e(a)])]),n("blockquote",null,[n("p",null,[s("Project URL "),n("a",$,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),K,n("blockquote",null,[n("p",null,[s("simple admin example api "),n("a",Q,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const en=l(u,[["render",J],["__file","rpc_example.html.vue"]]);export{en as default};
