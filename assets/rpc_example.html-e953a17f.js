...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 logic 直接调用 l.svcCtx.ExampleRpc 即可</p>`,7),Z={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function J(Q,nn){const a=r("ExternalLinkIcon");return o(),c("div",null,[d,n("div",m,[v,k,b,n("p",null,[s("必须了解 go zero 的 RPC 命令 "),n("a",h,[s("RPC 命令"),e(a)]),s(),n("a",g,[s("RPC 服务"),e(a)]),f,s(" 参考 "),n("a",_,[s("Example"),e(a)]),s(" 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令")])]),n("div",y,[x,n("p",null,[n("a",w,[s("视频教程"),e(a)])])]),q,n("table",null,[C,n("tbody",null,[z,S,n("tr",null,[E,R,T,P,n("td",null,[s("需要到"),n("a",N,[s("go-zero"),e(a)]),s("查看最新 release")])]),n("tr",null,[D,B,I,A,n("td",null,[s("需要到"),n("a",M,[s("tool"),e(a)]),s("查看 simple admin tools 最新 release")])]),F,L,U])]),W,n("div",j,[G,n("p",null,[n("a",V,[s("示例代码"),e(a)])])]),H,n("div",O,[$,n("p",null,[s("后续还需要修改数据库初始化函数，参考 "),n("a",K,[s("simple admin member"),e(a)])])]),n("blockquote",null,[n("p",null,[s("项目地址 "),n("a",X,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),Y,n("blockquote",null,[n("p",null,[s("simple admin example api 地址 "),n("a",Z,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const en=l(u,[["render",J],["__file","rpc_example.html.vue"]]);export{en as default};
