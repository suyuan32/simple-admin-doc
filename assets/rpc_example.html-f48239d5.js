...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p>创建项目名称仅支持小写和驼峰命名</p></div><h3 id="rpc-new参数介绍" tabindex="-1"><a class="header-anchor" href="#rpc-new参数介绍" aria-hidden="true">#</a> <code>rpc new</code>参数介绍</h3>`,11),C=n("thead",null,[n("tr",null,[n("th",null,"参数"),n("th",null,"必须"),n("th",null,"默认值"),n("th",null,"介绍"),n("th",null,"使用方法")])],-1),z=n("tr",null,[n("td",null,"ent"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否启用 ent"),n("td",null,"true 为启用")],-1),S=n("tr",null,[n("td",null,"module_name"),n("td",null,"否"),n("td"),n("td",null,"go.mod 中的 module 名称"),n("td",null,"如果项目需要被在外部 import，需要像上面例子设置为 github 或者其他地方的仓库网址， 为空则 module 为项目名称")],-1),R=n("tr",null,[n("td",null,"style"),n("td",null,"否"),n("td",null,"go_zero"),n("td",null,"文件名格式"),n("td",null,"go_zero 为蛇形格式")],-1),E=n("td",null,"go_zero_version",-1),P=n("td",null,"否",-1),N=n("td",null,"v1.5.2",-1),D=n("td",null,"go zero 版本",-1),I={href:"https://github.com/zeromicro/go-zero/releases",target:"_blank",rel:"noopener noreferrer"},B=n("td",null,"tool_version",-1),A=n("td",null,"否",-1),L=n("td",null,"v1.5.5",-1),M=n("td",null,"simple admin tools 版本号",-1),T={href:"https://github.com/suyuan32/simple-admin-tools/releases",target:"_blank",rel:"noopener noreferrer"},F=n("tr",null,[n("td",null,"gitlab"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否生成 gitlab-ci.yml"),n("td",null,"true 为生成")],-1),U=n("tr",null,[n("td",null,"port"),n("td",null,"否"),n("td",null,"9100"),n("td",null,"端口号"),n("td",null,"服务暴露的端口号")],-1),V=n("tr",null,[n("td",null,"desc"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否拆分 proto 文件到 desc 文件夹"),n("td",null,"true 会生成 desc 文件夹")],-1),j=t(`<p>** 详细参数请在命令行查看 <code>goctls rpc new --help</code> **</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls rpc new <span class="token parameter variable">--help</span>
生成 RPC 示例服务

用法：
  goctl rpc new <span class="token punctuation">[</span>选项<span class="token punctuation">]</span>

选项：
      <span class="token parameter variable">--branch</span> string            远程仓库的分支，需要与 <span class="token parameter variable">--remote</span> 一起使用
  -d, <span class="token parameter variable">--desc</span>                     是否为拆分的 proto 文件创建 desc 文件夹
  ...
  -h, <span class="token parameter variable">--help</span>                     显示帮助信息
      ...
      <span class="token parameter variable">--idea</span>                     针对 idea 插件 <span class="token punctuation">[</span>可选<span class="token punctuation">]</span>
  -m, <span class="token parameter variable">--module_name</span> string       在 go.mod 中的模块名称，例如 github.com/suyuan32/simple-admin-core
  -p, <span class="token parameter variable">--port</span> int                 暴露的服务端口号 <span class="token punctuation">(</span>默认为 <span class="token number">9110</span><span class="token punctuation">)</span>
...
选项：
  ...
  -m, <span class="token parameter variable">--model</span> string               要生成的模型名称，例如 user，如果为空，则为 schema 目录中的所有模型生成代码
      <span class="token parameter variable">--multiple</span>                   以多个 RPC 服务模式生成
  ...
  -f, <span class="token parameter variable">--proto_field_style</span> string   proto 字段样式 <span class="token punctuation">(</span>默认为 <span class="token string">&quot;go_zero&quot;</span><span class="token punctuation">)</span>
  -t, <span class="token parameter variable">--proto_out</span> string           输出 proto 文件的路径
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>说明运行成功.</p>`,15),W={class:"hint-container warning"},K=n("p",{class:"hint-container-title"},"注意",-1),X={href:"https://github.com/suyuan32/simple-admin-member-rpc/blob/main/internal/logic/base/init_database_logic.go",target:"_blank",rel:"noopener noreferrer"},Y={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},Z=t(`<h2 id="simple-admin-example-api-中如何远程调用该-rpc" tabindex="-1"><a class="header-anchor" href="#simple-admin-example-api-中如何远程调用该-rpc" aria-hidden="true">#</a> simple admin example api 中如何远程调用该 RPC</h2><h3 id="添加-config" tabindex="-1"><a class="header-anchor" href="#添加-config" aria-hidden="true">#</a> 添加 config</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> config
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 logic 直接调用 l.svcCtx.ExampleRpc 即可</p>`,7),J={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function Q(nn,sn){const a=r("ExternalLinkIcon");return o(),c("div",null,[d,n("div",m,[v,k,b,n("p",null,[s("必须了解 go zero 的 RPC 命令 "),n("a",g,[s("RPC 命令"),e(a)]),s(),n("a",h,[s("RPC 服务"),e(a)]),_,s(" 参考 "),n("a",f,[s("Example"),e(a)]),s(" 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令")])]),n("div",y,[x,n("p",null,[n("a",w,[s("视频教程"),e(a)])])]),q,n("table",null,[C,n("tbody",null,[z,S,R,n("tr",null,[E,P,N,D,n("td",null,[s("需要到"),n("a",I,[s("go-zero"),e(a)]),s("查看最新 release")])]),n("tr",null,[B,A,L,M,n("td",null,[s("需要到"),n("a",T,[s("tool"),e(a)]),s("查看 simple admin tools 最新 release")])]),F,U,V])]),j,n("div",H,[G,n("p",null,[n("a",O,[s("示例代码"),e(a)])])]),$,n("div",W,[K,n("p",null,[s("后续还需要修改数据库初始化函数，参考 "),n("a",X,[s("simple admin member"),e(a)])])]),n("blockquote",null,[n("p",null,[s("项目地址 "),n("a",Y,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),Z,n("blockquote",null,[n("p",null,[s("simple admin example api 地址 "),n("a",J,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const tn=l(u,[["render",Q],["__file","rpc_example.html.vue"]]);export{tn as default};
