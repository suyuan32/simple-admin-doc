...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p>创建项目名称仅支持小写和驼峰命名, 项目名称不能包含 rpc 字符</p></div><h3 id="rpc-new参数介绍" tabindex="-1"><a class="header-anchor" href="#rpc-new参数介绍" aria-hidden="true">#</a> <code>rpc new</code>参数介绍</h3>`,11),z=n("thead",null,[n("tr",null,[n("th",null,"参数"),n("th",null,"必须"),n("th",null,"默认值"),n("th",null,"介绍"),n("th",null,"使用方法")])],-1),S=n("tr",null,[n("td",null,"ent"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否启用 ent"),n("td",null,"true 为启用")],-1),E=n("tr",null,[n("td",null,"module_name"),n("td",null,"否"),n("td"),n("td",null,"go.mod 中的 module 名称"),n("td",null,"如果项目需要被在外部 import，需要像上面例子设置为 github 或者其他地方的仓库网址， 为空则 module 为项目名称")],-1),R=n("tr",null,[n("td",null,"style"),n("td",null,"否"),n("td",null,"go_zero"),n("td",null,"文件名格式"),n("td",null,"go_zero 为蛇形格式")],-1),P=n("td",null,"go_zero_version",-1),N=n("td",null,"否",-1),D=n("td",null,"v1.5.2",-1),B=n("td",null,"go zero 版本",-1),I={href:"https://github.com/zeromicro/go-zero/releases",target:"_blank",rel:"noopener noreferrer"},A=n("td",null,"tool_version",-1),M=n("td",null,"否",-1),L=n("td",null,"v1.5.5",-1),F=n("td",null,"simple admin tools 版本号",-1),T={href:"https://github.com/suyuan32/simple-admin-tools/releases",target:"_blank",rel:"noopener noreferrer"},U=n("tr",null,[n("td",null,"gitlab"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否生成 gitlab-ci.yml"),n("td",null,"true 为生成")],-1),V=n("tr",null,[n("td",null,"port"),n("td",null,"否"),n("td",null,"9100"),n("td",null,"端口号"),n("td",null,"服务暴露的端口号")],-1),j=n("tr",null,[n("td",null,"desc"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否拆分 proto 文件到 desc 文件夹"),n("td",null,"true 会生成 desc 文件夹")],-1),H=n("tr",null,[n("td",null,"i18n"),n("td",null,"否"),n("td",null,"false"),n("td",null,"是否启用 i18n"),n("td",null,"true 为启用")],-1),G=t(`<p>** 详细参数请在命令行查看 <code>goctls rpc new --help</code> **</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctls rpc new <span class="token parameter variable">--help</span>
生成 rpc 演示服务
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 logic 直接调用 l.svcCtx.ExampleRpc 即可</p>`,7),nn={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function sn(an,en){const a=o("ExternalLinkIcon");return c(),r("div",null,[d,n("div",m,[v,k,b,n("p",null,[s("必须了解 go zero 的 RPC 命令 "),n("a",g,[s("RPC 命令"),e(a)]),s(),n("a",h,[s("RPC 服务"),e(a)]),_,f,s(" 参考 "),n("a",y,[s("Example"),e(a)]),s(" 项目生成一遍，确认生成文件与 Example 项目一致，Example 项目有完整的命令")])]),n("div",x,[w,n("p",null,[n("a",q,[s("视频教程"),e(a)])])]),C,n("table",null,[z,n("tbody",null,[S,E,R,n("tr",null,[P,N,D,B,n("td",null,[s("需要到"),n("a",I,[s("go-zero"),e(a)]),s("查看最新 release")])]),n("tr",null,[A,M,L,F,n("td",null,[s("需要到"),n("a",T,[s("tool"),e(a)]),s("查看 simple admin tools 最新 release")])]),U,V,j,H])]),G,n("div",O,[W,n("p",null,[n("a",$,[s("示例代码"),e(a)])])]),K,n("div",J,[Q,n("p",null,[s("后续还需要修改数据库初始化函数，参考 "),n("a",X,[s("simple admin member"),e(a)])])]),n("blockquote",null,[n("p",null,[s("项目地址 "),n("a",Y,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),Z,n("blockquote",null,[n("p",null,[s("simple admin example api 地址 "),n("a",nn,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const on=i(u,[["render",sn],["__file","rpc_example.html.vue"]]);export{on as default};
