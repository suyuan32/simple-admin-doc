import{_ as i,a as o}from"./ent_gen_logic-QVeuvCRp.js";import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o as c,c as r,a as n,f as s,b as e,e as t}from"./app-kx6oLyAU.js";const d={},u={class:"hint-container warning"},m=n("p",{class:"hint-container-title"},"Warning",-1),v=n("p",null,"Make sure that you have been installed follow software:",-1),k=n("ul",null,[n("li",null,"simple-admin-tool (goctls) v1.5.5 +")],-1),b=n("br",null,null,-1),h={href:"https://go-zero.dev/docs/goctl/zrpc/#%E6%96%B9%E5%BC%8F%E4%BA%8C%E9%80%9A%E8%BF%87%E6%8C%87%E5%AE%9Aproto%E7%94%9F%E6%88%90rpc%E6%9C%8D%E5%8A%A1",target:"_blank",rel:"noopener noreferrer"},g={href:"https://go-zero.dev/docs/advance/rpc-call",target:"_blank",rel:"noopener noreferrer"},f=n("br",null,null,-1),y=n("br",null,null,-1),_={href:"https://github.com/suyuan32/simple-admin-example-rpc",target:"_blank",rel:"noopener noreferrer"},x=n("h2",{id:"rpc-responsibilities",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#rpc-responsibilities","aria-hidden":"true"},"#"),s(" RPC Responsibilities")],-1),w=n("p",null,"In Simple Admin, RPC is mainly used to obtain data and provide extended functions. It mainly has the following responsibilities:",-1),q=n("ul",null,[n("li",null,"Interact with the database to obtain the required data, such as PostgreSql"),n("li",null,"Interact with data sources to obtain data, such as ES"),n("li",null,"Provide additional functions for API layer calls, such as sending text messages and emails")],-1),C=n("p",null,"Multiple different APIs can access the same RPC to call its functions.",-1),E={class:"hint-container info"},S=n("p",{class:"hint-container-title"},"Info",-1),R={href:"https://youtu.be/Yv7d2EKy9ZE",target:"_blank",rel:"noopener noreferrer"},T=t(`<h2 id="create-rpc-project" tabindex="-1"><a class="header-anchor" href="#create-rpc-project" aria-hidden="true">#</a> Create RPC project</h2><blockquote><p>Create example project</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls rpc new example <span class="token parameter variable">--ent</span><span class="token operator">=</span>true <span class="token parameter variable">--module_name</span><span class="token operator">=</span>github.com/suyuan32/simple-admin-example-rpc <span class="token parameter variable">--port</span><span class="token operator">=</span><span class="token number">8080</span> <span class="token parameter variable">--desc</span><span class="token operator">=</span>true
...
<span class="token keyword">func</span> <span class="token function">NewServiceContext</span><span class="token punctuation">(</span>c config<span class="token punctuation">.</span>Config<span class="token punctuation">)</span> <span class="token operator">*</span>ServiceContext <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p><strong>And then you can call in via l.svcCtx.ExampleRpc in logic code.</strong></p></blockquote>`,7),A={href:"https://github.com/suyuan32/simple-admin-example-api",target:"_blank",rel:"noopener noreferrer"};function U(W,B){const a=l("ExternalLinkIcon");return c(),r("div",null,[n("div",u,[m,v,k,n("p",null,[b,s(" Must know go-zero's RPC command. "),n("a",h,[s("RPC Command"),e(a)]),s(),n("a",g,[s("RPC Service"),e(a)]),s(),f,y,s(" Refer to the "),n("a",_,[s("Example"),e(a)]),s(" project to generate it again, confirm that the generated file is consistent with the Example project, and the Example project has complete commands.")])]),x,w,q,C,n("div",E,[S,n("p",null,[n("a",R,[s("Video Tutorial"),e(a)])])]),T,n("div",z,[I,n("p",null,[n("a",N,[s("Example Code"),e(a)])])]),P,n("p",null,[s("That means the codes run successfully, you need to finish the database initialization like: "),n("a",j,[s("simple admin file"),e(a)])]),n("blockquote",null,[n("p",null,[s("Project URL "),n("a",D,[s("https://github.com/suyuan32/simple-admin-example-rpc"),e(a)])])]),M,n("blockquote",null,[n("p",null,[s("simple admin example api "),n("a",A,[s("https://github.com/suyuan32/simple-admin-example-api"),e(a)])])])])}const G=p(d,[["render",U],["__file","rpc_example.html.vue"]]);export{G as default};
