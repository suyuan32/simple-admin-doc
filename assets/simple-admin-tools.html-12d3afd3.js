import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as r,c,a as e,b as n,d as a,w as p,e as t}from"./app-91f241b2.js";const d={},u=t('<h1 id="simple-admin-tools" tabindex="-1"><a class="header-anchor" href="#simple-admin-tools" aria-hidden="true">#</a> Simple admin tools</h1><p>Simple admin tools is a tool fork from go-zero.<br> It provides more addition features than origin project such as:</p><ul><li>go-swagger : it is different with origin which uses @doc comments</li><li>multi-language support</li><li>optimize error message</li><li>fully support validator and easy to use</li><li>code auto generation for API, RPC and web</li><li>error handling which support multi-languages</li><li>so on</li></ul><div class="hint-container warning"><p class="hint-container-title">Note</p><p>Due to the rapid iteration of the current version, if there is a problem with code generation, please run <code>git pull</code> to download the latest code and recompile.<br> If there are still problems, please submit an issue.</p></div>',4),m={class:"hint-container info"},v=e("p",{class:"hint-container-title"},"Info",-1),b={href:"https://youtu.be/9AtGgMjBlWU",target:"_blank",rel:"noopener noreferrer"},h=e("p",null,[n("It is a little complex to install the "),e("code",null,"goctls"),n(" due to forking project."),e("br"),n(" Let me show you how to build the code by yourself.")],-1),k=e("blockquote",null,[e("p",null,"Build goctls")],-1),g={class:"hint-container warning"},f=e("p",{class:"hint-container-title"},"Note",-1),_=e("code",null,"Windows",-1),w={href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},y=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-tools.git
