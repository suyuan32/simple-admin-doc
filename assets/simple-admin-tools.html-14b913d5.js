...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>It is easy right?</p>`,7),d={href:"http://build.sh",target:"_blank",rel:"noopener noreferrer"},u=a(`<blockquote><p>How to use it?</p></blockquote><blockquote><p>Auto fix all dependencies command</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>goctls <span class="token function">env</span> check <span class="token parameter variable">-i</span> <span class="token parameter variable">-f</span> <span class="token parameter variable">--verbose</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Run this command can auto install protoc and so on.</p><blockquote><p>API command</p></blockquote><p>The command is the same as goctl but you should use goctls instead.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctl api <span class="token parameter variable">-h</span>
NAME:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>This means generating go files by core.api&#39;s declaration in current directory. -dir set the output path.</p><blockquote><p>Rpc command</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ goctl rpc protoc <span class="token parameter variable">-h</span>
NAME:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,17),m={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},v=a(`<blockquote><p>Project go.mod setting</p></blockquote><p>We know that if we want to import fork project we should use replace command.</p><div class="language-mod line-numbers-mode" data-ext="mod"><pre class="language-mod"><code>module github.com/suyuan32/simple-admin-core
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>It can help you to add replace code but it cannot run multiple times because it will add multiple replace lines in the go.mod file. You can just edit go.mod file can modify the simple-admin-tools version manually and run <strong>go mod tidy</strong>.</p></blockquote>`,6);function b(g,k){const s=r("ExternalLinkIcon");return o(),l("div",null,[p,e("blockquote",null,[e("p",null,[n("Now you can just run "),e("strong",null,[n("sh "),e("a",d,[n("build.sh"),i(s)])]),n(" in goctl directory")])]),u,e("p",null,[e("a",m,[n("More"),i(s)])]),v])}const f=t(c,[["render",b],["__file","simple-admin-tools.html.vue"]]);export{f as default};
