import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o,c as r,a,f as n,b as e,e as i}from"./app-Yp96lp0u.js";const p={},c=i(`<h1 id="goctls" tabindex="-1"><a class="header-anchor" href="#goctls" aria-hidden="true">#</a> Goctls</h1><p>Goctls 是一个为 simple admin 设计的代码生成工具, 基于 go zero 官方工具 goctl 开发而成。 它提供了许多额外的功能，例如:</p><ul><li>go-swagger : 基于 go-swagger 而不是官方的@doc 注解</li><li>多国语言支持</li><li>优化错误信息处理,支持多语言错误</li><li>简单易用的校验器</li><li>支持代码生成，生成 API,RPC 和 web 端的 CRUD 代码</li><li>对 Simple Admin 的针对性优化</li></ul><div class="hint-container warning"><p class="hint-container-title">注意</p><p>现已支持中文，只需要设置环境变量 SIMPLE_LANG=zh 即可</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token assign-left variable">SIMPLE_LANG</span><span class="token operator">=</span>zh goctls <span class="token parameter variable">-h</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,17),g={class:"hint-container info"},h=a("p",{class:"hint-container-title"},"相关信息",-1),k={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},_=a("div",{class:"hint-container warning"},[a("p",{class:"hint-container-title"},"注意"),a("p",null,[n("我们提供了 "),a("code",null,"make gen-rpc"),n(" 和 "),a("code",null,"make gen-api"),n(" 用于快速生成官方代码")])],-1);function f(x,q){const s=t("ExternalLinkIcon");return o(),r("div",null,[c,a("div",d,[u,a("p",null,[a("a",v,[n("教学视频"),e(s)])])]),a("p",null,[n("从 v1.5.14 开始，工具已移至新的仓库，便于快速迭代更新 "),a("a",m,[n("仓库地址"),e(s)]),n(", 目前已支持直接命令安装，不再需要 clone 代码")]),b,a("div",g,[h,a("p",null,[n("可以访问官网查看更多 "),a("a",k,[n("RPC command"),e(s)])])]),_])}const R=l(p,[["render",f],["__file","simple-admin-tools.html.vue"]]);export{R as default};
