...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>It can help you to add replace code but it cannot run multiple times because it will add multiple replace lines in the go.mod file. You can just edit go.mod file can modify the simple-admin-tools version manually and run <strong>go mod tidy</strong>.</p></blockquote><blockquote><p>Both API and RPC of the new version support directly setting the tool version for replacement when creating a new one</p></blockquote>`,7);function b(g,h){const s=r("ExternalLinkIcon");return t(),l("div",null,[p,e("blockquote",null,[e("p",null,[a("Now you can just run "),e("strong",null,[a("sh "),e("a",d,[a("build.sh"),i(s)])]),a(" in goctl directory")])]),u,e("p",null,[e("a",m,[a("More"),i(s)])]),v])}const f=o(c,[["render",b],["__file","simple-admin-tools.html.vue"]]);export{f as default};
