import{_ as l,W as r,X as c,Y as e,Z as n,$ as a,a1 as p,a0 as t,D as i}from"./framework-2d2f73c4.js";const d={},u=t('<h1 id="simple-admin-tools" tabindex="-1"><a class="header-anchor" href="#simple-admin-tools" aria-hidden="true">#</a> Simple admin tools</h1><p>Simple admin tools is a tool fork from go-zero. It provides more addition features than origin project such as:</p><ul><li>go-swagger : it is different with origin which uses @doc comments</li><li>multi-language support</li><li>optimize error message</li><li>fully support validator and easy to use</li><li>code auto generation for API, RPC and web</li><li>error handling which support multi-languages</li><li>so on</li></ul><div class="hint-container warning"><p class="hint-container-title">Note</p><p>Due to the rapid iteration of the current version, if there is a problem with code generation, please run <code>git pull</code> to download the latest code and recompile. If there are still problems, please submit an issue.</p></div><p>It is a little complex to install the <code>goctls</code> due to forking project. Let me show you how to build the code by yourself.</p><blockquote><p>Build goctls</p></blockquote>',6),m={class:"hint-container warning"},v=e("p",{class:"hint-container-title"},"Note",-1),b=e("code",null,"Windows",-1),h={href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},k=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-tools.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,17),g={class:"hint-container info"},f=e("p",{class:"hint-container-title"},"Info",-1),w={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},_=e("div",{class:"hint-container warning"},[e("p",{class:"hint-container-title"},"Note"),e("p",null,[n("We provide "),e("code",null,"make gen-rpc"),n(" and "),e("code",null,"make gen-api"),n(" for quick generation of official code")])],-1);function y(x,q){const s=i("ExternalLinkIcon"),o=i("RouterLink");return r(),c("div",null,[u,e("div",m,[v,e("p",null,[e("strong",null,[b,n(" users are recommended to develop in the "),e("a",h,[n("WSL"),a(s)]),n(" environment, you can also cofigure the environment via "),a(o,{to:"/guide/FAQ.html#how-to-configure-the-windows-environment"},{default:p(()=>[n("Windows")]),_:1}),n(".")])])]),k,e("div",g,[f,e("p",null,[n("You can get "),e("a",w,[n("More Document"),a(s)]),n(" on go zero official website.")])]),_])}const N=l(d,[["render",y],["__file","simple-admin-tools.html.vue"]]);export{N as default};
