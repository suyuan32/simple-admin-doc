...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,19),v={class:"hint-container info"},m=a("p",{class:"hint-container-title"},"相关信息",-1),b={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},h=a("div",{class:"hint-container warning"},[a("p",{class:"hint-container-title"},"注意"),a("p",null,[e("我们提供了 "),a("code",null,"make gen-rpc"),e(" 和 "),a("code",null,"make gen-api"),e(" 用于快速生成官方代码")])],-1);function k(g,f){const n=l("ExternalLinkIcon");return o(),r("div",null,[c,a("p",null,[e("从 v1.5.14 开始，工具已移至新的仓库，便于快速迭代更新 "),a("a",d,[e("仓库地址"),s(n)]),e(", 目前已支持直接命令安装，不再需要 clone 代码")]),u,a("div",v,[m,a("p",null,[e("可以访问官网查看更多 "),a("a",b,[e("RPC command"),s(n)])])]),h])}const w=t(p,[["render",k],["__file","simple-admin-tools.html.vue"]]);export{w as default};
