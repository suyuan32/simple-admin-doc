import{_ as t,W as o,X as l,Y as e,Z as a,$ as s,a0 as i,D as r}from"./framework-2d2f73c4.js";const c={},p=i(`<h1 id="simple-admin-tools" tabindex="-1"><a class="header-anchor" href="#simple-admin-tools" aria-hidden="true">#</a> Simple admin tools</h1><p>Simple admin tools is a tool fork from go-zero. It provides more addition features than origin project such as:</p><ul><li>go-swagger : it is different with origin which uses @doc comments</li><li>multi-language support</li><li>optimize error message</li><li>fully support validator and easy to use</li><li>code auto generation for API, RPC and web</li><li>error handling which support multi-languages</li><li>so on</li></ul><div class="hint-container warning"><p class="hint-container-title">Note</p><p>Due to the rapid iteration of the current version, if there is a problem with code generation, please run <code>git pull</code> to download the latest code and recompile. If there are still problems, please submit an issue.</p></div><p>It is a little complex to install the <code>goctls</code> due to forking project. Let me show you how to build the code by yourself.</p><blockquote><p>Build goctls</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-tools.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,16),f={class:"hint-container info"},_=e("p",{class:"hint-container-title"},"Info",-1),y={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},w=e("div",{class:"hint-container warning"},[e("p",{class:"hint-container-title"},"Note"),e("p",null,[a("We provide "),e("code",null,"make gen-rpc"),a(" and "),e("code",null,"make gen-api"),a(" for quick generation of official code")])],-1);function x(q,z){const n=r("ExternalLinkIcon");return o(),l("div",null,[p,e("div",d,[u,e("p",null,[m,a(" users can just run "),e("strong",null,[a("sh "),e("a",v,[a("build.sh"),s(n)])]),a(" in goctl directory. "),b,a(" users should run "),h,a(" in "),k,a(".")])]),g,e("div",f,[_,e("p",null,[a("You can get "),e("a",y,[a("More Document"),s(n)]),a(" on go zero official website.")])]),w])}const N=t(c,[["render",x],["__file","simple-admin-tools.html.vue"]]);export{N as default};
