import{_ as t,W as o,X as l,Y as a,Z as e,$ as s,a0 as i,D as r}from"./framework-2d2f73c4.js";const c={},p=i(`<h1 id="simple-admin-tools" tabindex="-1"><a class="header-anchor" href="#simple-admin-tools" aria-hidden="true">#</a> Simple admin tools</h1><p>Simple admin tools is a tool fork from go-zero. It provides more addition features than origin project such as:</p><ul><li>go-swagger : it is different with origin which uses @doc comments</li><li>multi-language support</li><li>optimize error message</li><li>fully support validator and easy to use</li><li>code auto generation for API, RPC and web</li><li>error handling which support multi-languages</li><li>several plugins such as RocketMQ, GORM</li><li>so on</li></ul><div class="hint-container warning"><p class="hint-container-title">Note</p><p>Due to the rapid iteration of the current version, if there is a problem with code generation, please run <code>git pull</code> to download the latest code and recompile. If there are still problems, please submit an issue.</p></div><p>It is a little complex to install the <code>goctls</code> due to forking project. Let me show you how to build the code by yourself.</p><blockquote><p>Build goctls</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-tools.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,16),b={class:"hint-container info"},h=a("p",{class:"hint-container-title"},"Info",-1),k={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},g=a("div",{class:"hint-container warning"},[a("p",{class:"hint-container-title"},"Note"),a("p",null,[e("We provide "),a("code",null,"make gen-rpc"),e(" and "),a("code",null,"make gen-api"),e(" for quick generation of official code")])],-1);function f(_,y){const n=r("ExternalLinkIcon");return o(),l("div",null,[p,a("div",d,[u,a("p",null,[e("You can just run "),a("strong",null,[e("sh "),a("a",m,[e("build.sh"),s(n)])]),e(" in goctl directory")])]),v,a("div",b,[h,a("p",null,[e("You can get "),a("a",k,[e("More Document"),s(n)]),e(" on go zero official website.")])]),g])}const x=t(c,[["render",f],["__file","simple-admin-tools.html.vue"]]);export{x as default};
