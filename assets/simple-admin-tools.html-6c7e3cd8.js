import{_ as o,W as r,X as p,Y as n,Z as a,$ as s,a1 as c,a0 as t,D as i}from"./framework-2d2f73c4.js";const d={},u=t('<h1 id="simple-admin-tools" tabindex="-1"><a class="header-anchor" href="#simple-admin-tools" aria-hidden="true">#</a> Simple admin tools</h1><p>Simple admin tools 是一个基于 go-zero 的 fork 项目。 它提供了许多额外的功能，例如:</p><ul><li>go-swagger : 基于 go-swagger 而不是官方的@doc 注解</li><li>多国语言支持</li><li>优化错误信息处理,支持多语言错误</li><li>简单易用的校验器</li><li>支持代码生成，生成 API,RPC 和 web 端的 CRUD 代码</li><li>对 Simple Admin 的针对性优化</li></ul><p>由于本工具是 fork 项目，因此使用 goctls 会有些麻烦. 使用 fork 主要是为了同步官方最新代码。</p><div class="hint-container warning"><p class="hint-container-title">注意</p><p>由于目前版本迭代较快，如果代码生成出现问题，请先 <code>git pull</code> 下载最新代码重新编译，如果还有问题，欢迎提交 issue</p></div><p>我们不能直接使用 go get and go install 命令安装 goctl 因为他会安装官方的文件，我们需要自行编译。</p><p>下面是构建 goctls 的过程.</p><blockquote><p>构建 goctls</p></blockquote>',8),v={class:"hint-container warning"},m=n("p",{class:"hint-container-title"},"注意",-1),b=n("code",null,"Windows",-1),k={href:"https://learn.microsoft.com/en-us/windows/wsl/install",target:"_blank",rel:"noopener noreferrer"},h=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/suyuan32/simple-admin-tools.git
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,18),g={class:"hint-container info"},f=n("p",{class:"hint-container-title"},"相关信息",-1),_={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},w=n("div",{class:"hint-container warning"},[n("p",{class:"hint-container-title"},"注意"),n("p",null,[a("我们提供了 "),n("code",null,"make gen-rpc"),a(" 和 "),n("code",null,"make gen-api"),a(" 用于快速生成官方代码")])],-1);function y(x,q){const e=i("ExternalLinkIcon"),l=i("RouterLink");return r(),p("div",null,[u,n("div",v,[m,n("p",null,[n("strong",null,[b,a(" 用户建议在 "),n("a",k,[a("WSL"),s(e)]),a(" 环境下开发, 你也可以自行配置环境， 参考 "),s(l,{to:"/zh/guide/FAQ.html#%E5%A6%82%E4%BD%95%E9%85%8D%E7%BD%AE-windows-%E7%8E%AF%E5%A2%83"},{default:c(()=>[a("Windows")]),_:1})])])]),h,n("div",g,[f,n("p",null,[a("可以访问官网查看更多 "),n("a",_,[a("RPC command"),s(e)])])]),w])}const z=o(d,[["render",y],["__file","simple-admin-tools.html.vue"]]);export{z as default};
