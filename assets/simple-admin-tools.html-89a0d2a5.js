...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>It can help you to add replace code but it cannot run multiple times because it will add multiple replace lines in the go.mod file. You can just edit go.mod file can modify the simple-admin-tools version manually and run <strong>go mod tidy</strong>.</p></blockquote><blockquote><p>Both API and RPC of the new version support directly setting the tool version for replacement when creating a new one</p></blockquote>`,7);function f(y,w){const s=r("ExternalLinkIcon");return o(),l("div",null,[p,e("div",d,[u,e("p",null,[n("You can just run "),e("strong",null,[n("sh "),e("a",m,[n("build.sh"),i(s)])]),n(" in goctl directory")])]),v,e("div",b,[g,e("p",null,[n("You can get "),e("a",h,[n("More Document"),i(s)]),n(" on go zero official website.")])]),k])}const x=t(c,[["render",f],["__file","simple-admin-tools.html.vue"]]);export{x as default};
