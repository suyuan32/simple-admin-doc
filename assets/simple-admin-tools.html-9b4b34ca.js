...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,17),m={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},v=n(`<blockquote><p>Project go.mod setting</p></blockquote><p>We know that if we want to import fork project we should use replace command.</p><div class="language-mod line-numbers-mode" data-ext="mod"><pre class="language-mod"><code>module github.com/suyuan32/simple-admin-core
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>It can help you to add replace code but it cannot run multiple times because it will add multiple replace lines in the go.mod file. You can just edit go.mod file can modify the simple-admin-tools version manually and run <strong>go mod tidy</strong>.</p></blockquote><blockquote><p>Both API and RPC of the new version support directly setting the tool version for replacement when creating a new one</p></blockquote>`,7);function b(g,h){const s=r("ExternalLinkIcon");return o(),l("div",null,[p,e("blockquote",null,[e("p",null,[a("Now you can just run "),e("strong",null,[a("sh "),e("a",d,[a("build.sh"),i(s)])]),a(" in goctl directory")])]),u,e("p",null,[e("a",m,[a("More"),i(s)])]),v])}const f=t(c,[["render",b],["__file","simple-admin-tools.html.vue"]]);export{f as default};
