...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,26),d={class:"hint-container info"},u=a("p",{class:"hint-container-title"},"相关信息",-1),v={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},m=n(`<blockquote><p>go.mod 配置</p></blockquote><p>导入fork项目需要使用 replace 命令。</p><div class="language-mod line-numbers-mode" data-ext="mod"><pre class="language-mod"><code>module github.com/suyuan32/simple-admin-core
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>这个命令可以快速添加 replace 语句， 但是不要运行多次， 会导致添加重复和 replace, 后续需要升级依赖的话直接修改 simple-admin-tools 的版本即可，然后 <strong>go mod tidy</strong>.</p></blockquote><blockquote><p>新版本API和RPC均支持新建时直接设置tool版本进行replace</p></blockquote>`,7);function b(g,k){const s=r("ExternalLinkIcon");return l(),o("div",null,[p,a("div",d,[u,a("p",null,[e("可以访问官网查看更多 "),a("a",v,[e("RPC command"),t(s)])])]),m])}const f=i(c,[["render",b],["__file","simple-admin-tools.html.vue"]]);export{f as default};
