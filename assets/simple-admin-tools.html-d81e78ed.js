...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,18),q={class:"hint-container info"},E=n("p",{class:"hint-container-title"},"相关信息",-1),z={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},A=n("div",{class:"hint-container warning"},[n("p",{class:"hint-container-title"},"注意"),n("p",null,[a("我们提供了 "),n("code",null,"make gen-rpc"),a(" 和 "),n("code",null,"make gen-api"),a(" 用于快速生成官方代码")])],-1);function R(S,N){const e=i("ExternalLinkIcon"),l=i("RouterLink");return r(),c("div",null,[u,n("div",v,[m,n("p",null,[n("a",b,[a("教学视频"),s(e)])])]),k,h,g,n("div",f,[_,n("p",null,[n("strong",null,[w,a(" 用户建议在 "),n("a",y,[a("WSL"),s(e)]),a(" 环境下开发, 你也可以自行配置环境， 参考 "),s(l,{to:"/zh/guide/FAQ.html#%E5%A6%82%E4%BD%95%E9%85%8D%E7%BD%AE-windows-%E7%8E%AF%E5%A2%83"},{default:p(()=>[a("Windows")]),_:1})])])]),x,n("div",q,[E,n("p",null,[a("可以访问官网查看更多 "),n("a",z,[a("RPC command"),s(e)])])]),A])}const P=o(d,[["render",R],["__file","simple-admin-tools.html.vue"]]);export{P as default};
