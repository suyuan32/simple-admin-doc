...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,23),d={class:"hint-container info"},u=a("p",{class:"hint-container-title"},"Info",-1),m={href:"https://go-zero.dev/docs/goctl/zrpc",target:"_blank",rel:"noopener noreferrer"},v=a("div",{class:"hint-container warning"},[a("p",{class:"hint-container-title"},"Note"),a("p",null,[e("We provide "),a("code",null,"make gen-rpc"),e(" and "),a("code",null,"make gen-api"),e(" for quick generation of official code")])],-1);function b(k,h){const n=r("ExternalLinkIcon");return i(),t("div",null,[c,a("div",d,[u,a("p",null,[e("You can get "),a("a",m,[e("More Document"),o(n)]),e(" on go zero official website.")])]),v])}const f=s(p,[["render",b],["__file","simple-admin-tools.html.vue"]]);export{f as default};
