import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o,c as r,a,f as n,b as e,e as i}from"./app-FG98sd9J.js";const p={},c=i(`<p>Goctls 是一个为 simple admin 设计的代码生成工具, 基于 go zero 官方工具 goctl 开发而成。 它提供了许多额外的功能，例如:</p><ul><li>go-swagger : 基于 go-swagger 而不是官方的@doc 注解</li><li>多国语言支持</li><li>优化错误信息处理,支持多语言错误</li><li>简单易用的校验器</li><li>支持代码生成，生成 API,RPC 和 web 端的 CRUD 代码</li><li>对 Simple Admin 的针对性优化</li></ul><div class="hint-container warning"><p class="hint-container-title">注意</p><p>现已支持中文，只需要设置环境变量 SIMPLE_LANG=zh 即可</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token assign-left variable">SIMPLE_LANG</span><span class="token operator">=</span>zh goctls <span class="token parameter variable">-h</span>
