...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 <code>goctls v0.3.2-beta</code> 已支持 prefix 设置路由前缀，只需设置 <code>prefix</code> ，并重新生成 <code>handler</code> 即可</p><h2 id="go-swagger-报错" tabindex="-1"><a class="header-anchor" href="#go-swagger-报错" aria-hidden="true">#</a> go swagger 报错</h2><p>安装最新版 go-swagger</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>go <span class="token function">install</span> github.com/go-swagger/go-swagger/cmd/swagger@latest
