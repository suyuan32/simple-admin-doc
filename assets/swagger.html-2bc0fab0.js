import{_ as t,a as i,b as o}from"./swagger_authority-0a365dc3.js";import{ab as p,F as l,G as c,E as n,R as s,M as e,ac as r,U as u}from"./framework-5ae10408.js";const d={},m=n("h2",{id:"使用swagger",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#使用swagger","aria-hidden":"true"},"#"),s(" 使用swagger")],-1),v=n("blockquote",null,[n("p",null,"环境配置")],-1),k={href:"https://zhuanlan.zhihu.com/p/556171256?",target:"_blank",rel:"noopener noreferrer"},b={href:"https://goswagger.io/use/spec/meta.html",target:"_blank",rel:"noopener noreferrer"},g=r(`<blockquote><p>在项目根目录运行 simple-admin-core/</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>swagger generate spec <span class="token parameter variable">--output</span><span class="token operator">=</span>./core.yml --scan-models
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+t+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>获取 Token</p><p>先登录系统，在任意请求中复制 authorization</p></blockquote><figure><img src="'+i+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>粘贴到 swagger</p></blockquote><figure><img src="'+o+`" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>注解规范</p></blockquote><p>通常对于请求参数我们使用 Req 即 Request 的缩写， 返回值 Resp 即 Response 的缩写</p><h4 id="如果你声明的类型后缀有-req-和-info-你可以忽略-swagger-model-的声明-系统自动添加-swagger-model-注解。" tabindex="-1"><a class="header-anchor" href="#如果你声明的类型后缀有-req-和-info-你可以忽略-swagger-model-的声明-系统自动添加-swagger-model-注解。" aria-hidden="true">#</a> 如果你声明的类型后缀有 &quot;Req&quot; 和 &quot;Info&quot;, 你可以忽略 swagger:model 的声明. 系统自动添加 swagger:model 注解。</h4><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> <span class="token punctuation">(</span>
