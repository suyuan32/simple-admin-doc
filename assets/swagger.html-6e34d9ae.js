...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,33);function P(w,x){const a=d("ExternalLinkIcon");return l(),c("div",null,[m,n("div",v,[k,n("blockquote",null,[n("p",null,[n("a",g,[s("官方文档"),e(a)])])]),n("p",null,[n("a",b,[s("示例项目"),e(a)]),s(),n("a",h,[s("Path 和 Query 请求例子"),e(a)])])]),n("div",q,[f,n("p",null,[n("a",A,[s("视频教程"),e(a)])])]),I])}const j=p(u,[["render",P],["__file","swagger.html.vue"]]);export{j as default};
