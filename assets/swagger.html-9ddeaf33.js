import{_ as t,a as i,b as o}from"./swagger_authority-f5f7790d.js";import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as c,c as r,a as n,b as s,d as e,e as d}from"./app-67bc5014.js";const u={},m=n("h2",{id:"use-swagger",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#use-swagger","aria-hidden":"true"},"#"),s(" Use swagger")],-1),v={class:"hint-container info"},k=n("p",{class:"hint-container-title"},"Info",-1),g={href:"https://goswagger.io/use/spec/meta.html",target:"_blank",rel:"noopener noreferrer"},b={href:"https://github.com/suyuan32/simple-admin-example-features/tree/main/swagger",target:"_blank",rel:"noopener noreferrer"},h=d(`<div class="hint-container warning"><p class="hint-container-title">Note</p><p><code>goctls</code> already supports to directly generate <code>swagger path</code> based on <code>go zero path</code>, <code>goctls</code> requires <code>v0.3.0+</code><code>goctls</code> already supports to directly generate <code>swagger</code> validation rules based on <code>validate</code>, <code>goctls</code> requires <code>v0.3.1+</code></p></div><blockquote><p>In the root of project run simple-admin-core/</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>swagger generate spec <span class="token parameter variable">--output</span><span class="token operator">=</span>./core.yml --scan-models
