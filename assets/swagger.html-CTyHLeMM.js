import{_ as a,a as t,b as i}from"./swagger_authority-8B5UJFxY.js";import{_ as o}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as p,c as l,d as n,e as r,b as s,o as c}from"./app-SeIJRtVB.js";const u={},d=s('<h2 id="use-swagger" tabindex="-1"><a class="header-anchor" href="#use-swagger"><span>Use swagger</span></a></h2><div class="hint-container info"><p class="hint-container-title">Info</p><blockquote><p><a href="https://goswagger.io/use/spec/meta.html" target="_blank" rel="noopener noreferrer">Official Documentation</a></p></blockquote><p><a href="https://github.com/suyuan32/simple-admin-example-features/tree/main/swagger" target="_blank" rel="noopener noreferrer">Sample project</a> [Path and Query request example](https://github.com/suyuan32/simple-admin -example-features/blob/main/swagger/desc/base.api)</p></div><div class="hint-container warning"><p class="hint-container-title">Warning</p><p><code>goctls</code> already supports to directly generate <code>swagger path</code> based on <code>go zero path</code>, <code>goctls</code> requires <code>v0.3.0+</code><code>goctls</code> already supports to directly generate <code>swagger</code> validation rules based on <code>validate</code>, <code>goctls</code> requires <code>v0.3.1+</code></p></div>',3),m={class:"hint-container info"},g=n("p",{class:"hint-container-title"},"Video Tutorial",-1),v=s(`<blockquote><p>In the root of project run simple-admin-core/</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>swagger generate spec <span class="token parameter variable">--output</span><span class="token operator">=</span>./core.yml --scan-models
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+a+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><h3 id="get-token" tabindex="-1"><a class="header-anchor" href="#get-token"><span>Get Token</span></a></h3><blockquote><p>Firstly, log in the system and press F12 to get authorization from any request</p></blockquote><figure><img src="'+t+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>Copy to swagger</p></blockquote><figure><img src="'+i+`" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><h3 id="comment-example" tabindex="-1"><a class="header-anchor" href="#comment-example"><span>Comment Example</span></a></h3><p>We use normally use Req suffix to represent Request， Resp to represent Response.</p><h4 id="if-the-type-name-has-suffix-req-and-info-you-can-omit-the-swagger-model-type-declaration" tabindex="-1"><a class="header-anchor" href="#if-the-type-name-has-suffix-req-and-info-you-can-omit-the-swagger-model-type-declaration"><span>If the type name has suffix &quot;Req&quot; and &quot;Info&quot;, you can omit the swagger model type declaration</span></a></h4><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">type</span> <span class="token punctuation">(</span>
