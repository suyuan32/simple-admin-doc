import{_ as p,a as l,b as r}from"./swagger_authority-8B5UJFxY.js";import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as u,c as d,a as n,f as s,b as e,e as i}from"./app-CK-zxo63.js";const m={},g=n("h2",{id:"use-swagger",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#use-swagger"},[n("span",null,"Use swagger")])],-1),v={class:"hint-container info"},k=n("p",{class:"hint-container-title"},"Info",-1),b={href:"https://goswagger.io/use/spec/meta.html",target:"_blank",rel:"noopener noreferrer"},h={href:"https://github.com/suyuan32/simple-admin-example-features/tree/main/swagger",target:"_blank",rel:"noopener noreferrer"},f=i('<div class="hint-container warning"><p class="hint-container-title">Warning</p><p><code>goctls</code> already supports to directly generate <code>swagger path</code> based on <code>go zero path</code>, <code>goctls</code> requires <code>v0.3.0+</code><code>goctls</code> already supports to directly generate <code>swagger</code> validation rules based on <code>validate</code>, <code>goctls</code> requires <code>v0.3.1+</code></p></div>',1),y={class:"hint-container info"},q=n("p",{class:"hint-container-title"},"Video Tutorial",-1),w=i(`<blockquote><p>In the root of project run simple-admin-core/</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>swagger generate spec <span class="token parameter variable">--output</span><span class="token operator">=</span>./core.yml --scan-models
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+p+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><h3 id="get-token" tabindex="-1"><a class="header-anchor" href="#get-token"><span>Get Token</span></a></h3><blockquote><p>Firstly, log in the system and press F12 to get authorization from any request</p></blockquote><figure><img src="'+l+'" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><blockquote><p>Copy to swagger</p></blockquote><figure><img src="'+r+`" alt="pic" tabindex="0" loading="lazy"><figcaption>pic</figcaption></figure><h3 id="comment-example" tabindex="-1"><a class="header-anchor" href="#comment-example"><span>Comment Example</span></a></h3><p>We use normally use Req suffix to represent Request， Resp to represent Response.</p><h4 id="if-the-type-name-has-suffix-req-and-info-you-can-omit-the-swagger-model-type-declaration" tabindex="-1"><a class="header-anchor" href="#if-the-type-name-has-suffix-req-and-info-you-can-omit-the-swagger-model-type-declaration"><span>If the type name has suffix &quot;Req&quot; and &quot;Info&quot;, you can omit the swagger model type declaration</span></a></h4><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">type</span> <span class="token punctuation">(</span>
