import{_ as o,a as p,b as l}from"./swagger_authority-8B5UJFxY.js";import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as r,c as d,a as n,f as s,b as a,e as u}from"./app-iw6MeW5y.js";const m={},g=n("h2",{id:"使用-swagger-生成-api-文档",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#使用-swagger-生成-api-文档"},[n("span",null,"使用 swagger 生成 API 文档")])],-1),v={class:"hint-container info"},k=n("p",{class:"hint-container-title"},"相关信息",-1),b={href:"https://goswagger.io/use/spec/meta.html",target:"_blank",rel:"noopener noreferrer"},h={href:"https://github.com/suyuan32/simple-admin-example-features/tree/main/swagger",target:"_blank",rel:"noopener noreferrer"},f={href:"https://github.com/suyuan32/simple-admin-example-features/blob/main/swagger/desc/base.api",target:"_blank",rel:"noopener noreferrer"},q={class:"hint-container info"},w=n("p",{class:"hint-container-title"},"相关信息",-1),A={href:"https://www.bilibili.com/video/BV1sg4y1L7ju",target:"_blank",rel:"noopener noreferrer"},y=u(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p><code>goctls</code> 已支持根据 <code>go zero path</code> 直接生成 <code>swagger path</code>, <code>goctls</code> 需要 <code>v0.3.0+</code><code>goctls</code> 已支持根据 <code>validate</code> 直接生成 <code>swagger</code>校验规则, <code>goctls</code> 需要 <code>v0.3.1+</code></p></div><blockquote><p>在项目根目录运行 simple-admin-core/</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>swagger generate spec <span class="token parameter variable">--output</span><span class="token operator">=</span>./core.yml --scan-models
