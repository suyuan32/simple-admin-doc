import{_ as i,a as t,b as o}from"./swagger_authority-f5f7790d.js";import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as c,c as r,a as n,b as s,d as e,e as d}from"./app-34a47d60.js";const u={},m=n("h2",{id:"使用-swagger-生成-api-文档",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#使用-swagger-生成-api-文档","aria-hidden":"true"},"#"),s(" 使用 swagger 生成 API 文档")],-1),v={class:"hint-container info"},k=n("p",{class:"hint-container-title"},"相关信息",-1),g={href:"https://goswagger.io/use/spec/meta.html",target:"_blank",rel:"noopener noreferrer"},b={href:"https://github.com/suyuan32/simple-admin-example-features/tree/main/swagger",target:"_blank",rel:"noopener noreferrer"},h={href:"https://github.com/suyuan32/simple-admin-example-features/blob/main/swagger/desc/base.api",target:"_blank",rel:"noopener noreferrer"},q={class:"hint-container info"},f=n("p",{class:"hint-container-title"},"相关信息",-1),A={href:"https://www.bilibili.com/video/BV1sg4y1L7ju",target:"_blank",rel:"noopener noreferrer"},I=d(`<div class="hint-container warning"><p class="hint-container-title">注意</p><p><code>goctls</code> 已支持根据 <code>go zero path</code> 直接生成 <code>swagger path</code>, <code>goctls</code> 需要 <code>v0.3.0+</code><br><code>goctls</code> 已支持根据 <code>validate</code> 直接生成 <code>swagger</code>校验规则, <code>goctls</code> 需要 <code>v0.3.1+</code></p></div><blockquote><p>在项目根目录运行 simple-admin-core/</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>swagger generate spec <span class="token parameter variable">--output</span><span class="token operator">=</span>./core.yml --scan-models
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>支持 prefix 设置路由前缀，只需设置 <code>prefix</code> ，并重新生成 <code>handler</code> 即可</p><h2 id="go-swagger-报错" tabindex="-1"><a class="header-anchor" href="#go-swagger-报错" aria-hidden="true">#</a> go swagger 报错</h2><p>安装最新版 go-swagger</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>go <span class="token function">install</span> github.com/go-swagger/go-swagger/cmd/swagger@latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,33);function P(w,x){const a=l("ExternalLinkIcon");return c(),r("div",null,[m,n("div",v,[k,n("blockquote",null,[n("p",null,[n("a",g,[s("官方文档"),e(a)])])]),n("p",null,[n("a",b,[s("示例项目"),e(a)]),s(),n("a",h,[s("Path 和 Query 请求例子"),e(a)])])]),n("div",q,[f,n("p",null,[n("a",A,[s("视频教程"),e(a)])])]),I])}const T=p(u,[["render",P],["__file","swagger.html.vue"]]);export{T as default};
