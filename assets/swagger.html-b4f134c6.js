...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>You can add more config in handler because it will not be over write if the file exists.</p><blockquote><p>Notice: goctls&#39; generating will only overwrite internal/types/* and internal/handler/routes.go. If handler and logic and so on need to regenerate, you must delete them by yourself.</p></blockquote>`,28);function h(f,q){const a=u("ExternalLinkIcon");return l(),c("div",null,[m,v,n("p",null,[n("a",k,[s("go-swagger"),e(a)])]),n("blockquote",null,[n("p",null,[n("a",b,[s("Office Document"),e(a)])])]),g])}const P=p(d,[["render",h],["__file","swagger.html.vue"]]);export{P as default};
