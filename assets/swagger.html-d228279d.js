import{_ as t,a as i,b as o}from"./swagger_authority-f5f7790d.js";import{_ as p,W as l,X as c,Y as n,Z as s,$ as e,a0 as r,D as u}from"./framework-2d2f73c4.js";const d={},m=n("h2",{id:"use-swagger",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#use-swagger","aria-hidden":"true"},"#"),s(" Use swagger")],-1),v={class:"hint-container info"},k=n("p",{class:"hint-container-title"},"Info",-1),g={href:"https://goswagger.io/use/spec/meta.html",target:"_blank",rel:"noopener noreferrer"},b={href:"https://github.com/suyuan32/simple-admin-example-features/tree/main/swagger",target:"_blank",rel:"noopener noreferrer"},h={href:"https://github.com/suyuan32/simple-admin",target:"_blank",rel:"noopener noreferrer"},f=r(`<div class="hint-container warning"><p class="hint-container-title">Note</p><p><code>goctls</code> already supports to directly generate <code>swagger path</code> based on <code>go zero path</code>, <code>goctls</code> requires <code>v0.3.0+</code></p></div><blockquote><p>In the root of project run simple-admin-core/</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>swagger generate spec <span class="token parameter variable">--output</span><span class="token operator">=</span>./core.yml --scan-models
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>You can add more config in handler because it will not be over write if the file exists.</p><div class="hint-container warning"><p class="hint-container-title">Note</p><p>goctls&#39; generating will only overwrite internal/types/* and internal/handler/routes.go. <br> If handler and logic and so on need to regenerate, you must delete them by yourself.</p></div><h2 id="go-swagger-report-error" tabindex="-1"><a class="header-anchor" href="#go-swagger-report-error" aria-hidden="true">#</a> Go swagger report error</h2><p>Install the latest version of go-swagger</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>go <span class="token function">install</span> github.com/go-swagger/go-swagger/cmd/swagger@latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,32);function q(I,A){const a=u("ExternalLinkIcon");return l(),c("div",null,[m,n("div",v,[k,n("blockquote",null,[n("p",null,[n("a",g,[s("Official Documentation"),e(a)])])]),n("p",null,[n("a",b,[s("Sample project"),e(a)]),s(" [Path and Query request example]("),n("a",h,[s("https://github.com/suyuan32/simple-admin"),e(a)]),s(" -example-features/blob/main/swagger/desc/base.api)")])]),f])}const w=p(d,[["render",q],["__file","swagger.html.vue"]]);export{w as default};
