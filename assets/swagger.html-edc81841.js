import{_ as t,a as i,b as o}from"./swagger_authority-f5f7790d.js";import{_ as p,W as l,X as c,Y as n,Z as s,$ as e,a0 as r,F as u}from"./framework-2d290880.js";const d={},m=n("h2",{id:"use-swagger",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#use-swagger","aria-hidden":"true"},"#"),s(" Use swagger")],-1),v=n("h3",{id:"environment-setting",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#environment-setting","aria-hidden":"true"},"#"),s(" Environment setting")],-1),k={href:"https://zhuanlan.zhihu.com/p/556171256?",target:"_blank",rel:"noopener noreferrer"},g={href:"https://goswagger.io/use/spec/meta.html",target:"_blank",rel:"noopener noreferrer"},b=r(`<blockquote><p>In the root of project run simple-admin-core/</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>swagger generate spec <span class="token parameter variable">--output</span><span class="token operator">=</span>./core.yml --scan-models
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,31);function h(f,q){const a=u("ExternalLinkIcon");return l(),c("div",null,[m,v,n("p",null,[n("a",k,[s("go-swagger"),e(a)])]),n("blockquote",null,[n("p",null,[n("a",g,[s("Office Document"),e(a)])])]),b])}const P=p(d,[["render",h],["__file","swagger.html.vue"]]);export{P as default};
