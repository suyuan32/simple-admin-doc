import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o as t,c as i,a as n,b as p,d as o,e as l}from"./app-dae30104.js";const c={},r={class:"hint-container info"},u=n("p",{class:"hint-container-title"},"相关信息",-1),d={href:"https://vben.ryansu.pro/zh/",target:"_blank",rel:"noopener noreferrer"},v=l(`<h2 id="前端设置" tabindex="-1"><a class="header-anchor" href="#前端设置" aria-hidden="true">#</a> 前端设置</h2><h3 id="主要修改-env-文件" tabindex="-1"><a class="header-anchor" href="#主要修改-env-文件" aria-hidden="true">#</a> 主要修改 env 文件</h3><blockquote><p>.env</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 后台名称
