import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as e,o as t,c as i,a as n,f as o,b as p,e as l}from"./app-VVVOBJHT.js";const c={},r=n("h2",{id:"web-ui-setting",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#web-ui-setting"},[n("span",null,"Web UI setting")])],-1),u={class:"hint-container info"},d=n("p",{class:"hint-container-title"},"Info",-1),v={href:"https://vben.ryansu.tech/",target:"_blank",rel:"noopener noreferrer"},m=l(`<blockquote><p>Mainly modify env file</p></blockquote><blockquote><p>.env</p></blockquote><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># spa-title
