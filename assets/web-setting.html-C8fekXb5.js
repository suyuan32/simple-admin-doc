import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,c as i,d as n,e as o,b as s,o as p}from"./app-SeIJRtVB.js";const l={},c=s('<h2 id="web-ui-setting" tabindex="-1"><a class="header-anchor" href="#web-ui-setting"><span>Web UI setting</span></a></h2><div class="hint-container info"><p class="hint-container-title">Info</p><p><a href="https://vben.ryansu.tech/" target="_blank" rel="noopener noreferrer">Backend UI Doc</a></p></div>',2),r={class:"hint-container info"},u=n("p",{class:"hint-container-title"},"Menu setting tutorial",-1),d=s(`<blockquote><p>Mainly modify env file</p></blockquote><blockquote><p>.env</p></blockquote><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># spa-title
