import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as s,o,c as p,a as n,f as l,b as a,e as c}from"./app-D1r_dmmg.js";const r={},u=n("h2",{id:"web-ui-setting",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#web-ui-setting"},[n("span",null,"Web UI setting")])],-1),d={class:"hint-container info"},v=n("p",{class:"hint-container-title"},"Info",-1),m={href:"https://vben.ryansu.tech/",target:"_blank",rel:"noopener noreferrer"},k={class:"hint-container info"},b=n("p",{class:"hint-container-title"},"Menu setting tutorial",-1),g=c(`<blockquote><p>Mainly modify env file</p></blockquote><blockquote><p>.env</p></blockquote><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># spa-title
