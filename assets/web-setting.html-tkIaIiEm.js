import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,c as i,d as n,e as o,b as s,o as p}from"./app-DWqRSxeM.js";const l={},c=s('<div class="hint-container info"><p class="hint-container-title">相关信息</p><p><a href="https://vben.ryansu.tech/zh/" target="_blank" rel="noopener noreferrer">Backend UI 文档</a></p></div><h2 id="前端设置" tabindex="-1"><a class="header-anchor" href="#前端设置"><span>前端设置</span></a></h2>',2),r={class:"hint-container info"},u=n("p",{class:"hint-container-title"},"菜单配置教程",-1),d=s(`<h3 id="主要修改-env-文件" tabindex="-1"><a class="header-anchor" href="#主要修改-env-文件"><span>主要修改 env 文件</span></a></h3><blockquote><p>.env</p></blockquote><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># 后台名称
